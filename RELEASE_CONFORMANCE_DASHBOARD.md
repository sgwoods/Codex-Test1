...
Generated: `2026-05-10T21:00:27.107Z`
...
| Metric points scanned | 1106 | History depth behind score trends |
| Score deltas found | 121 | Past-goal movement available for review |
| Measured runs | 413 | Tracked harness/model/local compute work |
| Tracked wall time | 263.6 min | Human clock-time planning input |
| Tracked CPU time | 410.9 min | Local compute-cost planning input |
| Tracked artifact growth | 662 MB | Evidence volume and storage/review-cost proxy |
...
| --- | --- | --- | --- |
| cpu | 411 | 238.6 min | 410.9 min |
| browser | 144 | 128.3 min | 223 min |
...
| 2 | Aurora audio cue comparison and event-gap reports | audio cue scoring | waveform/spectral/alignment/semantic reports | 21 compared cues; semantic 9.78/10; 0 attention rows | semantic-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-event-gap/2026-05-10-eedc85ba-dirty-205439/report.json | Tune the highest segment-level gap next: stagePulse onset. Rerun audio comparison and event-gap analysis after the change. |
...
![score-trends](reference-artifacts/analyses/conformance-economics/2026-05-10-eedc85ba/score-trends.svg)
...
![cpu-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-10-eedc85ba/cpu-use-by-purpose.svg)
...
- Quality report: `reference-artifacts/analyses/quality-conformance/2026-05-10-eedc85ba/report.json`
...
- Level-arc report: `reference-artifacts/analyses/level-arc-conformance/2026-05-10-eedc85ba/report.json`
- Economics report: `reference-artifacts/analyses/conformance-economics/2026-05-10-eedc85ba/report.json`
