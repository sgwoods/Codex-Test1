...
Generated: `2026-05-16T23:56:09.888Z`
...
| --- | --- | --- | --- | --- | --- |
| Aurora Galactica current dev line | 9.2/10 | strongest Player movement conformance 10/10; weakest Audio identity and cue alignment 7.1/10; broad alien/challenge variation 8.3/10; dedicated challenge-stage conformance 6.1/10; audio contract readiness 9.09/10 | release-quality conformance score plus audio cue-contract read | Audio identity and cue alignment (7.1/10) | reference-artifacts/analyses/quality-conformance/2026-05-16-8a54cf6f/report.json; reference-artifacts/analyses/aurora-audio-cue-contracts/latest.json; reference-artifacts/analyses/challenge-stage-conformance/latest.json |
...
| Audio identity and cue alignment | 7.1/10 | audio-cue-alignment correspondence, aurora-audio-theme-comparison, galaga-audio-overlap, aurora-audio-event-gap semantic read, audio-cue-contracts, audio-promotion-precheck | Audio score blends cue identity, active reference similarity, reference-window precision, overlap timing, cue alignment, semantic event mapping, and acoustic event-gap severity. 0/21 reference windows still need tighter segmentation; 22 candidate subwindows were found; semantic event score is 9.78/10, acoustic event score is 6.46/10, and highest segment risk is challengePerfect onset. Cue-contract readiness is 9.09/10; latest contract next step: Run a contract-aware candidate pass for challengePerfect, then rerun promotion precheck and live validation. |
