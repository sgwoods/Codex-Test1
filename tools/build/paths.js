...
module.exports = {
  ...
  DEV_WHITE_PAPER_PDF: path.join(DIST_DEV, 'white-paper.pdf'),
  DEV_WHITE_PAPER_PDF_META: path.join(DIST_DEV, 'white-paper-pdf.json'),
  DEV_PROJECT_OVERVIEW_SLIDES: path.join(DIST_DEV, 'project-overview-slides.html'),
  DEV_PROJECT_OVERVIEW_SLIDES_DATA: path.join(DIST_DEV, 'project-overview-slides.json'),
  ...
  PRODUCTION_WHITE_PAPER_PDF: path.join(DIST_PRODUCTION, 'white-paper.pdf'),
  PRODUCTION_WHITE_PAPER_PDF_META: path.join(DIST_PRODUCTION, 'white-paper-pdf.json'),
  PRODUCTION_PROJECT_OVERVIEW_SLIDES: path.join(DIST_PRODUCTION, 'project-overview-slides.html'),
  PRODUCTION_PROJECT_OVERVIEW_SLIDES_DATA: path.join(DIST_PRODUCTION, 'project-overview-slides.json'),
  ...
  BETA_WHITE_PAPER_PDF: path.join(DIST_BETA, 'white-paper.pdf'),
  BETA_WHITE_PAPER_PDF_META: path.join(DIST_BETA, 'white-paper-pdf.json'),
  BETA_PROJECT_OVERVIEW_SLIDES: path.join(DIST_BETA, 'project-overview-slides.html'),
  BETA_PROJECT_OVERVIEW_SLIDES_DATA: path.join(DIST_BETA, 'project-overview-slides.json'),
