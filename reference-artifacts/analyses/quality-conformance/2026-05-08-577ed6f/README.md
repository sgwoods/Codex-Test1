...
- Read: Current movement scored 8.7/10 against the control-principles profile, versus 8.7/10 for the shipped local baseline.

### Shot and hit responsiveness
- Score: 10/10
- Evidence: close-shot-hit, movement fire window
- Read: Close-shot responsiveness passed, and movement-fire post-shot travel was 100.72, with shot delay 7ms.
...
- Read: Level arc score is 8.4/10 with 6/6 stage families blueprinted and 6/6 evidence windows present; weakest submetric is Pressure curve over time (7.5/10).
...
- Read: Audio score blends cue identity, active reference similarity, reference-window precision, overlap timing, cue alignment, and semantic event mapping. 0/21 reference windows still need tighter segmentation; 21 candidate subwindows were found; semantic event score is 9.43/10 with 7 semantic attention rows and 7 shared-reference risks.
...
- Audio identity and cue alignment: 7.7/10
