...
Generated: `2026-05-17T10:58:27.071Z`
...
| --- | --- | --- | --- | --- | --- |
| Aurora Galactica current dev line | 9.2/10 | strongest Player movement conformance 10/10; weakest Audio identity and cue alignment 7.2/10; broad alien/challenge variation 8.3/10; dedicated challenge-stage conformance 6.1/10; audio contract readiness 9.24/10 | release-quality conformance score plus audio cue-contract read | Audio identity and cue alignment (7.2/10) | reference-artifacts/analyses/quality-conformance/2026-05-17-ab80e4c7/report.json; reference-artifacts/analyses/aurora-audio-cue-contracts/latest.json; reference-artifacts/analyses/challenge-stage-conformance/latest.json |
...
| Shot and hit responsiveness | 10/10 | close-shot-hit, movement fire window | Close-shot responsiveness passed, and movement-fire post-shot travel was 49.86, with shot delay 1ms. |
...
| Audio identity and cue alignment | 7.2/10 | audio-cue-alignment correspondence, aurora-audio-theme-comparison, galaga-audio-overlap, aurora-audio-event-gap semantic read, audio-cue-contracts, audio-promotion-precheck | Audio score blends cue identity, active reference similarity, reference-window precision, overlap timing, cue alignment, semantic event mapping, and acoustic event-gap severity. 0/21 reference windows still need tighter segmentation; 23 candidate subwindows were found; semantic event score is 9.78/10, acoustic event score is 6.56/10, and highest segment risk is challengePerfect onset. Cue-contract readiness is 9.24/10; latest contract next step: Do not promote Challenge Perfect runtime audio yet. Keep the new harness evidence, stabilize repeated full-theme capture, then compare bossHit, challengeTransition, and gameOver for the next best audio return. |
