...
Generated: `2026-05-14T18:05:00.000Z`
...
| --- | --- | --- | --- | --- | --- |
| Aurora Galactica current dev line | 9.1/10 | strongest Player movement conformance 10/10; weakest Audio identity and cue alignment 6.9/10; alien entry/challenge variation 7.8/10; audio contract readiness 9.09/10 | release-quality conformance score plus audio cue-contract read | Audio identity and cue alignment (6.9/10) | reference-artifacts/analyses/quality-conformance/2026-05-14-1c788342/report.json; reference-artifacts/analyses/aurora-audio-cue-contracts/latest.json |
...
| --- | --- | --- | --- | --- | --- |
| Current dev baseline | 9.1/10 | audio 6.9; movement 10; boss/formation 9.2; alien/challenge 7.8; stage opening 8.5; challenge timing 9.2; shell integrity 9.2 | 7.7/10 reference; 6.9/10 playtest | maturity 7; gate coverage 9.5; public readiness 3.9; audio feel 6.4 | Baseline for the next beta-candidate discussion, now weighted by local playtest feel and fresh audio capture evidence. |
...
| Audio identity / acoustic fit | 6.9/10 | restore `7.2+` in `1.3`; 7.6/10 in `1.4` | 6.4/10 playtest; 6.4/10 reference category | human-listened cue cleanup in `1.3`; 7.0/10 playtest in `1.4` | Audio is the weakest shared conformance area today; the latest enemy-fire cue improved acoustic event risk but the rounded category score still needs another lift. |
...
| Shot and hit responsiveness | 10/10 | close-shot-hit, movement fire window | Close-shot responsiveness passed, and movement-fire post-shot travel was 47.28, with shot delay -10ms. |
...
| Audio identity and cue alignment | 6.9/10 | audio-cue-alignment correspondence, aurora-audio-theme-comparison, galaga-audio-overlap, aurora-audio-event-gap semantic read, audio-cue-contracts, audio-promotion-precheck | Audio score blends cue identity, active reference similarity, reference-window precision, overlap timing, cue alignment, semantic event mapping, and acoustic event-gap severity. 0/21 reference windows still need tighter segmentation; 22 candidate subwindows were found; semantic event score is 9.78/10, acoustic event score is 6.30/10, and highest segment risk is captureBeam tail. Cue-contract readiness is 9.09/10; latest runtime lift promotes a measured enemyShot threat-fire subwindow while rejecting challengePerfect promotion after full-theme quality guards fell. |
