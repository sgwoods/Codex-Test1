...
Generated: `2026-05-08T22:11:05.988Z`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Audio identity, event feedback, and cue alignment | 7.9/10 | medium-high | 21 cue/event comparisons with waveform, spectral, overlap, alignment, and semantic event-mapping features | high; cpu, model-api, openai-api | 78 runs; 53.3 min wall; 92.4 min CPU | 7.5-8.0 | Measured release category; weakest axis | Largest current score gap and high user-experience impact: shots, explosions, boss damage, challenge results, capture/rescue feedback. | High; 3-6 hrs local/model-assisted analysis | Tune the highest segment-level audio gap next: challengePerfect body. Rerun audio comparison, event-gap analysis, and quality scoring after the change. | reference-artifacts/analyses/quality-conformance/2026-05-08-cfa8497/report.json |
| 2 | Level arc and encounter shape | 8.5/10 | medium-high | multi-submetric level-arc report with stage families, challenge layers, pressure, reward, and persona evidence | low; cpu, browser | 88 runs; 14.8 min wall; 24.7 min CPU | 8.8-9.0 | Measured release category | Controls whether long play feels like Galaga-like escalation rather than repeated pressure. | Medium-high; 2-5 hrs | Widen the Stage 1 baseline evidence window for player-shot and endpoint semantics before gameplay tuning. | reference-artifacts/analyses/level-arc-conformance/2026-05-08-cfa8497/report.json |
...
| 6 | Challenge-stage variation and new alien/formations introduction | 9.3/10 | medium | composite proxy from challenge timing, challenge identity, and non-repetition | estimated; cpu, browser | 43 runs; 7.5 min wall; 10 min CPU | 9.0-9.4 with dedicated scorer | Composite proxy: challenge timing + challenge identity + non-repetition | Challenge stages should teach new motion/reward patterns, not only pause normal combat. | Medium-high; 2-4 hrs | Add a challenge-variation metric for alien type introduction, path families, result feedback, and bonus opportunity clarity. | reference-artifacts/analyses/quality-conformance/2026-05-08-cfa8497/report.json; reference-artifacts/analyses/level-arc-conformance/2026-05-08-cfa8497/report.json |
...
| Measured runs | 150 | Tracked harness/model/local compute work |
| Tracked wall time | 72.5 min | Human clock-time planning input |
| Tracked CPU time | 119.8 min | Local compute-cost planning input |
| Tracked artifact growth | 313.9 MB | Evidence volume and storage/review-cost proxy |

### Resource And Time Usage

| Resource | Measured runs | Wall time | CPU time |
| --- | --- | --- | --- |
| cpu | 149 | 72.5 min | 119.8 min |
| browser | 102 | 69.2 min | 116 min |
...
| --- | --- | --- | --- |
| audio | 78 | 53.3 min | 92.4 min |
| conformance-economics | 69 | 17.8 min | 24.8 min |
| stage4-pressure | 28 | 12.8 min | 18.5 min |
| conformance-loop | 49 | 11.7 min | 19.6 min |
| audio-reference-segmentation | 16 | 11.1 min | 19.4 min |
| audio-event-gap | 12 | 8.8 min | 16 min |
| audio-theme-comparison | 8 | 8.7 min | 15.9 min |
| audio-segmentation-normalization | 7 | 8.4 min | 15.1 min |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Audio identity, event feedback, and cue alignment | 7.9/10 | 7.5-8.0 | at target | High; 3-6 hrs local/model-assisted analysis | cpu, model-api, openai-api | 78 runs; 53.3 min wall; 92.4 min CPU | Expected lift 0.7/10 on metric, 0.064/10 overall; investment score 2.9. | Tune the highest segment-level audio gap next: challengePerfect body. Rerun audio comparison, event-gap analysis, and quality scoring after the change. |
| 2 | Level arc and encounter shape | 8.5/10 | 8.8-9.0 | +0.3 | Medium-high; 2-5 hrs | cpu, browser | 88 runs; 14.8 min wall; 24.7 min CPU | Expected lift 0.24/10 on metric, 0.022/10 overall; investment score 1.92. | Widen the Stage 1 baseline evidence window for player-shot and endpoint semantics before gameplay tuning. |
...
| 6 | Challenge-stage variation and new alien/formations introduction | 9.3/10 | 9.0-9.4 with dedicated scorer | at target | Medium-high; 2-4 hrs | cpu, browser | 43 runs; 7.5 min wall; 10 min CPU | Estimated cost/value; dedicated investment candidate not yet generated. | Add a challenge-variation metric for alien type introduction, path families, result feedback, and bonus opportunity clarity. |
...
![score-trends](reference-artifacts/analyses/conformance-economics/2026-05-08-fa37a87/score-trends.svg)

![largest-score-deltas](reference-artifacts/analyses/conformance-economics/2026-05-08-fa37a87/largest-score-deltas.svg)

![compute-minutes-by-resource](reference-artifacts/analyses/conformance-economics/2026-05-08-fa37a87/compute-minutes-by-resource.svg)

![cost-per-positive-score-point](reference-artifacts/analyses/conformance-economics/2026-05-08-fa37a87/cost-per-positive-score-point.svg)
...
- Economics report: `reference-artifacts/analyses/conformance-economics/2026-05-08-fa37a87/report.json`
