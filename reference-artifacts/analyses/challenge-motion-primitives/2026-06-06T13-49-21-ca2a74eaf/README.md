...
Generated: 2026-06-06T13:49:21.951Z
Commit: ca2a74eaf
...
- First build target: group-spacing-field
...
| Challenging Stage 7-8 | lead-in-continuity, group-spacing-field, reference-spline-fit, phase-order-scheduler, hook-return-arc, lower-field-scoreable-pass | 1.4 | 0.811 | Wait for the Stage 3 primitive prototype, then retune this stage using the same primitive vocabulary. |
