...
Generated: `2026-05-15T12:53:10.491Z`
...
| Audio identity | 7/10 | >=7.5 | Primary user-experience gap |
| Level arc | 8.7/10 | >=8.8 | Long-play gameplay-quality gate |
| Alien entry and challenge-stage novelty | 8/10 | >=7.5 first gate; >=9.0 mature | New high-priority long-cycle gameplay-authenticity gate |
| Boss entry and formation grammar | 9.2/10 | >=8.0 first gate; >=9.0 mature | New measured gate for stage choreography |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Audio identity, event feedback, and cue alignment | 7/10 | medium-high | 21 cue/event comparisons with waveform, spectral, overlap, alignment, and semantic event-mapping features | high; cpu, model-api, openai-api | 266 runs; 185.8 min wall; 330 min CPU | 7.5-8.0 | Measured release category; weakest axis | Largest current score gap and high user-experience impact: shots, explosions, boss damage, challenge results, capture/rescue feedback. | High; 3-6 hrs local/model-assisted analysis | Keep the calibrated layered playerHit runtime cue; next either refine the residual playerHit tail/body gap with the same calibrated scorer or move effort to stagePulse pressure-bed strategy if user impact per compute looks higher. | reference-artifacts/analyses/quality-conformance/2026-05-15-60326a33/report.json; reference-artifacts/analyses/aurora-audio-cue-contracts/2026-05-11-b83393cd-dirty-201628/report.json |
| 2 | Alien entry and challenge-stage novelty | 8/10 | medium | dedicated planning scorer using stage-signature distance, runtime path-family signatures, challenge-window coverage, alien-family novelty, and reference-comparison readiness | estimated; cpu, browser | 177 runs; 24.6 min wall; 40.9 min CPU | 7.5 first gate; 9.0+ mature | Dedicated long-cycle scorer; high-priority gameplay-authenticity gap | Regular-stage alien entry, challenge-stage trajectories, and new-alien introduction are not yet sufficiently varied or reference-grounded; this is a first-order Galaga conformance gap. | High; long-cycle CPU/browser extraction plus reference contact-sheet and path-labeling pass | Attack Reference-grounded path precision readiness: Path comparison confidence 0.64; accepted reference labels 0 regular / 0 challenge; label coverage 0/10; current heuristic cap 6.8/10; path-slot extraction score 9.8/10. | reference-artifacts/analyses/alien-entry-challenge-variation/2026-05-15-60326a33/report.json |
| 3 | Level arc and encounter shape | 8.7/10 | medium-high | multi-submetric level-arc report with stage families, challenge layers, pressure, reward, and persona evidence | low; cpu, browser | 160 runs; 24 min wall; 39.7 min CPU | 8.8-9.0 | Measured release category | Controls whether long play feels like Galaga-like escalation rather than repeated pressure. | Medium-high; 2-5 hrs | Use the top-ranked opportunity window to add or widen deterministic evidence before changing gameplay tuning. | reference-artifacts/analyses/level-arc-conformance/2026-05-15-60326a33/report.json |
| 4 | Boss entry and formation grammar | 9.2/10 | medium | first-class boss/formation scorer using stage-window event grammar, boss timing, escort composition, challenge identity, and explicit path/slot measurement debt | high; cpu, browser | 160 runs; 24 min wall; 39.7 min CPU | 8.0-8.5 first gate; 9.0+ with path/slot extraction | Measured release category; new first-class axis | Boss entries, escorts, formation settling, and challenge set pieces are core Galaga choreography and directly affect whether stages feel authored. | Medium-high; 2-5 hrs, then recurring low-cost guardrail | Advance Path shape and set-formation precision: 600 tracks classified into path families; expected family coverage 1; capped score 6.8/10 until direct reference labels land. | reference-artifacts/analyses/quality-conformance/2026-05-15-60326a33/report.json |
...
| Latest level-arc conformance | 8.7/10 | Long-play gameplay-shape gate |
| Metric points scanned | 1230 | History depth behind score trends |
| Score deltas found | 134 | Past-goal movement available for review |
| Measured runs | 517 | Tracked harness/model/local compute work |
| Tracked wall time | 335.1 min | Human clock-time planning input |
| Tracked CPU time | 531.9 min | Local compute-cost planning input |
| Tracked artifact growth | 822.4 MB | Evidence volume and storage/review-cost proxy |
...
| --- | --- | --- | --- | --- |
| Audio conformance and cue feedback | 367 | 280.4 min | 90.4% | Moves the moment-to-moment arcade feel: impact clarity, ambience identity, reward/loss feedback, and player understanding. |
| Gameplay behavior and level complexity | 138 | 25 min | 8% | Moves player-facing pressure, stage shape, alien entry novelty, challenge-stage learning value, and long-play texture. |
| Harness, ingestion, and assessment logic | 4 | 4.8 min | 1.5% | Moves reusable automation: scorers, artifact extraction, candidate loops, measurement confidence, and future game ingestion. |
...
| --- | --- | --- | --- |
| Gameplay complexity and stage arc | +46.2 | 74% | Player-perceived variety, pressure, alien choreography, challenge-stage novelty, and long-play learning curve. |
| Core mechanics and control feel | +7.9 | 12.7% | Player-perceived fairness, responsiveness, collision quality, and trust in combat outcomes. |
| Audio feedback and event clarity | +5.6 | 9% | Player-perceived clarity from sounds that explain danger, reward, loss, and arcade identity. |
...
| --- | --- | --- | --- |
| cpu | 515 | 310.1 min | 531.9 min |
| browser | 193 | 196.4 min | 340.2 min |
...
| --- | --- | --- | --- |
| audio | 266 | 185.8 min | 330 min |
| audio-focus-candidate | 27 | 66 min | 121.8 min |
| conformance-economics | 95 | 46.4 min | 30.7 min |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Audio identity, event feedback, and cue alignment | 7/10 | 7.5-8.0 | +0.5 | High; 3-6 hrs local/model-assisted analysis | cpu, model-api, openai-api | 266 runs; 185.8 min wall; 330 min CPU | Expected lift 0.7/10 on metric, 0.058/10 overall; investment score 2.96. | Keep the calibrated layered playerHit runtime cue; next either refine the residual playerHit tail/body gap with the same calibrated scorer or move effort to stagePulse pressure-bed strategy if user impact per compute looks higher. |
| 2 | Alien entry and challenge-stage novelty | 8/10 | 7.5 first gate; 9.0+ mature | at target | High; long-cycle CPU/browser extraction plus reference contact-sheet and path-labeling pass | cpu, browser | 177 runs; 24.6 min wall; 40.9 min CPU | Estimated cost/value; dedicated investment candidate not yet generated. | Attack Reference-grounded path precision readiness: Path comparison confidence 0.64; accepted reference labels 0 regular / 0 challenge; label coverage 0/10; current heuristic cap 6.8/10; path-slot extraction score 9.8/10. |
| 3 | Level arc and encounter shape | 8.7/10 | 8.8-9.0 | +0.1 | Medium-high; 2-5 hrs | cpu, browser | 160 runs; 24 min wall; 39.7 min CPU | Expected lift 0.24/10 on metric, 0.02/10 overall; investment score 1.68. | Use the top-ranked opportunity window to add or widen deterministic evidence before changing gameplay tuning. |
| 4 | Boss entry and formation grammar | 9.2/10 | 8.0-8.5 first gate; 9.0+ with path/slot extraction | at target | Medium-high; 2-5 hrs, then recurring low-cost guardrail | cpu, browser | 160 runs; 24 min wall; 39.7 min CPU | Expected lift 0.28/10 on metric, 0.023/10 overall; investment score 0.79. | Advance Path shape and set-formation precision: 600 tracks classified into path families; expected family coverage 1; capped score 6.8/10 until direct reference labels land. |
...
| 7 | Alien entry to levels: formation, timing, and methods | 10/10 | 9.0-9.4 with path and rack-slot scorer | at target | Medium; 1-3 hrs plus visual review | cpu, browser | 109 runs; 24.1 min wall; 32.1 min CPU | Estimated cost/value; dedicated investment candidate not yet generated. | Raise regular-stage minimum signature distance and add stage-specific alien entry scripts before retuning broad level arc. |
| 8 | Challenge-stage variation and new alien/formations introduction | 10/10 | 9.0-9.4 with dedicated scorer | at target | Medium-high; 2-4 hrs | cpu, browser | 109 runs; 24.1 min wall; 32.1 min CPU | Estimated cost/value; dedicated investment candidate not yet generated. | Expand challenge evidence to at least four windows, then add distinct sweep/arc/lane/boss-led trajectory families. |
...
| 2 | Aurora audio cue comparison and event-gap reports | audio cue scoring | waveform/spectral/alignment/semantic reports | 21 compared cues; semantic 9.78/10; 0 attention rows | semantic-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-event-gap/2026-05-15-60326a33-dirty-124517/report.json | Tune the highest segment-level gap next: challengePerfect onset. Rerun audio comparison and event-gap analysis after the change. |
| 3 | Aurora Audio Conformance Lab v2 | audio candidate loop / family promotion decisions | cue-family risk, candidate history, keeper decision, promotion gate | 8/8 target cues swept; 2 keeper candidates tracked; runtime promotions 1 | family-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-conformance-lab-v2/2026-05-11-b83393cd-dirty/report.json | Keep the calibrated layered playerHit runtime cue; next either refine the residual playerHit tail/body gap with the same calibrated scorer or move effort to stagePulse pressure-bed strategy if user impact per compute looks higher. |
| 4 | Aurora audio cue contracts | audio semantic contract / theme latitude / promotion safety | cue contract readiness, theme lanes, runtime-trial blockers | 8 contracts; readiness 9.1/10; blocked 7 | contract-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-cue-contracts/2026-05-11-b83393cd-dirty-201628/report.json | Keep the calibrated layered playerHit runtime cue; next either refine the residual playerHit tail/body gap with the same calibrated scorer or move effort to stagePulse pressure-bed strategy if user impact per compute looks higher. |
| 5 | Aurora stagePulse cadence pressure analysis | formation pressure / cadence audio | tracked cadence pressure axes from full audio comparison | pressure 1.4/10; weakest brightness-control | scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-stage-pulse-cadence/2026-05-10-705e445c-dirty/report.json | Add a cadence-specific candidate generator that jointly optimizes low-band body, brightness control, zero-crossing calm, and gain. Promote only after both repeated focus gates and full audio-theme comparison improve. |
| 6 | Boss entry and formation grammar scorer | formation grammar / boss entry / challenge identity | event grammar, timing, stage-signature, and measurement-debt report | 11 boss/formation windows | scored | medium | Boss entry and formation grammar | reference-artifacts/analyses/formation-boss-grammar-conformance/2026-05-15-60326a33/report.json | Promote frame-level boss/escort path traces and formation rack slot coordinates so visual choreography can be scored directly. |
| 7 | Level arc and encounter-shape evidence | level arc / challenge / reward | stage signatures, pressure windows, persona reports | 6/6 stage families; 11/6 evidence windows | scored | medium-high | Level arc and encounter shape | reference-artifacts/analyses/level-arc-conformance/2026-05-15-60326a33/report.json | Add more long-play reference windows and expert-route scoring for challenge/reward opportunities. |
...
| 12 | Reference contact sheets and frame evidence | visual / motion / entry formation | contact sheets and still frames | 32 contact/frame evidence files | extracted, partially labeled | medium | Visual look, alien entry, challenge variation | reference-artifacts/analyses | Attach contact-sheet families to metric rows and add image-level comparison scores. |

### Charts

![score-trends](reference-artifacts/analyses/conformance-economics/2026-05-14-df15e918/score-trends.svg)

![largest-score-deltas](reference-artifacts/analyses/conformance-economics/2026-05-14-df15e918/largest-score-deltas.svg)

![compute-minutes-by-resource](reference-artifacts/analyses/conformance-economics/2026-05-14-df15e918/compute-minutes-by-resource.svg)

![cost-per-positive-score-point](reference-artifacts/analyses/conformance-economics/2026-05-14-df15e918/cost-per-positive-score-point.svg)

![gpu-equivalent-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-14-df15e918/gpu-equivalent-use-by-purpose.svg)

![cpu-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-14-df15e918/cpu-use-by-purpose.svg)

![gameplay-improvement-by-project-part](reference-artifacts/analyses/conformance-economics/2026-05-14-df15e918/gameplay-improvement-by-project-part.svg)
...
- Quality report: `reference-artifacts/analyses/quality-conformance/2026-05-15-60326a33/report.json`
- Investment priority report: `reference-artifacts/analyses/conformance-investment-priorities/2026-05-11-46e1b45c/report.json`
- Level-arc report: `reference-artifacts/analyses/level-arc-conformance/2026-05-15-60326a33/report.json`
- Economics report: `reference-artifacts/analyses/conformance-economics/2026-05-14-df15e918/report.json`
