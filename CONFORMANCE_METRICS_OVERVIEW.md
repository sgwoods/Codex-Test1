...
| --- | --- | --- | --- | --- | --- |
| Aurora Galactica current dev line | 9.1/10 | strongest Player movement conformance 10/10; weakest Audio identity and cue alignment 6.3/10; level arc and encounter shape 8.3/10; stage-signature distance 6.4/10 | stricter release-quality conformance score with active audio reference matching, candidate reference subwindows, level-arc scoring, expanded stage-signature distance evidence, stage-14 escort-role features, and stage-8 flank-dive grammar | Audio identity and cue alignment (6.3/10), followed by level arc and encounter shape (8.3/10) | reference-artifacts/analyses/quality-conformance/2026-05-07-2aeaafa/report.json |
...
| --- | --- | --- | --- | --- | --- |
| Current dev baseline | 9.1/10 | audio 6.3; level arc 8.3; stage signature 6.4; movement 10; stage opening 8.5; challenge timing 9.9; shell integrity 9.2 | 7.7/10 reference; 6.9/10 playtest | maturity 7; gate coverage 9.5; public readiness 3.9; audio feel 6.4 | Baseline for the next beta-candidate discussion, now weighted by stricter audio reference evidence, six-window level-arc shape, stage-signature distance, late-stage escort-role measurement, stage-8 flank grammar, and local playtest feel. |
