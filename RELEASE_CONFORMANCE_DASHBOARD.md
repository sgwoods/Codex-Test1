...
Generated: `2026-05-08T19:57:19.967Z`
...
| Measured runs | 126 | Tracked harness/model/local compute work |
| Tracked wall time | 50.8 min | Human clock-time planning input |
| Tracked CPU time | 81.2 min | Local compute-cost planning input |
| Tracked artifact growth | 260.5 MB | Evidence volume and storage/review-cost proxy |

### Resource And Time Usage

| Resource | Measured runs | Wall time | CPU time |
| --- | --- | --- | --- |
| cpu | 125 | 50.8 min | 81.2 min |
| browser | 81 | 47.5 min | 77.4 min |
...
| audio-reference-segmentation | 7 | 4.1 min | 7.3 min |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Audio identity, event feedback, and cue alignment | 7.9/10 | 7.5-8.0 | at target | High; 3-6 hrs local/model-assisted analysis | cpu, model-api, openai-api | 54 runs; 31.5 min wall; 53.9 min CPU | Expected lift 0.7/10 on metric, 0.064/10 overall; investment score 2.9. | Tune the highest segment-level audio gap next: challengePerfect body. Rerun audio comparison, event-gap analysis, and quality scoring after the change. |
...
![score-trends](reference-artifacts/analyses/conformance-economics/2026-05-08-8b6e3a8/score-trends.svg)

![largest-score-deltas](reference-artifacts/analyses/conformance-economics/2026-05-08-8b6e3a8/largest-score-deltas.svg)

![compute-minutes-by-resource](reference-artifacts/analyses/conformance-economics/2026-05-08-8b6e3a8/compute-minutes-by-resource.svg)

![cost-per-positive-score-point](reference-artifacts/analyses/conformance-economics/2026-05-08-8b6e3a8/cost-per-positive-score-point.svg)
...
- Economics report: `reference-artifacts/analyses/conformance-economics/2026-05-08-8b6e3a8/report.json`
