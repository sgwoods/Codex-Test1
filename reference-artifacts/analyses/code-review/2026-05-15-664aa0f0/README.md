...
Generated: `2026-05-15T13:03:30.532Z`
...
- `.github/workflows/pages.yml` (M; docs-artifact; no-risk-tags)
...
- `reference-artifacts/analyses/alien-entry-challenge-variation/2026-05-15-60326a33/README.md` (A; docs-artifact; no-risk-tags)
- `reference-artifacts/analyses/alien-entry-challenge-variation/2026-05-15-60326a33/report.json` (A; docs-artifact; no-risk-tags)
...
- `reference-artifacts/analyses/formation-boss-path-family-comparison/2026-05-15-60326a33/README.md` (A; docs-artifact; no-risk-tags)
- `reference-artifacts/analyses/formation-boss-path-family-comparison/2026-05-15-60326a33/report.json` (A; docs-artifact; no-risk-tags)
- `reference-artifacts/analyses/formation-boss-path-slot-extraction/2026-05-15-60326a33/challenge-stage-boss-led-loop.svg` (A; docs-artifact; no-risk-tags)
- `reference-artifacts/analyses/formation-boss-path-slot-extraction/2026-05-15-60326a33/challenge-stage-candidate.svg` (A; docs-artifact; no-risk-tags)
- `reference-artifacts/analyses/formation-boss-path-slot-extraction/2026-05-15-60326a33/challenge-stage-scorpion-cross.svg` (A; docs-artifact; no-risk-tags)
- `reference-artifacts/analyses/formation-boss-path-slot-extraction/2026-05-15-60326a33/challenge-stage-stingray-hook.svg` (A; docs-artifact; no-risk-tags)
- `reference-artifacts/analyses/formation-boss-path-slot-extraction/2026-05-15-60326a33/late-run-cleanup-or-failure.svg` (A; docs-artifact; no-risk-tags)
- `reference-artifacts/analyses/formation-boss-path-slot-extraction/2026-05-15-60326a33/late-run-crown-entry.svg` (A; docs-artifact; no-risk-tags)
- `reference-artifacts/analyses/formation-boss-path-slot-extraction/2026-05-15-60326a33/late-run-escort-variant.svg` (A; docs-artifact; no-risk-tags)
- `reference-artifacts/analyses/formation-boss-path-slot-extraction/2026-05-15-60326a33/mid-run-entry-variant.svg` (A; docs-artifact; no-risk-tags)
- `reference-artifacts/analyses/formation-boss-path-slot-extraction/2026-05-15-60326a33/mid-run-pincer-variant.svg` (A; docs-artifact; no-risk-tags)
- `reference-artifacts/analyses/formation-boss-path-slot-extraction/2026-05-15-60326a33/mid-run-pressure.svg` (A; docs-artifact; no-risk-tags)
- `reference-artifacts/analyses/formation-boss-path-slot-extraction/2026-05-15-60326a33/README.md` (A; docs-artifact; no-risk-tags)
- `reference-artifacts/analyses/formation-boss-path-slot-extraction/2026-05-15-60326a33/report.json` (A; docs-artifact; no-risk-tags)
- `reference-artifacts/analyses/formation-boss-path-slot-extraction/2026-05-15-60326a33/stage-1-baseline.svg` (A; docs-artifact; no-risk-tags)
- `reference-artifacts/analyses/galaga-path-reference-labels/2026-05-15-60326a33/README.md` (A; docs-artifact; no-risk-tags)
- `reference-artifacts/analyses/galaga-path-reference-labels/2026-05-15-60326a33/report.json` (A; docs-artifact; no-risk-tags)
- `reference-artifacts/analyses/galaga-path-reference-labels/latest.json` (A; docs-artifact; no-risk-tags)
...
- `reference-artifacts/analyses/release-conformance-dashboard/2026-05-15-60326a33-dirty/report.json` (A; release-tooling; release-lane)
...
- `reference-artifacts/analyses/stage-signature-distance/2026-05-15-60326a33/README.md` (A; docs-artifact; no-risk-tags)
- `reference-artifacts/analyses/stage-signature-distance/2026-05-15-60326a33/report.json` (A; docs-artifact; no-risk-tags)
- `reference-artifacts/ingestion/galaga-path-reference-labels/README.md` (A; docs-artifact; no-risk-tags)
...
- `SECURITY_AUTH_REPLAY_STORAGE_LOCKDOWN.md` (A; docs-artifact; auth-privacy, media-external)
...
- `tools/harness/analyze-galaga-path-reference-labels.js` (A; harness-tooling; browser-safety, harness)
- `tools/harness/check-security-auth-replay-storage-rules.js` (A; harness-tooling; auth-privacy, browser-safety, harness, media-external, platform-owned)
