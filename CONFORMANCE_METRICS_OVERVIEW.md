...
Generated: `2026-05-03T16:54:00.204Z`
...
| Galaxy Guardians 0.1 dev preview | 7.1/10 | playtest weighted 5.7/10; maturity 6.4/10; gate coverage 9.2/10; public readiness 3.5/10 | dev-preview-reference-conformance-model-not-public-release-score | Audio character and reference fit | reference-artifacts/analyses/galaxy-guardians-identity/reference-conformance-0.1.json |
...
| --- | --- | --- | --- | --- | --- |
| Movement and pressure | 8.1/10 | 8.6/10 in `1.3`; 8.8/10 in `1.4` | 5.9/10 playtest; 5.9/10 reference category | browser-reviewed runtime tuning in `1.3`; 7.2/10 playtest in `1.4` | This is the strongest direct feel signal during live play. |
| Audio identity / acoustic fit | 6.1/10 | 7.2/10 in `1.3`; 7.6/10 in `1.4` | 3.8/10 playtest; 3.8/10 reference category | isolated cue comparison in `1.3`; 7.0/10 playtest in `1.4` | Audio is the weakest shared conformance area today. |
| Visual identity | 9.2/10 shell integrity; game sprites not separately scored in the roll-up | add a visible arcade-depth visual score in `1.4` | 5.4/10 playtest; 5.4/10 reference category | final sprite recognition in `1.3`; 7.0/10 playtest in `1.4` | Guardians especially needs recognizably distinct alien silhouettes before beta-facing preview. |
...
| Movement and pressure model | 14 | 5.9/10 | reference-window-inspired-runtime-contract-plus-runtime-vs-reference-track-comparison | Scout dives, flagship dives, escort joins, enemy shots, and wrap/return pressure are implemented and gated. The latest pass increases dive speed, dive acceleration, enemy-shot pressure, and wrap cadence in response to playtest feedback. | The preview still feels proxy-tuned rather than Galaxian-tight; browser review and sprite-recognized dive-path targets are needed before beta-facing release. |
...
| Visual alien identity | 10 | 5.4/10 | game-owned-visual-catalog-readability-gate-frame-crops-object-proxies-and-sprite-extraction | Flagship, escort, scout, and player interceptor visuals are smaller, separate from Aurora, and gated for role readability. The latest pass separates escort and scout silhouettes after playtest review, and sprite extraction measures 27 rack/diver/player crops. | Sprites are still hand-authored preview approximations; final pixel-grid targets from reference crops are needed before the graphics can feel close to Galaxian. |
| Audio character and reference fit | 10 | 3.8/10 | internal-cue-shape-contract-plus-waveform-spectrogram-pcm-proxy | Runtime cue IDs and role-separated cue shapes are gated, and the latest pass makes shots and dives lower, raspier, and less Aurora-musical. The audio comparison analyzes 9 Galaxian waveform/spectrogram windows with PCM proxy metrics. | This is the weakest Guardians area: isolated acoustic matching against Galaxian hardware cues is not yet automated, and playtest review says the current sound is not close enough. |
...
| --- | --- | --- | --- | --- | --- | --- |
| Audio character and Galaxian acoustic feel | 28 | 5.3/10 | 2.5/10 | 3.8/10 | 7/10 | hardware-like square/noise timbre, short dry shot envelopes, dive siren descent character, event mix density during live play, waveform/spectrogram proxy fit |
| Motion pace and lower-field pressure | 32 | 6.7/10 | 4.8/10 | 5.9/10 | 7.2/10 | formation entry duration, first scout dive timing, flagship/escort dive timing, dive vertical speed and acceleration, lateral curve shape, enemy shot density, bottom wrap/return cadence |
| Graphic alignment and alien/player likeness | 28 | 7/10 | 4.5/10 | 5.4/10 | 7/10 | alien silhouette family likeness, flagship/escort/scout separation, palette family match, sprite scale and rack density, player ship likeness, score/attract visual layout |
