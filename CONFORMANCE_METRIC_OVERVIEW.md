...
Generated: `2026-05-11T18:04:44.952Z`
...
| --- | --- | --- | --- | --- | --- |
| Aurora Galactica current dev line | 9.1/10 | strongest Shot and hit responsiveness 10/10; weakest Audio identity and cue alignment 7.2/10; alien entry/challenge variation 7.8/10; audio contract readiness 9.09/10 | release-quality conformance score plus audio cue-contract read | Audio identity and cue alignment (7.2/10) | reference-artifacts/analyses/quality-conformance/2026-05-11-23c856ad/report.json; reference-artifacts/analyses/aurora-audio-cue-contracts/latest.json |
...
| --- | --- | --- | --- | --- | --- |
| Current dev baseline | 9.1/10 | audio 7.2; movement 9.1; boss/formation 9.2; alien/challenge 7.8; stage opening 8.5; challenge timing 9.2; shell integrity 9.2 | 7.7/10 reference; 6.9/10 playtest | maturity 7; gate coverage 9.5; public readiness 3.9; audio feel 6.4 | Baseline for the next beta-candidate discussion, now weighted by local playtest feel. |
...
xychart-beta
  ...
  line "Aurora Galactica" [9.1, 9.0, 9.2, 9.3, 9.4, 9.5]
...
| --- | --- | --- | --- | --- | --- |
| Movement and pressure | 9.1/10 | 8.6/10 in `1.3`; 8.8/10 in `1.4` | 6.2/10 playtest; 6.2/10 reference category | browser-reviewed runtime tuning in `1.3`; 7.2/10 playtest in `1.4` | This is the strongest direct feel signal during live play. |
...
| --- | --- | --- | --- |
| Player movement conformance | 9.1/10 | player-movement report | Current movement scored 9.1/10 against the control-principles profile, versus 9.1/10 for the shipped local baseline. |
| Shot and hit responsiveness | 10/10 | close-shot-hit, movement fire window | Close-shot responsiveness passed, and movement-fire post-shot travel was 62.21, with shot delay 7ms. |
...
| Challenge-stage timing fidelity | 9.2/10 | challenge-stage correspondence | 5/5 challenge timing metrics were within tolerance; worst current delta was 0.032. |
...
| Audio identity and cue alignment | 7.2/10 | audio-cue-alignment correspondence, aurora-audio-theme-comparison, galaga-audio-overlap, aurora-audio-event-gap semantic read, audio-cue-contracts, audio-promotion-precheck | Audio score blends cue identity, active reference similarity, reference-window precision, overlap timing, cue alignment, semantic event mapping, and acoustic event-gap severity. 0/21 reference windows still need tighter segmentation; 18 candidate subwindows were found; semantic event score is 9.78/10, acoustic event score is 6.2/10, and highest segment risk is playerHit tail. Cue-contract readiness is 9.09/10; latest contract next step: Run a contract-aware candidate pass for playerHit, then rerun promotion precheck and live validation. |
