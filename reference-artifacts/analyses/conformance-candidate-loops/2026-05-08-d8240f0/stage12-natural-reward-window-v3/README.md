...
- Candidate: stage12-natural-reward-window-v3
...
| --- | ---: | ---: | ---: | ---: | --- |
| opportunity.score10 | 4.5 | 4.2 | -0.3 | 0.2 | no |
| opportunity.meanRewardIndex | 2.1 | 2 | -0.1 | 0.2 | no |
...
| outcome.endpointWindows | 3 | 3 | 0 | 0 | yes |
| outcome.collisionLossWindows | 2 | 2 | 0 | 0 | yes |
