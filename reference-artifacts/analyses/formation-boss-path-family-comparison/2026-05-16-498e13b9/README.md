...
- Trajectory-vector comparison: 5.7/10 (reference-trajectory-vector-comparison-active-no-cap-lift)
...
Success: Raise path-family score beyond the label-backed cap (8.2/10) only after reference trajectories are tracked against Aurora paths, not just labeled by contact-sheet family. Current trajectory-vector score is 5.7/10.
...
| Escort paired dive | 2 | 22 | 1 | regular:regular:495474296, regular:regular:18744074, regular:regular:7657916, regular:regular:297646198, regular:regular:886246380, regular:regular:719362354 |
...
| challenge-stage-stingray-hook | 11 | boss-entry-or-dive, boss-looping-arc, challenge-boss-led-loop, challenge-crown-split-cascade, challenge-hook-arc, challenge-lane-wave, challenge-sweeping-path, entry-arc-to-rack, entry-galboss-low-hook-entry, escort-paired-dive, player-pressure-dive, rack-slot-settle | 80/80 |
