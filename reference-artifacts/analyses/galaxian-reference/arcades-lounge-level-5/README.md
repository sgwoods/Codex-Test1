# GALAXIAN (1979) - LEVEL 5 passed ! Video game - ARCADE'S LOUNGE
...
- source manifest: `reference-artifacts/analyses/galaxian-reference/arcades-lounge-level-5/source-manifest.json`
- contact sheet: `private-artifacts/repo-mirror/reference-artifacts/analyses/galaxian-reference/arcades-lounge-level-5/frames/contact-sheet-reference-window.jpg`
- waveform: `private-artifacts/repo-mirror/reference-artifacts/analyses/galaxian-reference/arcades-lounge-level-5/audio/waveform-reference-window.png`
