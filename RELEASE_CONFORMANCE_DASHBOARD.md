...
Generated: `2026-05-17T02:19:01.766Z`
...
| Metric points scanned | 1627 | History depth behind score trends |
| Score deltas found | 149 | Past-goal movement available for review |
| Measured runs | 738 | Tracked harness/model/local compute work |
| Tracked wall time | 562.2 min | Human clock-time planning input |
| Tracked CPU time | 807 min | Local compute-cost planning input |
| Tracked artifact growth | 1193.1 MB | Evidence volume and storage/review-cost proxy |
...
| --- | --- | --- | --- | --- |
| Audio conformance and cue feedback | 463 | 467.9 min | 91.4% | Moves the moment-to-moment arcade feel: impact clarity, ambience identity, reward/loss feedback, and player understanding. |
| Gameplay behavior and level complexity | 259 | 36.2 min | 7.1% | Moves player-facing pressure, stage shape, alien entry novelty, challenge-stage learning value, and long-play texture. |
| Harness, ingestion, and assessment logic | 7 | 8.1 min | 1.6% | Moves reusable automation: scorers, artifact extraction, candidate loops, measurement confidence, and future game ingestion. |
...
| --- | --- | --- | --- |
| cpu | 718 | 486.8 min | 760.5 min |
| browser | 266 | 372.8 min | 561.1 min |
...
| challenge-perfect | 51 | 154.7 min | 131.4 min |
| audio-theme-comparison | 32 | 74.2 min | 80.6 min |
| audio-focus-candidate | 37 | 73.9 min | 137.2 min |
...
| 2 | Aurora audio cue comparison and event-gap reports | audio cue scoring | waveform/spectral/alignment/semantic reports | 21 compared cues; semantic 9.78/10; 0 attention rows | semantic-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-event-gap/2026-05-17-612f086f-dirty-021525/report.json | Tune the highest segment-level gap next: gameOver onset. Rerun audio comparison and event-gap analysis after the change. |
| 3 | Aurora Audio Conformance Lab v2 | audio candidate loop / family promotion decisions | cue-family risk, candidate history, keeper decision, promotion gate | 8/8 target cues swept; 2 keeper candidates tracked; runtime promotions 1; rejected runtime trials 2 | family-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-conformance-lab-v2/2026-05-17-612f086f-dirty/report.json | playerHit: Build a contract-aware playerHit candidate/pass that either separates death onset/body/tail into runtime cue phases or improves the scoring/capture strategy so the active body is evaluated against the intended sub-event. |
| 4 | Aurora audio cue contracts | audio semantic contract / theme latitude / promotion safety | cue contract readiness, theme lanes, runtime-trial blockers | 8 contracts; readiness 9.2/10; blocked 5; rejected trials 2 | contract-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-cue-contracts/2026-05-17-612f086f-dirty-021822/report.json | Run a contract-aware candidate pass for rescueJoin, then rerun promotion precheck and live validation. |
| 5 | Aurora audio runtime trial decisions | audio promotion evidence / release guardrails | accepted, rejected, and inconclusive live runtime-trial outcomes | challengePerfect runtime-trial-rejected; candidate perfect-onset-body-separated-soft-tail | trial-recorded | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-runtime-trials/2026-05-17-612f086f-dirty-021812-challenge-perfect-rejected/report.json | Do not promote Challenge Perfect runtime audio yet. Keep the new harness evidence, stabilize repeated full-theme capture, then compare bossHit, challengeTransition, and gameOver for the next best audio return. |
...
![score-trends](reference-artifacts/analyses/conformance-economics/2026-05-17-612f086f/score-trends.svg)
...
![cpu-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-17-612f086f/cpu-use-by-purpose.svg)
...
- Quality report: `reference-artifacts/analyses/quality-conformance/2026-05-17-612f086f/report.json`
- Investment priority report: `reference-artifacts/analyses/conformance-investment-priorities/2026-05-17-612f086f/report.json`
- Level-arc report: `reference-artifacts/analyses/level-arc-conformance/2026-05-17-612f086f/report.json`
- Economics report: `reference-artifacts/analyses/conformance-economics/2026-05-17-612f086f/report.json`
