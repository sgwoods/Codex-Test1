...
Generated: `2026-05-09T22:04:10.617Z`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Audio identity, event feedback, and cue alignment | 6.8/10 | medium-high | 21 cue/event comparisons with waveform, spectral, overlap, alignment, and semantic event-mapping features | high; cpu, model-api, openai-api | 160 runs; 116.1 min wall; 208.2 min CPU | 7.5-8.0 | Measured release category; weakest axis | Largest current score gap and high user-experience impact: shots, explosions, boss damage, challenge results, capture/rescue feedback. | High; 3-6 hrs local/model-assisted analysis | Run a contract-aware stagePulse onset candidate pass that scores pressure cadence, onset band shape, and masking against shots/hits before any runtime promotion trial. | reference-artifacts/analyses/quality-conformance/2026-05-09-bbcc8df1/report.json |
...
| Measured runs | 331 | Tracked harness/model/local compute work |
| Tracked wall time | 184.2 min | Human clock-time planning input |
| Tracked CPU time | 316 min | Local compute-cost planning input |
| Tracked artifact growth | 546.4 MB | Evidence volume and storage/review-cost proxy |

### Resource And Time Usage

| Resource | Measured runs | Wall time | CPU time |
| --- | --- | --- | --- |
| cpu | 330 | 184.2 min | 316 min |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Audio identity, event feedback, and cue alignment | 6.8/10 | 7.5-8.0 | +0.7 | High; 3-6 hrs local/model-assisted analysis | cpu, model-api, openai-api | 160 runs; 116.1 min wall; 208.2 min CPU | Expected lift 0.7/10 on metric, 0.058/10 overall; investment score 3.08. | Run a contract-aware stagePulse onset candidate pass that scores pressure cadence, onset band shape, and masking against shots/hits before any runtime promotion trial. |
...
| 3 | Aurora Audio Conformance Lab v2 | audio candidate loop / family promotion decisions | cue-family risk, candidate history, keeper decision, promotion gate | 8/8 target cues swept; 5 keeper candidates tracked; runtime promotions 4 | family-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-conformance-lab-v2/2026-05-09-7edb5802-dirty/report.json | Run a contract-aware stagePulse onset candidate pass that scores pressure cadence, onset band shape, and masking against shots/hits before any runtime promotion trial. |
| 4 | Aurora audio cue contracts | audio semantic contract / theme latitude / promotion safety | cue contract readiness, theme lanes, runtime-trial blockers | 8 contracts; readiness 8.9/10; blocked 3 | contract-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-cue-contracts/2026-05-09-7edb5802-dirty-215835/report.json | Run a contract-aware stagePulse onset candidate pass that scores pressure cadence, onset band shape, and masking against shots/hits before any runtime promotion trial. |
...
![score-trends](reference-artifacts/analyses/conformance-economics/2026-05-09-7edb5802/score-trends.svg)

![largest-score-deltas](reference-artifacts/analyses/conformance-economics/2026-05-09-7edb5802/largest-score-deltas.svg)

![compute-minutes-by-resource](reference-artifacts/analyses/conformance-economics/2026-05-09-7edb5802/compute-minutes-by-resource.svg)

![cost-per-positive-score-point](reference-artifacts/analyses/conformance-economics/2026-05-09-7edb5802/cost-per-positive-score-point.svg)
...
- Investment priority report: `reference-artifacts/analyses/conformance-investment-priorities/2026-05-09-7edb5802/report.json`
- Level-arc report: `reference-artifacts/analyses/level-arc-conformance/2026-05-09-bbcc8df1/report.json`
- Economics report: `reference-artifacts/analyses/conformance-economics/2026-05-09-7edb5802/report.json`
