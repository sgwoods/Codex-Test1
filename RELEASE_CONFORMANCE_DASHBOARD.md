...
Generated: `2026-05-15T17:49:16.345Z`
...
| Metric points scanned | 1429 | History depth behind score trends |
| Score deltas found | 144 | Past-goal movement available for review |
| Measured runs | 568 | Tracked harness/model/local compute work |
| Tracked wall time | 394.6 min | Human clock-time planning input |
| Tracked CPU time | 654 min | Local compute-cost planning input |
| Tracked artifact growth | 941.1 MB | Evidence volume and storage/review-cost proxy |
...
| 4 | Boss entry and formation grammar | 9.4/10 | 8.0-8.5 first gate; 9.0+ with path/slot extraction | at target | Medium-high; 2-5 hrs, then recurring low-cost guardrail | cpu, browser | 160 runs; 24 min wall; 39.7 min CPU | Expected lift 0.28/10 on metric, 0.023/10 overall; investment score 0.79. | Advance Path shape and set-formation precision: 600 tracks classified into path families; expected family coverage 1; accepted Galaga labels 6 regular / 4 challenge; cap 8.2/10 (media-backed-reference-label-cap). |
...
| 2 | Aurora audio cue comparison and event-gap reports | audio cue scoring | waveform/spectral/alignment/semantic reports | 21 compared cues; semantic 9.78/10; 0 attention rows | semantic-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-event-gap/2026-05-15-d43b188a-dirty-174826/report.json | Tune the highest segment-level gap next: challengePerfect onset. Rerun audio comparison and event-gap analysis after the change. |
...
![score-trends](reference-artifacts/analyses/conformance-economics/2026-05-15-d43b188a/score-trends.svg)
...
![cpu-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-15-d43b188a/cpu-use-by-purpose.svg)
...
- Quality report: `reference-artifacts/analyses/quality-conformance/2026-05-15-d43b188a/report.json`
...
- Level-arc report: `reference-artifacts/analyses/level-arc-conformance/2026-05-15-d43b188a/report.json`
- Economics report: `reference-artifacts/analyses/conformance-economics/2026-05-15-d43b188a/report.json`
