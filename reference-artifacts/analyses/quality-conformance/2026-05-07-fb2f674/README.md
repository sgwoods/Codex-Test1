...
- Read: Close-shot responsiveness passed, and movement-fire post-shot travel was 52.23, with shot delay -7ms.
...
- Read: Level arc score is 8.2/10 with 6/6 stage families blueprinted and 6/6 evidence windows present; weakest submetric is Pressure curve over time (7.5/10).
