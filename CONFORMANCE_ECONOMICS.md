...
Generated: `2026-05-18T21:08:34.926Z`
Latest artifact: `reference-artifacts/analyses/conformance-economics/2026-05-18-026ccefc/report.json`
...
| Measured runs | 803 | Commands or manual entries logged in the economics ledger. |
| Local CPU tracked wall | 532.1 min | Main measured engine for harness execution, report generation, waveform/spectral work, and scoring. |
| Browser-backed local wall | 399.6 min | Subset of local work that exercised Chromium/gameplay runtime. |
| GPU-equivalent tracked wall | 630.8 min | Declared Codex/model/API/GPU usage. This is currently small and under-instrumented. |
| GPU-equivalent share | 68.4% | Approximate declared cloud/model share of tracked wall time. |
| Artifact growth | 1303.2 MB | Evidence volume and review/storage-cost proxy. |
...
| --- | --- | --- | --- | --- |
| gpu-equivalent | 18 | 630.8 min | 1.2 min | 68.4% |
| cpu | 779 | 532.1 min | 846 min | 57.7% |
| browser | 289 | 399.6 min | 614 min | 43.3% |
| codex | 13 | 365.7 min | 1.2 min | 39.6% |
| openai-gpu-equivalent | 1 | 75 min | 0 min | 8.1% |
| model-api | 2 | 25 min | 0 min | 2.7% |
...
| challenge-stage | 81 | 81.8 min | 12 min |
...
![Conformance score trends](reference-artifacts/analyses/conformance-economics/2026-05-18-026ccefc/score-trends.svg)
...
![Local CPU use by purpose](reference-artifacts/analyses/conformance-economics/2026-05-18-026ccefc/cpu-use-by-purpose.svg)
