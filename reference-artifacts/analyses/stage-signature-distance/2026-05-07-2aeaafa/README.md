...
- Windows: 6
- Pairs: 15
- Signature score: 6.4/10
- Mean distance: 0.273
- Minimum distance: 0.129
- Distinct pair ratio: 0.4
- Repetition risk: 0.414
- Closest pair: late-run-cleanup-or-failure / mid-run-entry-variant (0.129)
- Most distinct pair: challenge-stage-candidate / late-run-escort-variant (0.474)
- Regular windows: 5
- Mean regular distance: 0.188
- Minimum regular distance: 0.129
- Minimum mid/late distance: 0.129
- Closest mid/late pair: late-run-cleanup-or-failure / mid-run-entry-variant (0.129)
- Closest same-band regular pair: mid-run-entry-variant / mid-run-pressure (0.174)
...
- Stage band: mid
- Challenge: false
- Observed event families: enemy_dive_start, enemy_projectile, flank_dive_start, formation_entry
- Pressure read: max attackers 2, max enemy bullets 2, max challenge enemies 0
...
| Pair | Distance |
| --- | ---: |
| late-run-cleanup-or-failure / mid-run-entry-variant | 0.129 |
| late-run-escort-variant / mid-run-pressure | 0.137 |
| mid-run-entry-variant / mid-run-pressure | 0.174 |
| late-run-cleanup-or-failure / mid-run-pressure | 0.178 |
| mid-run-entry-variant / stage-1-baseline | 0.183 |
| late-run-cleanup-or-failure / late-run-escort-variant | 0.198 |
| late-run-cleanup-or-failure / stage-1-baseline | 0.199 |
| late-run-escort-variant / mid-run-entry-variant | 0.202 |
| mid-run-pressure / stage-1-baseline | 0.213 |
| late-run-escort-variant / stage-1-baseline | 0.262 |
| challenge-stage-candidate / late-run-cleanup-or-failure | 0.431 |
| challenge-stage-candidate / stage-1-baseline | 0.431 |
| challenge-stage-candidate / mid-run-entry-variant | 0.44 |
| challenge-stage-candidate / mid-run-pressure | 0.45 |
