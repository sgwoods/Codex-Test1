...
2. if yes, mirror the generated bytes into the companion private store
3. add or update a nearby `private-storage.json` pointer in the public repo
4. keep the public lane limited to summaries, latest aliases, and decision
