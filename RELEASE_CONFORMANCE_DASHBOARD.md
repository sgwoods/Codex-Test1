...
Generated: `2026-05-14T18:06:13.295Z`
...
| Audio identity | 6.9/10 | >=7.5 | Primary user-experience gap |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Audio identity, event feedback, and cue alignment | 6.9/10 | medium-high | 21 cue/event comparisons with waveform, spectral, overlap, alignment, and semantic event-mapping features | high; cpu, model-api, openai-api | 278 runs; 200 min wall; 359.1 min CPU | 7.5-8.0 | Measured release category; weakest axis | Largest current score gap and high user-experience impact: shots, explosions, boss damage, challenge results, capture/rescue feedback. | High; 3-6 hrs local/model-assisted analysis | Keep the calibrated layered playerHit runtime cue; next either refine the residual playerHit tail/body gap with the same calibrated scorer or move effort to stagePulse pressure-bed strategy if user impact per compute looks higher. | reference-artifacts/analyses/quality-conformance/2026-05-14-1c788342/report.json; reference-artifacts/analyses/aurora-audio-cue-contracts/2026-05-11-b83393cd-dirty-201628/report.json |
...
| Metric points scanned | 1274 | History depth behind score trends |
| Score deltas found | 137 | Past-goal movement available for review |
| Measured runs | 529 | Tracked harness/model/local compute work |
| Tracked wall time | 349.4 min | Human clock-time planning input |
| Tracked CPU time | 561 min | Local compute-cost planning input |
| Tracked artifact growth | 851.8 MB | Evidence volume and storage/review-cost proxy |
...
| --- | --- | --- | --- | --- |
| Audio conformance and cue feedback | 379 | 294.6 min | 90.8% | Moves the moment-to-moment arcade feel: impact clarity, ambience identity, reward/loss feedback, and player understanding. |
| Gameplay behavior and level complexity | 138 | 25 min | 7.7% | Moves player-facing pressure, stage shape, alien entry novelty, challenge-stage learning value, and long-play texture. |
...
| --- | --- | --- | --- |
| cpu | 527 | 324.4 min | 561 min |
| browser | 200 | 210.6 min | 369.2 min |
...
| 2 | Aurora audio cue comparison and event-gap reports | audio cue scoring | waveform/spectral/alignment/semantic reports | 21 compared cues; semantic 9.78/10; 0 attention rows | semantic-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-event-gap/2026-05-14-1c788342-dirty-180248/report.json | Tune the highest segment-level gap next: captureBeam tail. Rerun audio comparison and event-gap analysis after the change. |
...
![score-trends](reference-artifacts/analyses/conformance-economics/2026-05-14-1c788342/score-trends.svg)

![largest-score-deltas](reference-artifacts/analyses/conformance-economics/2026-05-14-1c788342/largest-score-deltas.svg)
...
![gpu-equivalent-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-14-1c788342/gpu-equivalent-use-by-purpose.svg)

![cpu-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-14-1c788342/cpu-use-by-purpose.svg)

![gameplay-improvement-by-project-part](reference-artifacts/analyses/conformance-economics/2026-05-14-1c788342/gameplay-improvement-by-project-part.svg)
...
- Quality report: `reference-artifacts/analyses/quality-conformance/2026-05-14-1c788342/report.json`
...
- Level-arc report: `reference-artifacts/analyses/level-arc-conformance/2026-05-14-1c788342/report.json`
- Economics report: `reference-artifacts/analyses/conformance-economics/2026-05-14-1c788342/report.json`
