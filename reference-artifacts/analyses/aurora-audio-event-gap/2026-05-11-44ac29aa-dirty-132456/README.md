...
Generated: `2026-05-11T13:24:56.154Z`
...
- Strongest improvement: highScoreOther (-0.29)
- Strongest regression: challengeResults (+0.68)

| Cue | Gap delta | Segment delta | Duration delta | Centroid delta |
| --- | ---: | ---: | ---: | ---: |
| challengeResults | -0.57 | 0.68 | 0.038s | 57.5 Hz |
| gameStart | -0.19 | 0.44 | -0.02s | 9.8 Hz |
| highScoreOther | -0.19 | -0.29 | -0.002s | 8.2 Hz |
| bossHit | -0.21 | -0.28 | -0.039s | -19.9 Hz |
| challengeTransition | -0.33 | -0.25 | 0.028s | 9.3 Hz |
| gameOver | -0.03 | -0.24 | -0.009s | 5.6 Hz |
| capturedFighterDestroyed | -0.04 | 0.21 | -0.05s | 3.2 Hz |
| highScoreFirst | 0.18 | -0.21 | 0.02s | 3.1 Hz |
| playerShot | 0.38 | 0.2 | 0.07s | 17.8 Hz |
| attractPulse | 0.1 | -0.18 | 0s | 16 Hz |
