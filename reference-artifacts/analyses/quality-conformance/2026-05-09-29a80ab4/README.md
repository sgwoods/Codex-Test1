...
- Read: Close-shot responsiveness passed, and movement-fire post-shot travel was 51.38, with shot delay -6ms.
...
- Read: Boss/formation grammar scores 8.4/10 across 6 evidence windows; weakest metric is Stage-to-stage formation variation (6/10).
