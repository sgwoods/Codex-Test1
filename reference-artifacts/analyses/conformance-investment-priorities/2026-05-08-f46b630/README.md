...
| ---: | --- | --- | ---: | ---: | ---: | --- |
| 1 | Tighten audio reference segmentation and cue matching | audio | 2.1 | 0.064 | 2.9 | Continue Challenge Perfect candidate generation around thin-bright-square-top; the latest sweep found no safe keeper, so do not promote a runtime cue yet. |
