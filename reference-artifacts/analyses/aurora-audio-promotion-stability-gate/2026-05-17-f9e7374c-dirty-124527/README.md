...
Generated: `2026-05-17T12:45:27.799Z`
...
| --- | --- | ---: | --- | --- | --- |
| `challengePerfect` | `stability-gate-reject` | 7.7 | range 2.49, threshold 1.88 | cue 6.04, segment 2.92 | Global audio scoring is unstable (19/21 cues volatile; most volatile captureBeam 3.89/10), so runtime promotion is blocked until scorer/capture stability improves. |
| `gameOver` | `stability-gate-reject` | 3.79 | range 1.34, threshold 1.16 | cue 1.41, segment 1.9 | Global audio scoring is unstable (19/21 cues volatile; most volatile captureBeam 3.89/10), so runtime promotion is blocked until scorer/capture stability improves. |
| `challengeTransition` | `stability-gate-reject` | 4.11 | range 1.12, threshold 0.86 | cue 2.01, segment 1.67 | Global audio scoring is unstable (19/21 cues volatile; most volatile captureBeam 3.89/10), so runtime promotion is blocked until scorer/capture stability improves. |
