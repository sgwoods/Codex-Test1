...
Generated: `2026-05-10T18:49:06.668Z`
...
- Source metrics: `reference-artifacts/analyses/aurora-audio-promotion-precheck/2026-05-10-705e445c-dirty-184906-stagePulse/candidate-theme-metrics.json`
- Compared cues: 21
...
- Highest-risk cue changed: yes (stagePulse -> attractPulse)
- Strongest improvement: stagePulse (-0.22)
- Strongest regression: none

| Cue | Gap delta | Segment delta | Duration delta | Centroid delta |
| --- | ---: | ---: | ---: | ---: |
| stagePulse | -2.2 | -0.22 | 0.052s | -130.4 Hz |
...
| ---: | --- | --- | ---: | --- | --- | ---: | ---: | --- | ---: | --- |
| 1 | attractPulse | Demo Pulse | 4.29 | high | single-reference-body | 0.011s | 610.5 Hz | onset | 5.24 | Tune the onset segment first: onset timbre is the leading gap: band shape/rolloff differ from the reference segment. |
| 2 | challengeResults | Challenge Results | 3.53 | medium-high | curated-reference-segmentation | 0.041s | 404.1 Hz | onset | 5.53 | Tune the onset segment first: onset timbre is the leading gap: band shape/rolloff differ from the reference segment. |
| 3 | rescueJoin | Rescue Join | 3.44 | high | single-reference-body | 0.141s | 393.9 Hz | onset | 5.13 | Tune the onset segment first: onset timbre is the leading gap: band shape/rolloff differ from the reference segment. |
| 4 | bossBoom | Boss Boom | 3.15 | medium-high | curated-reference-segmentation | 0.039s | 197.7 Hz | onset | 5.07 | Tune the onset segment first: onset timbre is the leading gap: band shape/rolloff differ from the reference segment. |
| 5 | stagePulse | Formation Pulse (promotion precheck) | 3.03 | high | single-reference-body | 0.081s | 694.7 Hz | onset | 7.03 | Tune the onset segment first: onset timbre is the leading gap: band shape/rolloff differ from the reference segment. |
