...
Generated: `2026-05-18T21:08:34.696Z`
...
| Challenge-stage set-piece conformance | 4.1/10 | >=5.0 before next beta claim; >=6.0 next major gate; >=9.0 mature | Strict movement/graphics/alien-novelty gate; safety does not inflate this score |
| Direct target sprite conformance | 4.5/10 | >=5.5 before next beta claim; >=7.5 mature preview | Strict runtime-vs-promoted-target-crop row; static proxy scores do not satisfy this gate |
...
| Metric points scanned | 1878 | History depth behind score trends |
| Score deltas found | 161 | Past-goal movement available for review |
| Measured runs | 803 | Tracked harness/model/local compute work |
| Tracked wall time | 922.5 min | Human clock-time planning input |
| Tracked CPU time | 892.4 min | Local compute-cost planning input |
| Tracked artifact growth | 1303.2 MB | Evidence volume and storage/review-cost proxy |
...
| --- | --- | --- | --- | --- |
| Audio conformance and cue feedback | 509 | 504.1 min | 90.4% | Moves the moment-to-moment arcade feel: impact clarity, ambience identity, reward/loss feedback, and player understanding. |
| Gameplay behavior and level complexity | 267 | 45.1 min | 8.1% | Moves player-facing pressure, stage shape, alien entry novelty, challenge-stage learning value, and long-play texture. |
...
| Visual and video reference analysis | 8 | 0.2 min | 0% | Moves graphical identity, reference inspection, contact-sheet review, sprite/surface comparison, and readability. |
...
| cpu | 779 | 532.1 min | 846 min |
| browser | 289 | 399.6 min | 614 min |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Challenge-stage set-piece conformance: movement, graphics, alien novelty | 4.1/10 | >=5.0 before next beta claim; 6.0 after three authored challenges; 9.0+ mature | +0.9 | High; long-cycle CPU/browser extraction plus gameplay authoring and sprite-motion/reference labeling | cpu, browser, gpu | 161 runs; 24 min wall; 39.7 min CPU | Expected lift 1.8/10 on metric, 0.138/10 overall; investment score 8.4. | Stage 3: rebuild Challenging Stage 1 against the Galaga challenge-1 arrival and late-wave references with visibly longer movement and readable exits. |
...
| 4.5 | Direct target sprite and impact feedback conformance | 4.5/10 | >=5.5 before next beta claim; >=7.5 mature preview | +1 | Medium-high; 2-5 hrs renderer/crop/harness work plus visual review | cpu | 15 runs; 16.6 min wall; 19.2 min CPU | Estimated cost/value; dedicated investment candidate not yet generated. | Raise direct sprite target score and impact/explosion feedback together; current impact/explosion static read is 5.9/10. |
...
| 2 | Aurora audio cue comparison and event-gap reports | audio cue scoring | waveform/spectral/alignment/semantic reports | 21 compared cues; semantic 9.78/10; 0 attention rows | semantic-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-event-gap/2026-05-18-026ccefc-dirty-210825/report.json | Tune the highest segment-level gap next: challengePerfect onset. Rerun audio comparison and event-gap analysis after the change. |
...
![score-trends](reference-artifacts/analyses/conformance-economics/2026-05-18-026ccefc/score-trends.svg)

![largest-score-deltas](reference-artifacts/analyses/conformance-economics/2026-05-18-026ccefc/largest-score-deltas.svg)

![compute-minutes-by-resource](reference-artifacts/analyses/conformance-economics/2026-05-18-026ccefc/compute-minutes-by-resource.svg)

![cost-per-positive-score-point](reference-artifacts/analyses/conformance-economics/2026-05-18-026ccefc/cost-per-positive-score-point.svg)

![gpu-equivalent-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-18-026ccefc/gpu-equivalent-use-by-purpose.svg)

![cpu-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-18-026ccefc/cpu-use-by-purpose.svg)

![gameplay-improvement-by-project-part](reference-artifacts/analyses/conformance-economics/2026-05-18-026ccefc/gameplay-improvement-by-project-part.svg)
...
- Quality report: `reference-artifacts/analyses/quality-conformance/2026-05-18-026ccefc/report.json`
...
- Level-arc report: `reference-artifacts/analyses/level-arc-conformance/2026-05-18-026ccefc/report.json`
- Economics report: `reference-artifacts/analyses/conformance-economics/2026-05-18-026ccefc/report.json`
