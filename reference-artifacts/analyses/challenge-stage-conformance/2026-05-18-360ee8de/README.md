...
Generated: 2026-05-18T20:10:04.130Z
Commit: 360ee8de
...
**Current score:** interesting factor 4.1/10; challenge conformance 4/10. Movement 3.8/10, graphics 4.3/10, alien novelty 3.9/10, progression 3.2/10, player shot opportunity 5.5/10.
...
**Aurora current:** first-challenge-peel / first-challenge-peel; lanes bee, bee, bee, bee, but, but, but, but; first-wave types bee, bee, bee, bee, but, but, but, but; visual families classic; strict movement 3.8/10, graphics 4.3/10, alien novelty 3.9/10, shot opportunity 5.5/10.

**Graphics read:** Strict graphics score 4.3/10. Current visible family/type labels are present, Direct runtime-vs-Galaga target-crop comparator reads 4.21/10 overall and 4.33/10 for challenge specialty sprites; weakest challenge crop is challenge-dragonfly at 4.25/10. Runtime sprite-motion hook observed 1 visual family/families, 3 path pose family/families, 6/6 animation phase buckets, both flap state(s), and 40 object-tracked silhouette track(s). Graphics remain capped at 4.8/10 until object tracks are compared as full temporal Galaga target-crop sequences, rotations, dive poses, and capture/rescue transitions.

**Movement read:** Strict movement score 3.8/10 against challenge-1-late-wave-group-4: y-range fit 1, path-length fit 1, turn fit 1. Current probes are still sampled summaries, so full temporal choreography is not yet proven. Legacy broad vector best-match was 8.6/10 against challenge-1-late-wave-group-4; xRange 1.4, yRange 0.7642, pathLength 0.7599.
...
**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 15 sampled windows; 73% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.3.
...
**Aurora current:** scorpion-cross-sweep / cross-sweep; lanes but, boss, rogue, bee, bee, rogue, boss, but; first-wave types but, boss, rogue, bee, bee, rogue, boss, but; visual families classic; strict movement 4/10, graphics 4/10, alien novelty 3.9/10, shot opportunity 5.3/10.

**Graphics read:** Strict graphics score 4/10. Current visible family/type labels are present, Direct runtime-vs-Galaga target-crop comparator reads 4.21/10 overall and 4.33/10 for challenge specialty sprites; weakest challenge crop is challenge-dragonfly at 4.25/10. Runtime sprite-motion hook observed 3 visual family/families, 3 path pose family/families, 6/6 animation phase buckets, both flap state(s), and 39 object-tracked silhouette track(s). Graphics remain capped at 4.8/10 until object tracks are compared as full temporal Galaga target-crop sequences, rotations, dive poses, and capture/rescue transitions.
...
**Aurora current:** stingray-crown-hook-hybrid / hook-arc; lanes boss, rogue, but, bee, boss, bee, but, rogue; first-wave types boss, rogue, but, bee, boss, bee, but, rogue; visual families dragonfly; strict movement 4/10, graphics 4.5/10, alien novelty 3.9/10, shot opportunity 5.3/10.

**Graphics read:** Strict graphics score 4.5/10. Current visible family/type labels are present, Direct runtime-vs-Galaga target-crop comparator reads 4.21/10 overall and 4.33/10 for challenge specialty sprites; weakest challenge crop is challenge-dragonfly at 4.25/10. Runtime sprite-motion hook observed 3 visual family/families, 3 path pose family/families, 6/6 animation phase buckets, both flap state(s), and 38 object-tracked silhouette track(s). Graphics remain capped at 4.8/10 until object tracks are compared as full temporal Galaga target-crop sequences, rotations, dive poses, and capture/rescue transitions.
...
**Aurora current:** pink-serpentine-late / pink-serpentine; lanes boss, rogue, but, bee, bee, but, rogue, boss; first-wave types boss, rogue, but, bee, bee, but, rogue, boss; visual families galboss; strict movement 4.1/10, graphics 4.5/10, alien novelty 3.9/10, shot opportunity 5.3/10.

**Graphics read:** Strict graphics score 4.5/10. Current visible family/type labels are present, Direct runtime-vs-Galaga target-crop comparator reads 4.21/10 overall and 4.33/10 for challenge specialty sprites; weakest challenge crop is challenge-dragonfly at 4.25/10. Runtime sprite-motion hook observed 2 visual family/families, 3 path pose family/families, 6/6 animation phase buckets, both flap state(s), and 37 object-tracked silhouette track(s). Graphics remain capped at 4.8/10 until object tracks are compared as full temporal Galaga target-crop sequences, rotations, dive poses, and capture/rescue transitions.
...
**Aurora current:** pink-green-cascade / pink-green-cascade; lanes rogue, boss, but, bee, boss, but, bee, rogue; first-wave types rogue, boss, but, bee, boss, but, bee, rogue; visual families galboss; strict movement 4.1/10, graphics 4.5/10, alien novelty 3.9/10, shot opportunity 5.4/10.
...
**Aurora current:** green-ladder-split / green-ladder-split; lanes bee, but, rogue, boss, boss, rogue, but, bee; first-wave types bee, but, rogue, boss, boss, rogue, but, bee; visual families dragonfly; strict movement 4.2/10, graphics 4.4/10, alien novelty 3.9/10, shot opportunity 5.6/10.

**Graphics read:** Strict graphics score 4.4/10. Current visible family/type labels are present, Direct runtime-vs-Galaga target-crop comparator reads 4.21/10 overall and 4.33/10 for challenge specialty sprites; weakest challenge crop is challenge-dragonfly at 4.25/10. Runtime sprite-motion hook observed 2 visual family/families, 1 path pose family/families, 6/6 animation phase buckets, both flap state(s), and 40 object-tracked silhouette track(s). Graphics remain capped at 4.8/10 until object tracks are compared as full temporal Galaga target-crop sequences, rotations, dive poses, and capture/rescue transitions.
...
**Aurora current:** yellow-diagonal-fan / yellow-diagonal-fan; lanes boss, bee, but, rogue, rogue, but, bee, boss; first-wave types boss, bee, but, rogue, rogue, but, bee, boss; visual families crown; strict movement 4.1/10, graphics 4.4/10, alien novelty 3.9/10, shot opportunity 4.9/10.

**Graphics read:** Strict graphics score 4.4/10. Current visible family/type labels are present, Direct runtime-vs-Galaga target-crop comparator reads 4.21/10 overall and 4.33/10 for challenge specialty sprites; weakest challenge crop is challenge-dragonfly at 4.25/10. Runtime sprite-motion hook observed 1 visual family/families, 1 path pose family/families, 6/6 animation phase buckets, both flap state(s), and 32 object-tracked silhouette track(s). Graphics remain capped at 4.8/10 until object tracks are compared as full temporal Galaga target-crop sequences, rotations, dive poses, and capture/rescue transitions.
...
**Aurora current:** blue-purple-finale / blue-purple-finale; lanes rogue, boss, bee, but, but, bee, boss, rogue; first-wave types rogue, boss, bee, but, but, bee, boss, rogue; visual families stingray; strict movement 4.1/10, graphics 4.5/10, alien novelty 3.9/10, shot opportunity 5.3/10.
...
- Raise challenge-stage interesting factor from 4.2/10 to 3.5/10 as the first honest gate by implementing one visibly reference-like challenge, then toward 6.0/10 after Stage 3, 7, and 11 each have distinct authored contracts.
