...
Generated: `2026-05-15T20:25:32.186Z`
...
| Metric points scanned | 1451 | History depth behind score trends |
| Score deltas found | 146 | Past-goal movement available for review |
| Measured runs | 600 | Tracked harness/model/local compute work |
| Tracked wall time | 412.7 min | Human clock-time planning input |
| Tracked CPU time | 685.9 min | Local compute-cost planning input |
| Tracked artifact growth | 991.1 MB | Evidence volume and storage/review-cost proxy |
...
| --- | --- | --- | --- | --- |
| Audio conformance and cue feedback | 411 | 353.4 min | 91.1% | Moves the moment-to-moment arcade feel: impact clarity, ambience identity, reward/loss feedback, and player understanding. |
| Gameplay behavior and level complexity | 174 | 26.2 min | 6.8% | Moves player-facing pressure, stage shape, alien entry novelty, challenge-stage learning value, and long-play texture. |
| Harness, ingestion, and assessment logic | 7 | 8.1 min | 2.1% | Moves reusable automation: scorers, artifact extraction, candidate loops, measurement confidence, and future game ingestion. |
...
| --- | --- | --- | --- |
| cpu | 588 | 373.4 min | 660.1 min |
| browser | 223 | 254.3 min | 449.6 min |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Audio identity, event feedback, and cue alignment | 7.3/10 | 7.5-8.0 | +0.2 | High; 3-6 hrs local/model-assisted analysis | cpu, model-api, openai-api | 305 runs; 243.2 min wall; 439.9 min CPU | Expected lift 0.7/10 on metric, 0.058/10 overall; investment score 2.89. | Keep the calibrated layered playerHit runtime cue; next either refine the residual playerHit tail/body gap with the same calibrated scorer or move effort to stagePulse pressure-bed strategy if user impact per compute looks higher. |
| 2 | Alien entry and challenge-stage novelty | 8.3/10 | 7.5 first gate; 9.0+ mature | at target | High; long-cycle CPU/browser extraction plus reference contact-sheet and path-labeling pass | cpu, browser | 213 runs; 25.9 min wall; 43.3 min CPU | Estimated cost/value; dedicated investment candidate not yet generated. | Attack Regular-entry geometry separation: Minimum regular geometry distance 0.086; mean regular geometry distance 0.146; closest pair mid-run-entry-variant / late-run-cleanup-or-failure. |
...
| 2 | Aurora audio cue comparison and event-gap reports | audio cue scoring | waveform/spectral/alignment/semantic reports | 21 compared cues; semantic 9.78/10; 0 attention rows | semantic-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-event-gap/2026-05-15-c8c7246f-dirty-201945/report.json | Tune the highest segment-level gap next: challengePerfect onset. Rerun audio comparison and event-gap analysis after the change. |
| 3 | Aurora Audio Conformance Lab v2 | audio candidate loop / family promotion decisions | cue-family risk, candidate history, keeper decision, promotion gate | 8/8 target cues swept; 1 keeper candidates tracked; runtime promotions 1 | family-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-conformance-lab-v2/2026-05-15-c8c7246f-dirty/report.json | Keep the calibrated layered playerHit runtime cue; next either refine the residual playerHit tail/body gap with the same calibrated scorer or move effort to stagePulse pressure-bed strategy if user impact per compute looks higher. |
...
![score-trends](reference-artifacts/analyses/conformance-economics/2026-05-15-c8c7246f/score-trends.svg)

![largest-score-deltas](reference-artifacts/analyses/conformance-economics/2026-05-15-c8c7246f/largest-score-deltas.svg)

![compute-minutes-by-resource](reference-artifacts/analyses/conformance-economics/2026-05-15-c8c7246f/compute-minutes-by-resource.svg)

![cost-per-positive-score-point](reference-artifacts/analyses/conformance-economics/2026-05-15-c8c7246f/cost-per-positive-score-point.svg)

![gpu-equivalent-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-15-c8c7246f/gpu-equivalent-use-by-purpose.svg)

![cpu-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-15-c8c7246f/cpu-use-by-purpose.svg)

![gameplay-improvement-by-project-part](reference-artifacts/analyses/conformance-economics/2026-05-15-c8c7246f/gameplay-improvement-by-project-part.svg)
...
- Quality report: `reference-artifacts/analyses/quality-conformance/2026-05-15-c8c7246f/report.json`
- Investment priority report: `reference-artifacts/analyses/conformance-investment-priorities/2026-05-15-c8c7246f/report.json`
- Level-arc report: `reference-artifacts/analyses/level-arc-conformance/2026-05-15-c8c7246f/report.json`
- Economics report: `reference-artifacts/analyses/conformance-economics/2026-05-15-c8c7246f/report.json`
