...
- Score: 9.1/10
- Read: Boss/formation grammar scores 9.2/10; weakest metric is Path shape and set-formation precision (6.8/10).
...
- advance boss/formation grammar by targeting Path shape and set-formation precision: 600 tracks classified into path families; expected family coverage 1; capped score 6.8/10 until direct reference labels land.
