...
Generated: `2026-05-09T21:58:35.000Z`
...
| --- | --- | --- | --- | --- | --- |
| Aurora Galactica current dev line | 9.2/10 | strongest Player movement conformance 10/10; weakest Audio identity and cue alignment 6.8/10; audio contract readiness 8.94/10 | release-quality conformance score plus audio cue-contract read | Audio identity and cue alignment (6.8/10) | reference-artifacts/analyses/quality-conformance/2026-05-09-bbcc8df1/report.json; reference-artifacts/analyses/aurora-audio-cue-contracts/latest.json |
...
| --- | --- | --- | --- | --- | --- |
| Current dev baseline | 9.2/10 | audio 6.8; audio cue-contract readiness 8.94; movement 10; boss/formation 8.4; stage opening 8.5; challenge timing 9.9; shell integrity 9.2 | 7.7/10 reference; 6.9/10 playtest | maturity 7; gate coverage 9.5; public readiness 3.9; audio feel 6.4 | Baseline for the next beta-candidate discussion, with audio now separated into runtime quality and contract/process readiness. |
...
| Audio identity / acoustic fit | 6.8/10 runtime quality; 8.94/10 contract readiness | 7.2/10 in `1.3`; 7.6/10 in `1.4` | 6.4/10 playtest; 6.4/10 reference category | human-listened cue cleanup in `1.3`; 7.0/10 playtest in `1.4` | Audio is the weakest shared conformance area today; contracts now make the next improvements more repeatable. |
...
| Boss entry and formation grammar | 8.4/10 | >=8.0 first gate in `1.4`; >=9.0 with path/rack extraction | rack timing 6.2/10 reference category | frame-derived rack timing >=7.2; dive paths >=7.2 | Boss entry, escort composition, formation settling, and challenge set pieces are the arcade choreography players recognize by stage. |
| Stage / rack / wave timing | stage opening 8.5; challenge timing 9.9 | challenge and later-stage targets >= 8.6 in `1.4` | rack timing 6.2/10 | browser-reviewed rack timing in `1.3`; 7.2/10 in `1.4` | Timing separates authentic arcade pressure from approximate motion. |
...
| Shot and hit responsiveness | 10/10 | close-shot-hit, movement fire window | Close-shot responsiveness passed, and movement-fire post-shot travel was 51.38, with shot delay -6ms. |
...
| Boss entry and formation grammar | 8.4/10 | formation-boss-grammar-conformance report, stage-signature-distance report, level-expansion cycle evidence | Boss/formation grammar scores 8.4/10 across 6 evidence windows; weakest metric is Stage-to-stage formation variation (6/10). |
| Level arc and encounter shape | 8.4/10 | level-arc-conformance report, stage-signature-distance report, level-expansion cycle evidence | Level arc score is 8.4/10 with 6/6 stage families blueprinted and 6/6 evidence windows present; weakest submetric is Pressure curve over time (7.5/10). |
| Audio identity and cue alignment | 6.8/10 | audio-cue-contracts, audio-conformance-lab-v2, audio-cue-alignment correspondence, aurora-audio-theme-comparison, galaga-audio-overlap, aurora-audio-event-gap semantic read, audio-promotion-precheck | Audio now separates runtime quality from process readiness. Runtime audio is still weakest at 6.8/10, while cue-contract readiness is 8.94/10. Semantic event score is 9.78/10, acoustic event score is 5.6/10, average worst segment risk is 4.4/10, and the highest current gap is stagePulse onset. |
