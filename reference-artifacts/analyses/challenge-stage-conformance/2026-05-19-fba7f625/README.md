...
Generated: 2026-05-19T03:31:43.081Z
Commit: fba7f625
...
**Aurora current:** first-challenge-peel / first-challenge-peel; lanes bee, bee, bee, bee, but, but, but, but; first-wave types bee, bee, bee, bee, but, but, but, but; visual families classic; strict movement 4.2/10, graphics 4.3/10, alien novelty 3.9/10, shot opportunity 5.7/10, target-contract fit 6.8/10.
...
**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 47 sampled windows; 81% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.33.
...
**Current score:** interesting factor 4.2/10; challenge conformance 4.1/10. Movement 4.3/10, graphics 4/10, alien novelty 3.9/10, progression 3.2/10, player shot opportunity 5.6/10.
...
**Aurora current:** scorpion-cross-sweep / cross-sweep; lanes but, boss, rogue, bee, bee, rogue, boss, but; first-wave types but, boss, rogue, bee, bee, rogue, boss, but; visual families classic; strict movement 4.3/10, graphics 4/10, alien novelty 3.9/10, shot opportunity 5.6/10, target-contract fit 6.9/10.
...
**Movement read:** Strict movement score 4.3/10 against challenge-2-arrival-group-1: y-range fit 1, path-length fit 1, turn fit 1, object-track fit 0.3. Current probes now include runtime object tracks compared against CPU-extracted Galaga target-video object tracks where available. Legacy broad vector best-match was 8.9/10 against challenge-2-arrival-group-1; xRange 1.0563, yRange 0.8642, pathLength 1.5142.
...
**Target contract read:** Target contract fit is 6.9/10 for Challenging Stage 2 (Levels 7-8): group count 1, path-family order 1, type order 1, family order 1, object-track 0.3 via direct target-video tracks. This is a group/object-track read, not frame-perfect sprite identity recognition.

**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 43 sampled windows; 84% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.13.
...
**Current score:** interesting factor 4.3/10; challenge conformance 4.3/10. Movement 4.3/10, graphics 4.5/10, alien novelty 3.9/10, progression 3.2/10, player shot opportunity 5.5/10.
...
**Aurora current:** stingray-crown-hook-hybrid / hook-arc; lanes boss, rogue, but, bee, boss, bee, but, rogue; first-wave types boss, rogue, but, bee, boss, bee, but, rogue; visual families dragonfly; strict movement 4.3/10, graphics 4.5/10, alien novelty 3.9/10, shot opportunity 5.5/10, target-contract fit 7/10.
...
**Movement read:** Strict movement score 4.3/10 against challenge-3-arrival-group-1: y-range fit 1, path-length fit 1, turn fit 1, object-track fit 0.37. Current probes now include runtime object tracks compared against CPU-extracted Galaga target-video object tracks where available. Legacy broad vector best-match was 8.9/10 against challenge-3-arrival-group-1; xRange 1.062, yRange 0.8145, pathLength 1.7567.
...
**Target contract read:** Target contract fit is 7/10 for Challenging Stage 3 (Levels 11-12): group count 1, path-family order 1, type order 1, family order 1, object-track 0.37 via direct target-video tracks. This is a group/object-track read, not frame-perfect sprite identity recognition.

**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 42 sampled windows; 79% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.13.
...
**Current score:** interesting factor 4.2/10; challenge conformance 4.2/10. Movement 4.2/10, graphics 4.5/10, alien novelty 3.9/10, progression 3.1/10, player shot opportunity 5.5/10.
...
**Aurora current:** pink-serpentine-late / pink-serpentine; lanes boss, rogue, but, bee, bee, but, rogue, boss; first-wave types boss, rogue, but, bee, bee, but, rogue, boss; visual families galboss; strict movement 4.2/10, graphics 4.5/10, alien novelty 3.9/10, shot opportunity 5.5/10, target-contract fit 4.1/10.
...
**Movement read:** Strict movement score 4.2/10 against challenge-4-pink-serpentine-group-1: y-range fit 1, path-length fit 1, turn fit 1, object-track fit 0.27. Current probes now include runtime object tracks compared against CPU-extracted Galaga target-video object tracks where available. Legacy broad vector best-match was 8.9/10 against challenge-4-pink-serpentine-group-1; xRange 1.0647, yRange 0.8289, pathLength 1.9486.
...
**Target contract read:** Target contract fit is 4.1/10 for Challenging Stage 4 target-video object tracks: group count 1, path-family order 0, type order 0, family order 0, object-track 0.27 via direct target-video tracks. This is a group/object-track read, not frame-perfect sprite identity recognition.

**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 42 sampled windows; 83% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.16.
...
**Current score:** interesting factor 4.3/10; challenge conformance 4.3/10. Movement 4.6/10, graphics 4.5/10, alien novelty 3.9/10, progression 3.1/10, player shot opportunity 5.4/10.
...
**Aurora current:** pink-green-cascade / pink-green-cascade; lanes rogue, boss, but, bee, boss, but, bee, rogue; first-wave types rogue, boss, but, bee, boss, but, bee, rogue; visual families galboss; strict movement 4.6/10, graphics 4.5/10, alien novelty 3.9/10, shot opportunity 5.4/10, target-contract fit 4.3/10.

**Graphics read:** Strict graphics score 4.5/10. Current visible family/type labels are present, Direct runtime-vs-Galaga target-crop comparator reads 4.48/10 overall and 4.46/10 for challenge specialty sprites; weakest challenge crop is challenge-dragonfly at 4.46/10. Runtime sprite-motion hook observed 3 visual family/families, 3 path pose family/families, 6/6 animation phase buckets, both flap state(s), and 38 object-tracked silhouette track(s). Graphics remain capped at 4.8/10 until object tracks are compared as full temporal Galaga target-crop sequences, rotations, dive poses, and capture/rescue transitions.

**Movement read:** Strict movement score 4.6/10 against challenge-5-pink-green-cascade-group-4: y-range fit 1, path-length fit 1, turn fit 1, object-track fit 0.31. Current probes now include runtime object tracks compared against CPU-extracted Galaga target-video object tracks where available. Legacy broad vector best-match was 9.7/10 against challenge-5-pink-green-cascade-group-4; xRange 1.0692, yRange 0.6875, pathLength 1.7911.
...
**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 40 sampled windows; 75% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.19.
...
**Current score:** interesting factor 4.2/10; challenge conformance 4.2/10. Movement 4.3/10, graphics 4.4/10, alien novelty 3.9/10, progression 2.7/10, player shot opportunity 5.8/10.
...
**Aurora current:** green-ladder-split / green-ladder-split; lanes bee, but, rogue, boss, boss, rogue, but, bee; first-wave types bee, but, rogue, boss, boss, rogue, but, bee; visual families dragonfly; strict movement 4.3/10, graphics 4.4/10, alien novelty 3.9/10, shot opportunity 5.8/10, target-contract fit 4.7/10.
...
**Movement read:** Strict movement score 4.3/10 against challenge-6-green-ladder-split-group-1: y-range fit 1, path-length fit 1, turn fit 1, object-track fit 0.38. Current probes now include runtime object tracks compared against CPU-extracted Galaga target-video object tracks where available. Legacy broad vector best-match was 8.9/10 against challenge-6-green-ladder-split-group-1; xRange 1.0702, yRange 0.8204, pathLength 2.1037.
...
**Target contract read:** Target contract fit is 4.7/10 for Challenging Stage 6 target-video object tracks: group count 1, path-family order 0, type order 0, family order 0, object-track 0.37 via direct target-video tracks. This is a group/object-track read, not frame-perfect sprite identity recognition.

**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 38 sampled windows; 84% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.17.
...
**Current score:** interesting factor 4.1/10; challenge conformance 4.1/10. Movement 4.2/10, graphics 4.4/10, alien novelty 3.9/10, progression 2.7/10, player shot opportunity 5.1/10.

**Legacy broad coverage score:** 6.8/10. This is retained as diagnostic evidence only; it no longer counts as the player-facing conformance score.

**Original target:** Seventh challenge should introduce a yellow diagonal fan with a memorable scoring lane.

**Aurora current:** yellow-diagonal-fan / yellow-diagonal-fan; lanes boss, bee, but, rogue, rogue, but, bee, boss; first-wave types boss, bee, but, rogue, rogue, but, bee, boss; visual families crown; strict movement 4.2/10, graphics 4.4/10, alien novelty 3.9/10, shot opportunity 5.1/10, target-contract fit 4.5/10.
...
**Movement read:** Strict movement score 4.2/10 against challenge-7-yellow-diagonal-fan-group-1: y-range fit 0.96, path-length fit 1, turn fit 1, object-track fit 0.34. Current probes now include runtime object tracks compared against CPU-extracted Galaga target-video object tracks where available. Legacy broad vector best-match was 8.8/10 against challenge-7-yellow-diagonal-fan-group-1; xRange 1.019, yRange 0.5361, pathLength 1.3276.
...
**Target contract read:** Target contract fit is 4.5/10 for Challenging Stage 7 target-video object tracks: group count 1, path-family order 0, type order 0, family order 0, object-track 0.34 via direct target-video tracks. This is a group/object-track read, not frame-perfect sprite identity recognition.

**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 27 sampled windows; 70% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.18.
...
**Current score:** interesting factor 4.3/10; challenge conformance 4.3/10. Movement 4.3/10, graphics 4.5/10, alien novelty 3.9/10, progression 3.1/10, player shot opportunity 5.6/10.

**Legacy broad coverage score:** 7/10. This is retained as diagnostic evidence only; it no longer counts as the player-facing conformance score.

**Original target:** Eighth visible challenge should act as a compact blue/purple late-loop capstone.

**Aurora current:** blue-purple-finale / blue-purple-finale; lanes rogue, boss, bee, but, but, bee, boss, rogue; first-wave types rogue, boss, bee, but, but, bee, boss, rogue; visual families stingray; strict movement 4.3/10, graphics 4.5/10, alien novelty 3.9/10, shot opportunity 5.6/10, target-contract fit 3.9/10.

**Graphics read:** Strict graphics score 4.5/10. Current visible family/type labels are present, Direct runtime-vs-Galaga target-crop comparator reads 4.48/10 overall and 4.46/10 for challenge specialty sprites; weakest challenge crop is challenge-dragonfly at 4.46/10. Runtime sprite-motion hook observed 3 visual family/families, 3 path pose family/families, 6/6 animation phase buckets, both flap state(s), and 38 object-tracked silhouette track(s). Graphics remain capped at 4.8/10 until object tracks are compared as full temporal Galaga target-crop sequences, rotations, dive poses, and capture/rescue transitions.

**Movement read:** Strict movement score 4.3/10 against challenge-8-blue-purple-finale-group-4: y-range fit 1, path-length fit 1, turn fit 1, object-track fit 0.23. Current probes now include runtime object tracks compared against CPU-extracted Galaga target-video object tracks where available. Legacy broad vector best-match was 9.2/10 against challenge-8-blue-purple-finale-group-4; xRange 1.0447, yRange 0.7988, pathLength 2.444.
...
**Target contract read:** Target contract fit is 3.9/10 for Challenging Stage 8 target-video object tracks: group count 1, path-family order 0, type order 0, family order 0, object-track 0.23 via direct target-video tracks. This is a group/object-track read, not frame-perfect sprite identity recognition.

**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 40 sampled windows; 80% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.17.
...
- Raise player shot opportunity from 5.5/10 by creating lane-readable scoring windows for each challenge rather than incidental central-lane hits.
