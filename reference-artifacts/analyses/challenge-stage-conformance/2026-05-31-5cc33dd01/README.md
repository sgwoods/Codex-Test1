...
Generated: 2026-05-31T14:00:37.319Z
Commit: 5cc33dd01
...
**Target contract read:** Target contract fit is 6.9/10 for Challenging Stage 1 (Levels 3-4): group count 1, path-family order 1, type order 1, family order 1, object-track 0.31 via direct target-video tracks. This is a group/object-track read, not frame-perfect sprite identity recognition.
...
| 2 | measured | 3.3/10 | center -> center; start 4.25s; end 16s; path 0.59 | center -> center; start 4.38s; end 10.5s; path 0.25 |  |
...
**Target contract read:** Target contract fit is 7.2/10 for Challenging Stage 2 (Levels 7-8): group count 1, path-family order 1, type order 1, family order 1, object-track 0.49 via direct target-video tracks. This is a group/object-track read, not frame-perfect sprite identity recognition.
...
**Current score:** interesting factor 4.4/10; challenge conformance 4.4/10. Movement 4.5/10, graphics 4.6/10, alien novelty 3.9/10, progression 3.2/10, player shot opportunity 6.1/10.
...
**Aurora current:** stingray-crown-hook-hybrid / hook-arc; lanes boss, rogue, but, bee, boss, bee, but, rogue; first-wave types boss, rogue, but, bee, boss, bee, but, rogue; visual families dragonfly; strict movement 4.5/10, graphics 4.6/10, alien novelty 3.9/10, shot opportunity 6.1/10, target-contract fit 7.3/10.
...
**Target contract read:** Target contract fit is 7.3/10 for Challenging Stage 3 (Levels 11-12): group count 1, path-family order 1, type order 1, family order 1, object-track 0.53 via direct target-video tracks. This is a group/object-track read, not frame-perfect sprite identity recognition.
...
| 5 | measured | 5.6/10 | center -> center; start 12.25s; end 14s; path 0.92 | center -> center; start 12.13s; end 15.88s; path 0.21 |  |
...
**Current score:** interesting factor 4.2/10; challenge conformance 4.2/10. Movement 4.2/10, graphics 4.6/10, alien novelty 3.9/10, progression 3.1/10, player shot opportunity 5.4/10.
...
**Aurora current:** pink-serpentine-late / pink-serpentine; lanes boss, rogue, but, bee, bee, but, rogue, boss; first-wave types boss, rogue, but, bee, bee, but, rogue, boss; visual families galboss; strict movement 4.2/10, graphics 4.6/10, alien novelty 3.9/10, shot opportunity 5.4/10, target-contract fit 3.9/10.
...
**Movement read:** Strict movement score 4.2/10 against challenge-4-pink-serpentine-group-1: y-range fit 1, path-length fit 1, turn fit 1, object-track fit 0.23. Current probes now include runtime object tracks compared against CPU-extracted Galaga target-video object tracks where available. Legacy broad vector best-match was 8.9/10 against challenge-4-pink-serpentine-group-1; xRange 0.9745, yRange 0.4753, pathLength 1.8423.
...
**Target contract read:** Target contract fit is 3.9/10 for Challenging Stage 4 target-video object tracks: group count 1, path-family order 0, type order 0, family order 0, object-track 0.23 via direct target-video tracks. This is a group/object-track read, not frame-perfect sprite identity recognition.

**Per-group movement rows:**
| Group | Status | Fit | Aurora runtime | Galaga target | Gap |
| --- | --- | ---: | --- | --- | --- |
| 1 | measured | 2/10 | left -> left; start 0.25s; end 7.25s; path 2.55 | center -> center; start 0s; end 3.25s; path 0.13 |  |
| 2 | measured | 2.6/10 | left -> left; start 1s; end 5s; path 1.07 | center -> center; start 0.5s; end 3.25s; path 0.25 |  |
| 3 | measured | 3.7/10 | right -> right; start 3.25s; end 13.25s; path 1.87 | center -> center; start 2.88s; end 6.63s; path 0.15 |  |
| 4 | measured | 1.1/10 | left -> left; start 7.75s; end 11.75s; path 1.09 | center -> center; start 6.38s; end 9.88s; path 0.13 |  |
| 5 | measured | 4/10 | left -> center; start 13s; end 16s; path 0.5 | left -> right; start 13.13s; end 15.88s; path 0.01 |  |

**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 64 sampled windows; 75% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.16.
...
**Target contract read:** Target contract fit is 3.8/10 for Challenging Stage 5 target-video object tracks: group count 1, path-family order 0, type order 0, family order 0, object-track 0.2 via direct target-video tracks. This is a group/object-track read, not frame-perfect sprite identity recognition.
...
**Target contract read:** Target contract fit is 4.2/10 for Challenging Stage 7 target-video object tracks: group count 1, path-family order 0, type order 0, family order 0, object-track 0.29 via direct target-video tracks. This is a group/object-track read, not frame-perfect sprite identity recognition.
...
**Movement read:** Strict movement score 4.6/10 against challenge-8-blue-purple-finale-group-3: y-range fit 1, path-length fit 1, turn fit 1, object-track fit 0.29. Current probes now include runtime object tracks compared against CPU-extracted Galaga target-video object tracks where available. Legacy broad vector best-match was 9.6/10 against challenge-8-blue-purple-finale-group-3; xRange 0.9949, yRange 0.6363, pathLength 2.9186.
...
**Target contract read:** Target contract fit is 4.2/10 for Challenging Stage 8 target-video object tracks: group count 1, path-family order 0, type order 0, family order 0, object-track 0.29 via direct target-video tracks. This is a group/object-track read, not frame-perfect sprite identity recognition.
...
| 4 | measured | 3.5/10 | right -> left; start 3.25s; end 12.25s; path 2.04 | center -> center; start 10.75s; end 15.38s; path 0.15 |  |
