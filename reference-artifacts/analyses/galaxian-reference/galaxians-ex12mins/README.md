# Galaxians example 12-minute session
...
This source extends the current Galaxy Guardians / Galaxian reference profile
with a repeatable early-session lane. It is especially useful for:

- attract/logo persistence and score-advance-table confirmation across restarts
- early formation/rack presentation, palette, and score-strip review
- quick restart cadence, early scoring reads, and corroborating single-shot-era
  playfield spacing against the other reference sources
