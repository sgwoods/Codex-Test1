...
Generated: `2026-05-09T16:14:23.064Z`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Audio identity, event feedback, and cue alignment | 6.3/10 | medium-high | 21 cue/event comparisons with waveform, spectral, overlap, alignment, and semantic event-mapping features | high; cpu, model-api, openai-api | 113 runs; 85 min wall; 150.3 min CPU | 7.5-8.0 | Measured release category; weakest axis | Largest current score gap and high user-experience impact: shots, explosions, boss damage, challenge results, capture/rescue feedback. | High; 3-6 hrs local/model-assisted analysis | Tune the highest segment-level audio gap next: playerHit body. Rerun audio comparison, event-gap analysis, and quality scoring after the change. | reference-artifacts/analyses/quality-conformance/2026-05-09-6c0e2b61/report.json |
...
| Metric points scanned | 709 | History depth behind score trends |
| Score deltas found | 106 | Past-goal movement available for review |
| Measured runs | 208 | Tracked harness/model/local compute work |
| Tracked wall time | 108 min | Human clock-time planning input |
| Tracked CPU time | 183.7 min | Local compute-cost planning input |
| Tracked artifact growth | 390 MB | Evidence volume and storage/review-cost proxy |

### Resource And Time Usage

| Resource | Measured runs | Wall time | CPU time |
| --- | --- | --- | --- |
| cpu | 207 | 108 min | 183.7 min |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Audio identity, event feedback, and cue alignment | 6.3/10 | 7.5-8.0 | +1.2 | High; 3-6 hrs local/model-assisted analysis | cpu, model-api, openai-api | 113 runs; 85 min wall; 150.3 min CPU | Expected lift 0.7/10 on metric, 0.058/10 overall; investment score 3.27. | Tune the highest segment-level audio gap next: playerHit body. Rerun audio comparison, event-gap analysis, and quality scoring after the change. |
...
| 9 | Reference contact sheets and frame evidence | visual / motion / entry formation | contact sheets and still frames | 30 contact/frame evidence files | extracted, partially labeled | medium | Visual look, alien entry, challenge variation | reference-artifacts/analyses | Attach contact-sheet families to metric rows and add image-level comparison scores. |

### Charts

![score-trends](reference-artifacts/analyses/conformance-economics/2026-05-09-6c0e2b61/score-trends.svg)

![largest-score-deltas](reference-artifacts/analyses/conformance-economics/2026-05-09-6c0e2b61/largest-score-deltas.svg)

![compute-minutes-by-resource](reference-artifacts/analyses/conformance-economics/2026-05-09-6c0e2b61/compute-minutes-by-resource.svg)

![cost-per-positive-score-point](reference-artifacts/analyses/conformance-economics/2026-05-09-6c0e2b61/cost-per-positive-score-point.svg)
...
- Quality report: `reference-artifacts/analyses/quality-conformance/2026-05-09-6c0e2b61/report.json`
- Investment priority report: `reference-artifacts/analyses/conformance-investment-priorities/2026-05-09-6c0e2b61/report.json`
- Level-arc report: `reference-artifacts/analyses/level-arc-conformance/2026-05-09-6c0e2b61/report.json`
- Economics report: `reference-artifacts/analyses/conformance-economics/2026-05-09-6c0e2b61/report.json`
