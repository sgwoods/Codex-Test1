...
Generated: `2026-05-10T00:05:06.268Z`
...
- Source metrics: `reference-artifacts/analyses/aurora-audio-promotion-precheck/2026-05-10-c9ef29d2-dirty-000506-stagePulse/candidate-theme-metrics.json`
- Compared cues: 21
...
- Highest event-gap risk: stagePulse (4.39/10 risk)
...
| ---: | --- | --- | ---: | --- | --- | ---: | ---: | --- | ---: | --- |
| 1 | stagePulse | Formation Pulse (promotion precheck) | 4.39 | high | single-reference-body | 0.029s | 684.6 Hz | onset | 7.02 | Tune the onset segment first: onset timbre is the leading gap: band shape/rolloff differ from the reference segment. |
