...
Generated: `2026-05-10T18:01:57.292Z`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Audio identity, event feedback, and cue alignment | 6.7/10 | medium-high | 21 cue/event comparisons with waveform, spectral, overlap, alignment, and semantic event-mapping features | high; cpu, model-api, openai-api | 199 runs; 144.8 min wall; 259 min CPU | 7.5-8.0 | Measured release category; weakest axis | Largest current score gap and high user-experience impact: shots, explosions, boss damage, challenge results, capture/rescue feedback. | High; 3-6 hrs local/model-assisted analysis | StagePulse candidate cadence-phase-muted-square-body is a phase/envelope near miss, but repeat stability and masking reject promotion. Preserve it as generator evidence and run a broader stagePulse onset strategy that compares reference subclips, pressure cadence, and combat masking before another runtime trial. | reference-artifacts/analyses/quality-conformance/2026-05-10-9ddc6104/report.json |
...
| Metric points scanned | 1040 | History depth behind score trends |
| Score deltas found | 118 | Past-goal movement available for review |
| Measured runs | 381 | Tracked harness/model/local compute work |
| Tracked wall time | 240.2 min | Human clock-time planning input |
| Tracked CPU time | 369.5 min | Local compute-cost planning input |
| Tracked artifact growth | 609.9 MB | Evidence volume and storage/review-cost proxy |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Audio identity, event feedback, and cue alignment | 6.7/10 | 7.5-8.0 | +0.8 | High; 3-6 hrs local/model-assisted analysis | cpu, model-api, openai-api | 199 runs; 144.8 min wall; 259 min CPU | Expected lift 0.7/10 on metric, 0.058/10 overall; investment score 3.04. | StagePulse candidate cadence-phase-muted-square-body is a phase/envelope near miss, but repeat stability and masking reject promotion. Preserve it as generator evidence and run a broader stagePulse onset strategy that compares reference subclips, pressure cadence, and combat masking before another runtime trial. |
...
| 2 | Aurora audio cue comparison and event-gap reports | audio cue scoring | waveform/spectral/alignment/semantic reports | 21 compared cues; semantic 9.78/10; 0 attention rows | semantic-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-event-gap/2026-05-10-9ddc6104-dirty-175807/report.json | Tune the highest segment-level gap next: playerHit body. Rerun audio comparison and event-gap analysis after the change. |
...
![score-trends](reference-artifacts/analyses/conformance-economics/2026-05-10-9ddc6104/score-trends.svg)
...
![cpu-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-10-9ddc6104/cpu-use-by-purpose.svg)
...
- Quality report: `reference-artifacts/analyses/quality-conformance/2026-05-10-9ddc6104/report.json`
...
- Level-arc report: `reference-artifacts/analyses/level-arc-conformance/2026-05-10-9ddc6104/report.json`
- Economics report: `reference-artifacts/analyses/conformance-economics/2026-05-10-9ddc6104/report.json`
