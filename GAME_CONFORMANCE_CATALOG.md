...
| Stage 3 / first challenge | First challenging stage and bonus-stage learning moment. | Non-lethal challenge behavior, scoreable windows, group readability, perfect-result feedback. | Challenge timing guardrails; challenge-stage candidate window. |
...
| Stage 7 challenge | Scorpion cross-sweep challenge set piece. | New trajectory family, challenge alien novelty, bonus opportunity clarity. | `challenge-stage-scorpion-cross`; contributes to 8.7/10 alien-entry/challenge score. |
...
| Stage 11 challenge | Stingray hook-arc challenge set piece. | Hooking trajectories, mixed alien composition, learning-stage novelty. | `challenge-stage-stingray-hook`; challenge trajectory variation maxed at current scorer resolution. |
