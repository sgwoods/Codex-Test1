...
Generated: `2026-05-17T12:54:26.012Z`
...
| --- | --- | --- | --- | --- | --- |
| Aurora Galactica current dev line | 9.2/10 | strongest Player movement conformance 10/10; weakest Audio identity and cue alignment 7/10; broad alien/challenge variation 8.3/10; dedicated challenge-stage conformance 6.1/10; audio contract readiness 9.3/10 | release-quality conformance score plus audio cue-contract read | Audio identity and cue alignment (7/10) | reference-artifacts/analyses/quality-conformance/2026-05-17-f9e7374c/report.json; reference-artifacts/analyses/aurora-audio-cue-contracts/latest.json; reference-artifacts/analyses/challenge-stage-conformance/latest.json |
...
| Audio identity / acoustic fit | 7/10 | 7.2/10 in `1.3`; 7.6/10 in `1.4` | 6.4/10 playtest; 6.4/10 reference category | human-listened cue cleanup in `1.3`; 7.0/10 playtest in `1.4` | Audio is the weakest shared conformance area today. |
...
| Shot and hit responsiveness | 10/10 | close-shot-hit, movement fire window | Close-shot responsiveness passed, and movement-fire post-shot travel was 43.1, with shot delay -2ms. |
