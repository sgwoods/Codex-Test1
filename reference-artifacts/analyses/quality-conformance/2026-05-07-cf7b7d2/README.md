...
- Read: Level arc score is 7.4/10 with 6/6 stage families blueprinted and 4/6 evidence windows present; weakest submetric is Long-run non-repetition (6/10).
...
- Level arc and encounter shape: 7.4/10
