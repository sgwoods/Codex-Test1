...
- Mean distance: 0.422
- Minimum distance: 0.261
- Distinct pair ratio: 1
- Repetition risk: 0
- Closest pair: late-run-crown-entry / late-run-escort-variant (0.261)
- Most distinct pair: challenge-stage-candidate / late-run-escort-variant (0.558)
- Regular windows: 7
- Mean regular distance: 0.315
- Minimum regular distance: 0.261
- Minimum mid/late distance: 0.271
- Closest mid/late pair: mid-run-entry-variant / mid-run-pincer-variant (0.271)
- Closest same-band regular pair: late-run-crown-entry / late-run-escort-variant (0.261)
...
- Challenge: false
- Observed event families: enemy_dive_start, enemy_projectile, escort_dive_start, formation_entry, player_hit
- Pressure read: max attackers 8, max enemy bullets 3, max challenge enemies 0
...
| Pair | Distance |
| --- | ---: |
| late-run-crown-entry / late-run-escort-variant | 0.261 |
| mid-run-entry-variant / mid-run-pincer-variant | 0.271 |
| late-run-escort-variant / mid-run-pressure | 0.274 |
...
| late-run-escort-variant / mid-run-pincer-variant | 0.309 |
...
| late-run-escort-variant / mid-run-entry-variant | 0.319 |
...
| late-run-cleanup-or-failure / late-run-escort-variant | 0.34 |
...
| late-run-escort-variant / stage-1-baseline | 0.391 |
...
| challenge-stage-boss-led-loop / late-run-escort-variant | 0.488 |
...
| challenge-stage-scorpion-cross / late-run-escort-variant | 0.551 |
| challenge-stage-stingray-hook / late-run-escort-variant | 0.556 |
| challenge-stage-candidate / late-run-crown-entry | 0.557 |
| challenge-stage-stingray-hook / late-run-crown-entry | 0.557 |
| challenge-stage-candidate / late-run-escort-variant | 0.558 |
