...
- Weakest category: movement (5.4/10)
...
- Read: Current movement scored 5.4/10 against the control-principles profile, versus 5.3/10 for the shipped local baseline.

### Shot and hit responsiveness
- Score: 10/10
- Evidence: close-shot-hit, movement fire window
- Read: Close-shot responsiveness passed, and movement-fire post-shot travel was 61.43, with shot delay 27ms.
...
- Player movement conformance: 5.4/10
