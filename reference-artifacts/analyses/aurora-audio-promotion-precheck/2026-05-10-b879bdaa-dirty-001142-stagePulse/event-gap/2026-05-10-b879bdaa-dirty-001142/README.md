...
Generated: `2026-05-10T00:11:42.905Z`
...
- Source metrics: `reference-artifacts/analyses/aurora-audio-promotion-precheck/2026-05-10-b879bdaa-dirty-001142-stagePulse/candidate-theme-metrics.json`
- Compared cues: 21
...
| ---: | --- | --- | ---: | --- | --- | ---: | ---: | --- | ---: | --- |
| 1 | stagePulse | Formation Pulse (promotion precheck) | 4.47 | high | single-reference-body | 0.019s | 709.4 Hz | onset | 7.05 | Tune the onset segment first: onset timbre is the leading gap: band shape/rolloff differ from the reference segment. |
