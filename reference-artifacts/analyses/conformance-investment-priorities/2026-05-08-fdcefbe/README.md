...
| 2 | Tighten level-arc opportunity coverage and late reward reads | level-arc | 1.6 | 0.022 | 1.95 | Promote mid-run pressure event coverage by widening the Stage 6 evidence window for flank-dive and wave-clear semantics before changing gameplay tuning. |
