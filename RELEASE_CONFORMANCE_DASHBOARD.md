...
Generated: `2026-05-24T07:43:42.161Z`
...
| Metric points scanned | 2223 | History depth behind score trends |
| Score deltas found | 165 | Past-goal movement available for review |
| Measured runs | 864 | Tracked harness/model/local compute work |
| Tracked wall time | 955.1 min | Human clock-time planning input |
| Tracked CPU time | 951.9 min | Local compute-cost planning input |
| Tracked artifact growth | 1434.4 MB | Evidence volume and storage/review-cost proxy |
...
| --- | --- | --- | --- | --- |
| Audio conformance and cue feedback | 510 | 504.2 min | 85.4% | Moves the moment-to-moment arcade feel: impact clarity, ambience identity, reward/loss feedback, and player understanding. |
| Gameplay behavior and level complexity | 317 | 75.3 min | 12.8% | Moves player-facing pressure, stage shape, alien entry novelty, challenge-stage learning value, and long-play texture. |
...
| cpu | 825 | 560.3 min | 899.3 min |
| browser | 310 | 413.5 min | 637.8 min |
...
| conformance-analysis | 8 | 235.7 min | 1.3 min |
...
| challenge-stage | 101 | 87.6 min | 20.8 min |
...
| 2 | Aurora audio cue comparison and event-gap reports | audio cue scoring | waveform/spectral/alignment/semantic reports | 21 compared cues; semantic 9.78/10; 0 attention rows | semantic-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-event-gap/2026-05-24-ff249bba-dirty-073545/report.json | Tune the highest segment-level gap next: challengePerfect onset. Rerun audio comparison and event-gap analysis after the change. |
...
![score-trends](reference-artifacts/analyses/conformance-economics/2026-05-24-c2b9aaba/score-trends.svg)

![largest-score-deltas](reference-artifacts/analyses/conformance-economics/2026-05-24-c2b9aaba/largest-score-deltas.svg)

![compute-minutes-by-resource](reference-artifacts/analyses/conformance-economics/2026-05-24-c2b9aaba/compute-minutes-by-resource.svg)

![cost-per-positive-score-point](reference-artifacts/analyses/conformance-economics/2026-05-24-c2b9aaba/cost-per-positive-score-point.svg)

![gpu-equivalent-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-24-c2b9aaba/gpu-equivalent-use-by-purpose.svg)

![cpu-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-24-c2b9aaba/cpu-use-by-purpose.svg)

![gameplay-improvement-by-project-part](reference-artifacts/analyses/conformance-economics/2026-05-24-c2b9aaba/gameplay-improvement-by-project-part.svg)
...
- Economics report: `reference-artifacts/analyses/conformance-economics/2026-05-24-c2b9aaba/report.json`
