...
- Generated from commit `96c62d6`
- Version: `1.3.0`
- Generated at: `2026-05-08T12:35:07.163Z`
...
- Quick read: synthetic Galaga centroid delta vs reference = `119.3Hz`; Aurora centroid delta vs reference = `61.2Hz`.
- Active-window status: `direct-cue-comparison`.
- Active quick read: Aurora vs reference duration delta = `0.030s`; centroid delta = `115.2Hz`.
...
| Variant | Duration (s) | Peak | RMS | Spectral Centroid (Hz) | Zero Crossings / s | Active Window | Waveform | Spectrogram |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| Aurora Application Mix | 0.540 | 0.8141 | 0.2503 | 1173.9 | 1900.0 | 0.000-0.540s | n/a | n/a |
...
- Quick read: synthetic Galaga duration delta vs reference = `0.000s`; Aurora duration delta vs reference = `0.000s`.
- Quick read: synthetic Galaga centroid delta vs reference = `153.4Hz`; Aurora centroid delta vs reference = `168.9Hz`.
- Active-window status: `direct-cue-comparison`.
- Active quick read: Aurora vs reference duration delta = `0.150s`; centroid delta = `106.4Hz`.
...
- Quick read: synthetic Galaga duration delta vs reference = `0.000s`; Aurora duration delta vs reference = `0.000s`.
- Quick read: synthetic Galaga centroid delta vs reference = `11.6Hz`; Aurora centroid delta vs reference = `11.6Hz`.
- Active-window status: `direct-cue-comparison`.
...
- Quick read: synthetic Galaga centroid delta vs reference = `626.7Hz`; Aurora centroid delta vs reference = `568.6Hz`.
- Active-window status: `active-segment-detected`.
- Active quick read: Aurora vs reference duration delta = `1.037s`; centroid delta = `569.6Hz`.
- Candidate reference subwindows: 1.149-1.389s score 0.886; 0.900-1.140s score 0.715; 0.050-0.290s score 0.682.
...
- Quick read: synthetic Galaga centroid delta vs reference = `47.9Hz`; Aurora centroid delta vs reference = `47.9Hz`.
- Active-window status: `active-segment-detected`.
- Active quick read: Aurora vs reference duration delta = `0.279s`; centroid delta = `47.9Hz`.
- Candidate reference subwindows: 0.500-0.800s score 0.813; 0.000-0.300s score 0.200.
...
- Quick read: synthetic Galaga centroid delta vs reference = `540.2Hz`; Aurora centroid delta vs reference = `540.2Hz`.
- Active-window status: `active-segment-detected`.
...
- Quick read: synthetic Galaga duration delta vs reference = `1.743s`; Aurora duration delta vs reference = `1.743s`.
- Quick read: synthetic Galaga centroid delta vs reference = `601.0Hz`; Aurora centroid delta vs reference = `389.4Hz`.
- Active-window status: `active-segment-detected`.
...
- Quick read: synthetic Galaga duration delta vs reference = `0.000s`; Aurora duration delta vs reference = `0.000s`.
- Quick read: synthetic Galaga centroid delta vs reference = `623.3Hz`; Aurora centroid delta vs reference = `623.3Hz`.
- Active-window status: `direct-cue-comparison`.
- Active quick read: Aurora vs reference duration delta = `0.141s`; centroid delta = `620.0Hz`.
...
| Galaga Original Reference (synthetic) | 0.420 | 0.8141 | 0.2473 | 1216.6 | 1992.9 | 0.000-0.420s | n/a | n/a |
| Capturing | 0.420 | 0.4716 | 0.2589 | 1091.8 | 1561.9 | 0.000-0.420s | n/a | n/a |

- Quick read: synthetic Galaga duration delta vs reference = `0.000s`; Aurora duration delta vs reference = `0.000s`.
- Quick read: synthetic Galaga centroid delta vs reference = `124.8Hz`; Aurora centroid delta vs reference = `126.9Hz`.
- Active-window status: `direct-cue-comparison`.
- Active quick read: Aurora vs reference duration delta = `0.000s`; centroid delta = `126.9Hz`.
...
- Quick read: synthetic Galaga duration delta vs reference = `0.000s`; Aurora duration delta vs reference = `0.000s`.
- Quick read: synthetic Galaga centroid delta vs reference = `727.4Hz`; Aurora centroid delta vs reference = `622.5Hz`.
- Active-window status: `direct-cue-comparison`.
...
- Quick read: synthetic Galaga duration delta vs reference = `0.000s`; Aurora duration delta vs reference = `0.000s`.
- Quick read: synthetic Galaga centroid delta vs reference = `132.9Hz`; Aurora centroid delta vs reference = `132.9Hz`.
- Active-window status: `direct-cue-comparison`.
- Active quick read: Aurora vs reference duration delta = `0.000s`; centroid delta = `132.9Hz`.
...
| Variant | Duration (s) | Peak | RMS | Spectral Centroid (Hz) | Zero Crossings / s | Active Window | Waveform | Spectrogram |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| Aurora Application Mix | 0.360 | 0.7722 | 0.2435 | 1213.8 | 1997.2 | 0.000-0.360s | n/a | n/a |
...
- Quick read: synthetic Galaga duration delta vs reference = `0.000s`; Aurora duration delta vs reference = `0.000s`.
- Quick read: synthetic Galaga centroid delta vs reference = `272.5Hz`; Aurora centroid delta vs reference = `302.7Hz`.
- Active-window status: `direct-cue-comparison`.
- Active quick read: Aurora vs reference duration delta = `0.000s`; centroid delta = `302.7Hz`.
...
- Quick read: synthetic Galaga centroid delta vs reference = `200.9Hz`; Aurora centroid delta vs reference = `281.9Hz`.
- Active-window status: `active-segment-detected`.
...
| Galaga Original Reference (synthetic) | 0.480 | 0.8141 | 0.2489 | 1083.5 | 1997.9 | 0.000-0.480s | n/a | n/a |
| Challenging Stage | 0.480 | 0.9487 | 0.2017 | 1607.3 | 2085.4 | 0.000-0.480s | n/a | n/a |

- Quick read: synthetic Galaga duration delta vs reference = `0.000s`; Aurora duration delta vs reference = `0.000s`.
- Quick read: synthetic Galaga centroid delta vs reference = `523.8Hz`; Aurora centroid delta vs reference = `446.9Hz`.
- Active-window status: `direct-cue-comparison`.
- Active quick read: Aurora vs reference duration delta = `0.000s`; centroid delta = `446.9Hz`.
...
- Quick read: synthetic Galaga centroid delta vs reference = `620.3Hz`; Aurora centroid delta vs reference = `619.5Hz`.
- Active-window status: `direct-cue-comparison`.
- Active quick read: Aurora vs reference duration delta = `0.060s`; centroid delta = `619.5Hz`.
...
| Variant | Duration (s) | Peak | RMS | Spectral Centroid (Hz) | Zero Crossings / s | Active Window | Waveform | Spectrogram |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| Aurora Application Mix | 0.480 | 0.8706 | 0.2493 | 1136.9 | 1933.3 | 0.000-0.480s | n/a | n/a |
| Galaga Original Reference (synthetic) | 0.480 | 0.7995 | 0.2465 | 1081.4 | 1920.8 | 0.000-0.480s | n/a | n/a |
| Challenging Stage Perfect | 0.480 | 0.4117 | 0.1421 | 2040.1 | 2256.2 | 0.000-0.480s | n/a | n/a |

- Quick read: synthetic Galaga duration delta vs reference = `0.000s`; Aurora duration delta vs reference = `0.000s`.
- Quick read: synthetic Galaga centroid delta vs reference = `958.7Hz`; Aurora centroid delta vs reference = `903.2Hz`.
- Active-window status: `direct-cue-comparison`.
- Active quick read: Aurora vs reference duration delta = `0.000s`; centroid delta = `903.2Hz`.
...
| Variant | Duration (s) | Peak | RMS | Spectral Centroid (Hz) | Zero Crossings / s | Active Window | Waveform | Spectrogram |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| Aurora Application Mix | 0.480 | 0.7995 | 0.2495 | 1160.0 | 1937.5 | 0.000-0.480s | n/a | n/a |
...
- Quick read: synthetic Galaga duration delta vs reference = `0.000s`; Aurora duration delta vs reference = `0.000s`.
- Quick read: synthetic Galaga centroid delta vs reference = `717.7Hz`; Aurora centroid delta vs reference = `715.8Hz`.
- Active-window status: `direct-cue-comparison`.
- Active quick read: Aurora vs reference duration delta = `0.000s`; centroid delta = `715.8Hz`.
...
| Variant | Duration (s) | Peak | RMS | Spectral Centroid (Hz) | Zero Crossings / s | Active Window | Waveform | Spectrogram |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| Aurora Application Mix | 0.420 | 0.7995 | 0.2459 | 1095.5 | 1976.2 | 0.000-0.420s | n/a | n/a |
| Galaga Original Reference (synthetic) | 0.420 | 0.7995 | 0.2465 | 1141.3 | 1961.9 | 0.000-0.420s | n/a | n/a |
| Name Entry (2nd-5th) | 0.420 | 0.9313 | 0.2595 | 1683.5 | 2771.4 | 0.050-0.420s | n/a | n/a |

- Quick read: synthetic Galaga duration delta vs reference = `0.000s`; Aurora duration delta vs reference = `0.000s`.
- Quick read: synthetic Galaga centroid delta vs reference = `542.2Hz`; Aurora centroid delta vs reference = `588.0Hz`.
- Active-window status: `direct-cue-comparison`.
- Active quick read: Aurora vs reference duration delta = `0.050s`; centroid delta = `675.0Hz`.
...
- Candidate reference subwindows found: 20
- Average active Aurora-vs-synthetic-Galaga duration delta: `0.006s`
- Average active Aurora-vs-reference duration delta: `0.258s`
- Average active Aurora-vs-reference centroid delta: `389.0Hz`
