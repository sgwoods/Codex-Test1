...
Generated: `2026-05-09T21:38:21.281Z`
...
- Source metrics: `reference-artifacts/analyses/aurora-audio-promotion-precheck/2026-05-09-bbcc8df1-dirty-rescueJoin/candidate-theme-metrics.json`
- Compared cues: 21
...
- Average worst segment risk: 4.47/10
...
| 9 | rescueJoin | Rescue Join (promotion precheck) | 2.79 | high | single-reference-body | 0.001s | 366.1 Hz | onset | 4.81 | Tune the onset segment first: onset timbre is the leading gap: band shape/rolloff differ from the reference segment. |
