...
- Mean reward index: 2/10
- Mean identity index: 5.7/10
- Outcome reward windows: 2
- Outcome special reward bonus: 3200
...
- Score: 8.2
- Problem: late-run-cleanup-or-failure has late-stage pressure evidence but low reward/opportunity signal (1.8/10).
...
- Window: late-run-escort-variant
- Score: 7.9
- Problem: late-run-escort-variant has late-stage pressure evidence but low reward/opportunity signal (2.1/10).
- Strategy: Measure boss/escort score opportunities, hit-before-loss events, and clear/failure outcomes; then add one visible late-stage reward window rather than increasing raw attack density.
- Success measure: Reward index reaches 5+/10 while pressure index does not increase by more than 1 point unless survival evidence also improves.
...
| late-run-cleanup-or-failure | 12 | 7.2 | 1.8 | 4.8 | wave_clear, game_over |
| late-run-escort-variant | 14 | 6.6 | 2.1 | 5.1 | wave_clear, game_over |
| mid-run-entry-variant | 8 | 4.3 | 0.6 | 5.1 | escort_dive_start, wave_clear |
