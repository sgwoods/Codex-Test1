...
- Mean reward index: 2.7/10
- Mean identity index: 5.7/10
- Skill-route reward windows: 1
...
| late-run-cleanup-or-failure | 12 | 7.2 | 5.9 (base 1.8; skill 10) | 4.8 | none |
| late-run-escort-variant | 14 | 6.6 | 2.1 | 5.1 | none |
