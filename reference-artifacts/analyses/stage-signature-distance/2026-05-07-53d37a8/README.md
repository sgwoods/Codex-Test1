...
- Windows: 6
- Pairs: 15
- Signature score: 5.8/10
- Mean distance: 0.25
- Minimum distance: 0.074
- Distinct pair ratio: 0.467
- Repetition risk: 0.664
- Closest pair: late-run-cleanup-or-failure / late-run-escort-variant (0.074)
- Most distinct pair: challenge-stage-candidate / late-run-cleanup-or-failure (0.471)
- Regular windows: 5
- Mean regular distance: 0.151
- Minimum regular distance: 0.074
- Minimum mid/late distance: 0.097
- Closest mid/late pair: late-run-escort-variant / mid-run-pressure (0.097)
- Closest same-band regular pair: late-run-cleanup-or-failure / late-run-escort-variant (0.074)
...
| Pair | Distance |
| --- | ---: |
| late-run-cleanup-or-failure / late-run-escort-variant | 0.074 |
| mid-run-entry-variant / mid-run-pressure | 0.077 |
| late-run-escort-variant / mid-run-pressure | 0.097 |
| late-run-cleanup-or-failure / mid-run-pressure | 0.116 |
| late-run-escort-variant / mid-run-entry-variant | 0.121 |
| late-run-cleanup-or-failure / mid-run-entry-variant | 0.152 |
| mid-run-entry-variant / stage-1-baseline | 0.178 |
| mid-run-pressure / stage-1-baseline | 0.2 |
| late-run-escort-variant / stage-1-baseline | 0.243 |
| late-run-cleanup-or-failure / stage-1-baseline | 0.256 |
| challenge-stage-candidate / mid-run-entry-variant | 0.426 |
| challenge-stage-candidate / mid-run-pressure | 0.436 |
| challenge-stage-candidate / stage-1-baseline | 0.446 |
| challenge-stage-candidate / late-run-escort-variant | 0.456 |
