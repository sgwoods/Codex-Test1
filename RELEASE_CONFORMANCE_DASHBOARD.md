...
Generated: `2026-05-11T01:10:40.328Z`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Audio identity, event feedback, and cue alignment | 7.1/10 | medium-high | 21 cue/event comparisons with waveform, spectral, overlap, alignment, and semantic event-mapping features | high; cpu, model-api, openai-api | 231 runs; 168.2 min wall; 300.4 min CPU | 7.5-8.0 | Measured release category; weakest axis | Largest current score gap and high user-experience impact: shots, explosions, boss damage, challenge results, capture/rescue feedback. | High; 3-6 hrs local/model-assisted analysis | StagePulse candidate refclip-s660-d240-v86 is a measured near miss: full-theme precheck shows improvement, but focused masking/stability gates reject promotion. Next build a stronger low-brightness, low-variance pressure-bed generator, then rerun focused repeats and promotion precheck. | reference-artifacts/analyses/quality-conformance/2026-05-11-46e1b45c/report.json; reference-artifacts/analyses/aurora-audio-cue-contracts/2026-05-10-eedc85ba-dirty-205906/report.json |
...
| Metric points scanned | 1129 | History depth behind score trends |
| Score deltas found | 121 | Past-goal movement available for review |
| Measured runs | 432 | Tracked harness/model/local compute work |
| Tracked wall time | 265.4 min | Human clock-time planning input |
| Tracked CPU time | 413.2 min | Local compute-cost planning input |
| Tracked artifact growth | 672.2 MB | Evidence volume and storage/review-cost proxy |
...
| --- | --- | --- | --- | --- |
| Audio conformance and cue feedback | 286 | 212 min | 88.2% | Moves the moment-to-moment arcade feel: impact clarity, ambience identity, reward/loss feedback, and player understanding. |
| Gameplay behavior and level complexity | 137 | 24.9 min | 10.4% | Moves player-facing pressure, stage shape, alien entry novelty, challenge-stage learning value, and long-play texture. |
...
| --- | --- | --- | --- |
| cpu | 430 | 240.4 min | 413.2 min |
| browser | 149 | 130 min | 225.3 min |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Audio identity, event feedback, and cue alignment | 7.1/10 | 7.5-8.0 | +0.4 | High; 3-6 hrs local/model-assisted analysis | cpu, model-api, openai-api | 231 runs; 168.2 min wall; 300.4 min CPU | Expected lift 0.7/10 on metric, 0.058/10 overall; investment score 2.96. | StagePulse candidate refclip-s660-d240-v86 is a measured near miss: full-theme precheck shows improvement, but focused masking/stability gates reject promotion. Next build a stronger low-brightness, low-variance pressure-bed generator, then rerun focused repeats and promotion precheck. |
...
| 2 | Aurora audio cue comparison and event-gap reports | audio cue scoring | waveform/spectral/alignment/semantic reports | 21 compared cues; semantic 9.78/10; 0 attention rows | semantic-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-event-gap/2026-05-11-46e1b45c-dirty-010949/report.json | Tune the highest segment-level gap next: stagePulse onset. Rerun audio comparison and event-gap analysis after the change. |
...
| 4 | Aurora audio cue contracts | audio semantic contract / theme latitude / promotion safety | cue contract readiness, theme lanes, runtime-trial blockers | 8 contracts; readiness 9.1/10; blocked 3 | contract-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-cue-contracts/2026-05-10-eedc85ba-dirty-205906/report.json | StagePulse candidate refclip-s660-d240-v86 is a measured near miss: full-theme precheck shows improvement, but focused masking/stability gates reject promotion. Next build a stronger low-brightness, low-variance pressure-bed generator, then rerun focused repeats and promotion precheck. |
...
![score-trends](reference-artifacts/analyses/conformance-economics/2026-05-11-46e1b45c/score-trends.svg)

![largest-score-deltas](reference-artifacts/analyses/conformance-economics/2026-05-11-46e1b45c/largest-score-deltas.svg)

![compute-minutes-by-resource](reference-artifacts/analyses/conformance-economics/2026-05-11-46e1b45c/compute-minutes-by-resource.svg)

![cost-per-positive-score-point](reference-artifacts/analyses/conformance-economics/2026-05-11-46e1b45c/cost-per-positive-score-point.svg)

![gpu-equivalent-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-11-46e1b45c/gpu-equivalent-use-by-purpose.svg)

![cpu-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-11-46e1b45c/cpu-use-by-purpose.svg)

![gameplay-improvement-by-project-part](reference-artifacts/analyses/conformance-economics/2026-05-11-46e1b45c/gameplay-improvement-by-project-part.svg)
...
- Quality report: `reference-artifacts/analyses/quality-conformance/2026-05-11-46e1b45c/report.json`
...
- Level-arc report: `reference-artifacts/analyses/level-arc-conformance/2026-05-11-46e1b45c/report.json`
- Economics report: `reference-artifacts/analyses/conformance-economics/2026-05-11-46e1b45c/report.json`
