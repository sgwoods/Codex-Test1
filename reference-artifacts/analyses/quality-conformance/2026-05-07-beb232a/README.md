...
- Read: Close-shot responsiveness passed, and movement-fire post-shot travel was 58.14, with shot delay -4ms.
...
- Read: Audio score blends cue identity, active reference similarity, reference-window precision, overlap timing, and cue alignment. 7/14 reference windows still need tighter segmentation; active Aurora-vs-reference duration delta averages 3.236s.
