...
Generated: `2026-05-16T22:00:08.294Z`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Audio identity, event feedback, and cue alignment | 7.3/10 | medium-high | 21 cue/event comparisons with waveform, spectral, overlap, alignment, and semantic event-mapping features | high; cpu, model-api, openai-api | 309 runs; 253.7 min wall; 459.4 min CPU | 7.5-8.0 | Measured release category; weakest axis | Largest current score gap and high user-experience impact: shots, explosions, boss damage, challenge results, capture/rescue feedback. | High; 3-6 hrs local/model-assisted analysis | Challenge Perfect: Use the compact high-pass segment-air result to decide whether synthesized cue roles can satisfy both segmentation and band-shape gates, or whether this event needs a reference-clip/subclip playback strategy. | reference-artifacts/analyses/quality-conformance/2026-05-16-498e13b9/report.json; reference-artifacts/analyses/aurora-audio-cue-contracts/2026-05-11-b83393cd-dirty-201628/report.json |
...
| Measured runs | 699 | Tracked harness/model/local compute work |
| Tracked wall time | 442 min | Human clock-time planning input |
| Tracked CPU time | 739.1 min | Local compute-cost planning input |
| Tracked artifact growth | 1127.9 MB | Evidence volume and storage/review-cost proxy |
...
| --- | --- | --- | --- | --- |
| Audio conformance and cue feedback | 427 | 375 min | 89.9% | Moves the moment-to-moment arcade feel: impact clarity, ambience identity, reward/loss feedback, and player understanding. |
| Gameplay behavior and level complexity | 257 | 33.9 min | 8.1% | Moves player-facing pressure, stage shape, alien entry novelty, challenge-stage learning value, and long-play texture. |
| Harness, ingestion, and assessment logic | 7 | 8.1 min | 1.9% | Moves reusable automation: scorers, artifact extraction, candidate loops, measurement confidence, and future game ingestion. |
...
| --- | --- | --- | --- |
| cpu | 680 | 391.6 min | 692.6 min |
| browser | 243 | 277.7 min | 493.3 min |
...
| challenge-perfect | 12 | 34.5 min | 63.5 min |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Audio identity, event feedback, and cue alignment | 7.3/10 | 7.5-8.0 | +0.2 | High; 3-6 hrs local/model-assisted analysis | cpu, model-api, openai-api | 309 runs; 253.7 min wall; 459.4 min CPU | Expected lift 0.7/10 on metric, 0.058/10 overall; investment score 2.89. | Challenge Perfect: Use the compact high-pass segment-air result to decide whether synthesized cue roles can satisfy both segmentation and band-shape gates, or whether this event needs a reference-clip/subclip playback strategy. |
...
| 3 | Aurora Audio Conformance Lab v2 | audio candidate loop / family promotion decisions | cue-family risk, candidate history, keeper decision, promotion gate | 8/8 target cues swept; 1 keeper candidates tracked; runtime promotions 1 | family-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-conformance-lab-v2/2026-05-16-b456e040-dirty/report.json | challengePerfect: Use the compact high-pass segment-air result to decide whether synthesized cue roles can satisfy both segmentation and band-shape gates, or whether this event needs a reference-clip/subclip playback strategy. |
...
![score-trends](reference-artifacts/analyses/conformance-economics/2026-05-16-b456e040/score-trends.svg)

![largest-score-deltas](reference-artifacts/analyses/conformance-economics/2026-05-16-b456e040/largest-score-deltas.svg)

![compute-minutes-by-resource](reference-artifacts/analyses/conformance-economics/2026-05-16-b456e040/compute-minutes-by-resource.svg)

![cost-per-positive-score-point](reference-artifacts/analyses/conformance-economics/2026-05-16-b456e040/cost-per-positive-score-point.svg)

![gpu-equivalent-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-16-b456e040/gpu-equivalent-use-by-purpose.svg)

![cpu-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-16-b456e040/cpu-use-by-purpose.svg)

![gameplay-improvement-by-project-part](reference-artifacts/analyses/conformance-economics/2026-05-16-b456e040/gameplay-improvement-by-project-part.svg)
...
- Investment priority report: `reference-artifacts/analyses/conformance-investment-priorities/2026-05-16-b456e040/report.json`
- Level-arc report: `reference-artifacts/analyses/level-arc-conformance/2026-05-16-498e13b9/report.json`
- Economics report: `reference-artifacts/analyses/conformance-economics/2026-05-16-b456e040/report.json`
