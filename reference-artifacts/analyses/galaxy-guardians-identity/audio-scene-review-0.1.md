# Galaxy Guardians 0.1 Preview Audio Scene Review
...
| --- | --- | --- | ---: | --- |
| Launch / Rack Establish | `guardians-opening-professional-review` | 0s-1.633s | 5 | The start chirp should hand off quickly into a living rack cadence instead of dead air. |
...
Listen scene by scene against the promoted reference windows, then retune only the cue families and cadence points that fail the lived-scene read.
