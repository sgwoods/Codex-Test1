...
Generated: `2026-05-15T17:17:12.510Z`
...
| --- | --- | --- | --- | --- | --- |
| Aurora Galactica current dev line | 9.2/10 | strongest Player movement conformance 10/10; weakest Audio identity and cue alignment 7.3/10; alien entry/challenge variation 8/10; audio contract readiness 9.09/10 | release-quality conformance score plus audio cue-contract read | Audio identity and cue alignment (7.3/10) | reference-artifacts/analyses/quality-conformance/2026-05-11-b83393cd/report.json; reference-artifacts/analyses/aurora-audio-cue-contracts/latest.json |
...
| --- | --- | --- | --- | --- | --- |
| Current dev baseline | 9.2/10 | audio 7.3; movement 10; boss/formation 9.2; alien/challenge 8; stage opening 8.5; challenge timing 9.2; shell integrity 9.2 | 7.6/10 reference; 6.9/10 playtest | maturity 7.2; gate coverage 9.6; public readiness 4.2; audio feel 6.4 | Baseline for the next beta-candidate discussion, now weighted by local playtest feel. |
