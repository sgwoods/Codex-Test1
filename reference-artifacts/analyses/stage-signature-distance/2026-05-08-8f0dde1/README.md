...
- Windows: 6
- Pairs: 15
- Signature score: 6.8/10
- Mean distance: 0.277
- Minimum distance: 0.136
- Distinct pair ratio: 0.467
- Repetition risk: 0.382
- Closest pair: late-run-cleanup-or-failure / late-run-escort-variant (0.136)
- Most distinct pair: challenge-stage-candidate / late-run-escort-variant (0.474)
- Regular windows: 5
- Mean regular distance: 0.189
- Minimum regular distance: 0.136
- Minimum mid/late distance: 0.137
- Closest mid/late pair: late-run-escort-variant / mid-run-pressure (0.137)
- Closest same-band regular pair: late-run-cleanup-or-failure / late-run-escort-variant (0.136)
...
| Pair | Distance |
| --- | ---: |
| late-run-cleanup-or-failure / late-run-escort-variant | 0.136 |
| late-run-escort-variant / mid-run-pressure | 0.137 |
| late-run-cleanup-or-failure / mid-run-pressure | 0.162 |
| mid-run-entry-variant / mid-run-pressure | 0.174 |
| late-run-cleanup-or-failure / mid-run-entry-variant | 0.179 |
...
| late-run-cleanup-or-failure / stage-1-baseline | 0.246 |
...
| challenge-stage-candidate / late-run-cleanup-or-failure | 0.46 |
