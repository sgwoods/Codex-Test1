...
Generated: `2026-05-10T00:11:42.806Z`
...
- Cue: `stagePulse`
- Candidate: `cadence-stable-two-step-pressure-pocket`
- Status: `precheck-reject`
- Runtime trial allowed: no
- Promote runtime from precheck alone: no
- Current cue gap: 5.11/10
- Simulated cue gap: 4.47/10
- Current worst segment: 7.14/10
- Simulated worst segment: 7.05/10
...
- Full-theme cue gap improves by 0.64/10.
- Worst segment risk improves by 0.09/10.

## Source Artifacts

- Candidate report: `reference-artifacts/analyses/aurora-audio-cue-candidates/latest-formation-pulse.json`
- Candidate focus metrics: `reference-artifacts/analyses/aurora-audio-cue-candidates/2026-05-10-b879bdaa-dirty-audio-focus-001058/formation-pulse/metrics.json`
- Theme metrics: `reference-artifacts/analyses/aurora-audio-theme-comparison/2026-05-09-main-bbcc8df1-213945/metrics.json`
- Synthetic theme metrics: `reference-artifacts/analyses/aurora-audio-promotion-precheck/2026-05-10-b879bdaa-dirty-001142-stagePulse/candidate-theme-metrics.json`
- Simulated event gap: `reference-artifacts/analyses/aurora-audio-promotion-precheck/2026-05-10-b879bdaa-dirty-001142-stagePulse/event-gap/latest.json`
