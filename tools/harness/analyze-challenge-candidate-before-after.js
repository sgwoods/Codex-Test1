...
- Expected-label lift: ${report.sweepSummary.expectedLift10}/10
- Target-video object-track lift: ${report.sweepSummary.targetVideoObjectFitLift10}/10
- Human-perfect lift: ${report.sweepSummary.humanPerfectPotentialLift10}/10
...
async function main(){
  ...
  const report = {
    ...
    read: `Candidate ${candidateId} should be visually compared against baseline, then accepted only if the full analyzers preserve safety and human-perfect playability.`
  };
