...
Generated: 2026-05-19T00:45:39.668Z
Commit: 6fd7f6ad
...
Current result: **4.2/10 interesting factor** and **4.2/10 challenge-stage conformance**. Movement is **4.1/10**, graphical conformance is **4.4/10**, alien/stage novelty is **3.9/10**, and player shot opportunity is **5.3/10**. The strongest rule finding is that current probes show no enemy shots, no attack starts, and no ship losses during sampled challenge windows. The weakest player-facing finding is that current challenge stages are functionally safe but not yet fully credible Galaga-like bonus exhibitions: strict movement is 4.1/10, strict graphics is 4.4/10, alien/stage novelty is 3.9/10, player shot opportunity is 5.3/10, active sprite-motion now includes object-tracked runtime pixel/silhouette evidence but not yet Galaga target-crop sequence comparison, and late challenge references are still first-pass group labels rather than full object tracks. Diagnostic legacy coverage was 6.8/10, which is why the old read was too generous.
...
**Aurora current:** first-challenge-peel / first-challenge-peel; lanes bee, bee, bee, bee, but, but, but, but; first-wave types bee, bee, bee, bee, but, but, but, but; visual families classic; strict movement 3.8/10, graphics 4.4/10, alien novelty 3.9/10, shot opportunity 5.5/10, target-contract fit 7/10.
...
**Movement read:** Strict movement score 3.8/10 against challenge-1-arrival-group-1: y-range fit 1, path-length fit 1, turn fit 0.4, object-track fit 0.38. Current probes now include first-pass group object tracks, but full target-video optical tracking is still not proven. Legacy broad vector best-match was 7.7/10 against challenge-1-arrival-group-1; xRange 0.7893, yRange 0.7953, pathLength 0.7863.
...
**Target contract read:** First-pass target contract fit is 7/10 for Challenging Stage 1 (Levels 3-4): group count 1, path-family order 1, type order 1, family order 1, object-track 0.38. This is now a first-pass group/object-track read, not frame-perfect optical tracking.

**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 14 sampled windows; 71% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.31.

**Safety rule:** enemy shots 0, attack starts 0, ship losses 0.

**Critical gaps:**
- Movement conformance is only 3.8/10 under the strict scorer: current paths are too short/shallow and do not yet show the sweeping, turning, learnable Galaga challenge-stage trajectories.
...
**Current score:** interesting factor 4.2/10; challenge conformance 4.2/10. Movement 4.5/10, graphics 4/10, alien novelty 3.9/10, progression 3.2/10, player shot opportunity 5.3/10.
...
**Aurora current:** scorpion-cross-sweep / cross-sweep; lanes but, boss, rogue, bee, bee, rogue, boss, but; first-wave types but, boss, rogue, bee, bee, rogue, boss, but; visual families classic; strict movement 4.5/10, graphics 4/10, alien novelty 3.9/10, shot opportunity 5.3/10, target-contract fit 7.3/10.

**Graphics read:** Strict graphics score 4/10. Current visible family/type labels are present, Direct runtime-vs-Galaga target-crop comparator reads 4.48/10 overall and 4.46/10 for challenge specialty sprites; weakest challenge crop is challenge-dragonfly at 4.46/10. Runtime sprite-motion hook observed 3 visual family/families, 3 path pose family/families, 6/6 animation phase buckets, both flap state(s), and 39 object-tracked silhouette track(s). Graphics remain capped at 4.8/10 until object tracks are compared as full temporal Galaga target-crop sequences, rotations, dive poses, and capture/rescue transitions.

**Movement read:** Strict movement score 4.5/10 against challenge-2-arrival-group-1: y-range fit 1, path-length fit 1, turn fit 1, object-track fit 0.53. Current probes now include first-pass group object tracks, but full target-video optical tracking is still not proven. Legacy broad vector best-match was 8.9/10 against challenge-2-arrival-group-1; xRange 1.0092, yRange 0.6683, pathLength 0.9261.
...
**Target contract read:** First-pass target contract fit is 7.3/10 for Challenging Stage 2 (Levels 7-8): group count 1, path-family order 1, type order 1, family order 1, object-track 0.53. This is now a first-pass group/object-track read, not frame-perfect optical tracking.

**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 13 sampled windows; 69% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.13.
...
**Current score:** interesting factor 4.3/10; challenge conformance 4.3/10. Movement 4.5/10, graphics 4.5/10, alien novelty 3.9/10, progression 3.2/10, player shot opportunity 5.1/10.
...
**Aurora current:** stingray-crown-hook-hybrid / hook-arc; lanes boss, rogue, but, bee, boss, bee, but, rogue; first-wave types boss, rogue, but, bee, boss, bee, but, rogue; visual families dragonfly; strict movement 4.5/10, graphics 4.5/10, alien novelty 3.9/10, shot opportunity 5.1/10, target-contract fit 7.3/10.

**Graphics read:** Strict graphics score 4.5/10. Current visible family/type labels are present, Direct runtime-vs-Galaga target-crop comparator reads 4.48/10 overall and 4.46/10 for challenge specialty sprites; weakest challenge crop is challenge-dragonfly at 4.46/10. Runtime sprite-motion hook observed 3 visual family/families, 3 path pose family/families, 6/6 animation phase buckets, both flap state(s), and 38 object-tracked silhouette track(s). Graphics remain capped at 4.8/10 until object tracks are compared as full temporal Galaga target-crop sequences, rotations, dive poses, and capture/rescue transitions.

**Movement read:** Strict movement score 4.5/10 against challenge-3-arrival-group-1: y-range fit 1, path-length fit 1, turn fit 1, object-track fit 0.51. Current probes now include first-pass group object tracks, but full target-video optical tracking is still not proven. Legacy broad vector best-match was 8.9/10 against challenge-3-arrival-group-1; xRange 1.0215, yRange 0.7175, pathLength 1.0525.
...
**Target contract read:** First-pass target contract fit is 7.3/10 for Challenging Stage 3 (Levels 11-12): group count 1, path-family order 1, type order 1, family order 1, object-track 0.51. This is now a first-pass group/object-track read, not frame-perfect optical tracking.

**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 13 sampled windows; 62% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.15.
...
**Current score:** interesting factor 4.2/10; challenge conformance 4.2/10. Movement 4.1/10, graphics 4.5/10, alien novelty 3.9/10, progression 3.1/10, player shot opportunity 5.3/10.
...
**Aurora current:** pink-serpentine-late / pink-serpentine; lanes boss, rogue, but, bee, bee, but, rogue, boss; first-wave types boss, rogue, but, bee, bee, but, rogue, boss; visual families galboss; strict movement 4.1/10, graphics 4.5/10, alien novelty 3.9/10, shot opportunity 5.3/10, target-contract fit pending/10.

**Graphics read:** Strict graphics score 4.5/10. Current visible family/type labels are present, Direct runtime-vs-Galaga target-crop comparator reads 4.48/10 overall and 4.46/10 for challenge specialty sprites; weakest challenge crop is challenge-dragonfly at 4.46/10. Runtime sprite-motion hook observed 2 visual family/families, 3 path pose family/families, 6/6 animation phase buckets, both flap state(s), and 37 object-tracked silhouette track(s). Graphics remain capped at 4.8/10 until object tracks are compared as full temporal Galaga target-crop sequences, rotations, dive poses, and capture/rescue transitions.

**Movement read:** Strict movement score 4.1/10 against challenge-4-pink-serpentine-group-4: y-range fit 1, path-length fit 0.93, turn fit 1, object-track fit 0. Current probes now include first-pass group object tracks, but full target-video optical tracking is still not proven. Legacy broad vector best-match was 9.2/10 against challenge-4-pink-serpentine-group-4; xRange 1.0351, yRange 0.6258, pathLength 1.0238.
...
**Target contract read:** No explicit challenge-stage target contract is available for this stage yet.

**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 13 sampled windows; 69% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.12.

**Safety rule:** enemy shots 0, attack starts 0, ship losses 0.

**Critical gaps:**
- Alien/stage novelty is only 3.9/10: the current type mix does not yet prove Galaga-like new alien introductions, memorable challenge-specific roles, or distinct bonus-stage learning patterns.
- Target-contract fit is only null/10: the runtime group order, path families, type/family mix, or group count still misses the first-pass media-backed challenge contract.
...
**Current score:** interesting factor 4.2/10; challenge conformance 4.2/10. Movement 4.2/10, graphics 4.5/10, alien novelty 3.9/10, progression 3.1/10, player shot opportunity 5.4/10.
...
**Aurora current:** pink-green-cascade / pink-green-cascade; lanes rogue, boss, but, bee, boss, but, bee, rogue; first-wave types rogue, boss, but, bee, boss, but, bee, rogue; visual families galboss; strict movement 4.2/10, graphics 4.5/10, alien novelty 3.9/10, shot opportunity 5.4/10, target-contract fit pending/10.

**Graphics read:** Strict graphics score 4.5/10. Current visible family/type labels are present, Direct runtime-vs-Galaga target-crop comparator reads 4.48/10 overall and 4.46/10 for challenge specialty sprites; weakest challenge crop is challenge-dragonfly at 4.46/10. Runtime sprite-motion hook observed 3 visual family/families, 3 path pose family/families, 6/6 animation phase buckets, both flap state(s), and 38 object-tracked silhouette track(s). Graphics remain capped at 4.8/10 until object tracks are compared as full temporal Galaga target-crop sequences, rotations, dive poses, and capture/rescue transitions.

**Movement read:** Strict movement score 4.2/10 against challenge-5-pink-green-cascade-group-2: y-range fit 0.99, path-length fit 0.87, turn fit 1, object-track fit 0. Current probes now include first-pass group object tracks, but full target-video optical tracking is still not proven. Legacy broad vector best-match was 9.4/10 against challenge-5-pink-green-cascade-group-2; xRange 1.0366, yRange 0.5126, pathLength 0.9379.
...
**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 13 sampled windows; 77% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.19.
...
**Current score:** interesting factor 4.1/10; challenge conformance 4.1/10. Movement 4/10, graphics 4.4/10, alien novelty 3.9/10, progression 2.7/10, player shot opportunity 5.6/10.
...
**Aurora current:** green-ladder-split / green-ladder-split; lanes bee, but, rogue, boss, boss, rogue, but, bee; first-wave types bee, but, rogue, boss, boss, rogue, but, bee; visual families dragonfly; strict movement 4/10, graphics 4.4/10, alien novelty 3.9/10, shot opportunity 5.6/10, target-contract fit pending/10.

**Graphics read:** Strict graphics score 4.4/10. Current visible family/type labels are present, Direct runtime-vs-Galaga target-crop comparator reads 4.48/10 overall and 4.46/10 for challenge specialty sprites; weakest challenge crop is challenge-dragonfly at 4.46/10. Runtime sprite-motion hook observed 2 visual family/families, 1 path pose family/families, 6/6 animation phase buckets, both flap state(s), and 40 object-tracked silhouette track(s). Graphics remain capped at 4.8/10 until object tracks are compared as full temporal Galaga target-crop sequences, rotations, dive poses, and capture/rescue transitions.

**Movement read:** Strict movement score 4/10 against challenge-6-green-ladder-split-group-1: y-range fit 1, path-length fit 1, turn fit 1, object-track fit 0. Current probes now include first-pass group object tracks, but full target-video optical tracking is still not proven. Legacy broad vector best-match was 8.9/10 against challenge-6-green-ladder-split-group-1; xRange 1.0533, yRange 0.646, pathLength 1.1868.
...
**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 12 sampled windows; 75% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.16.
...
**Current score:** interesting factor 4/10; challenge conformance 3.9/10. Movement 3.8/10, graphics 4.4/10, alien novelty 3.9/10, progression 2.7/10, player shot opportunity 4.9/10.

**Legacy broad coverage score:** 6.8/10. This is retained as diagnostic evidence only; it no longer counts as the player-facing conformance score.

**Original target:** Seventh challenge should introduce a yellow diagonal fan with a memorable scoring lane.

**Aurora current:** yellow-diagonal-fan / yellow-diagonal-fan; lanes boss, bee, but, rogue, rogue, but, bee, boss; first-wave types boss, bee, but, rogue, rogue, but, bee, boss; visual families crown; strict movement 3.8/10, graphics 4.4/10, alien novelty 3.9/10, shot opportunity 4.9/10, target-contract fit pending/10.

**Graphics read:** Strict graphics score 4.4/10. Current visible family/type labels are present, Direct runtime-vs-Galaga target-crop comparator reads 4.48/10 overall and 4.46/10 for challenge specialty sprites; weakest challenge crop is challenge-dragonfly at 4.46/10. Runtime sprite-motion hook observed 1 visual family/families, 1 path pose family/families, 6/6 animation phase buckets, both flap state(s), and 32 object-tracked silhouette track(s). Graphics remain capped at 4.8/10 until object tracks are compared as full temporal Galaga target-crop sequences, rotations, dive poses, and capture/rescue transitions.

**Movement read:** Strict movement score 3.8/10 against challenge-7-yellow-diagonal-fan-group-1: y-range fit 0.81, path-length fit 0.89, turn fit 0.5, object-track fit 0. Current probes now include first-pass group object tracks, but full target-video optical tracking is still not proven. Legacy broad vector best-match was 8.7/10 against challenge-7-yellow-diagonal-fan-group-1; xRange 0.9576, yRange 0.4527, pathLength 0.9744.
...
**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 10 sampled windows; 70% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.13.
...
**Current score:** interesting factor 4.2/10; challenge conformance 4.2/10. Movement 4.2/10, graphics 4.5/10, alien novelty 3.9/10, progression 3.1/10, player shot opportunity 5.3/10.

**Legacy broad coverage score:** 7/10. This is retained as diagnostic evidence only; it no longer counts as the player-facing conformance score.

**Original target:** Eighth visible challenge should act as a compact blue/purple late-loop capstone.

**Aurora current:** blue-purple-finale / blue-purple-finale; lanes rogue, boss, bee, but, but, bee, boss, rogue; first-wave types rogue, boss, bee, but, but, bee, boss, rogue; visual families stingray; strict movement 4.2/10, graphics 4.5/10, alien novelty 3.9/10, shot opportunity 5.3/10, target-contract fit pending/10.

**Graphics read:** Strict graphics score 4.5/10. Current visible family/type labels are present, Direct runtime-vs-Galaga target-crop comparator reads 4.48/10 overall and 4.46/10 for challenge specialty sprites; weakest challenge crop is challenge-dragonfly at 4.46/10. Runtime sprite-motion hook observed 3 visual family/families, 3 path pose family/families, 6/6 animation phase buckets, both flap state(s), and 35 object-tracked silhouette track(s). Graphics remain capped at 4.8/10 until object tracks are compared as full temporal Galaga target-crop sequences, rotations, dive poses, and capture/rescue transitions.

**Movement read:** Strict movement score 4.2/10 against challenge-8-blue-purple-finale-group-5: y-range fit 1, path-length fit 1, turn fit 1, object-track fit 0. Current probes now include first-pass group object tracks, but full target-video optical tracking is still not proven. Legacy broad vector best-match was 9.3/10 against challenge-8-blue-purple-finale-group-5; xRange 0.9966, yRange 0.6647, pathLength 1.1166.
...
**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 13 sampled windows; 69% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.17.
...
- Raise challenge-stage interesting factor from 4.2/10 to 5.0/10 as the first honest beta-facing gate by implementing one visibly reference-like challenge, then toward 6.0/10 after Stage 3, 7, and 11 each have distinct authored contracts.
...
- Raise movement conformance from 4.1/10 by increasing y-range, path length, turn count, and exit-side match against the Galaga challenge references.
- Raise graphical conformance from 4.4/10 by extending the object-tracked silhouette hook into Galaga target-crop sequence comparisons; do not inflate it from type labels alone.
- Raise player shot opportunity from 5.3/10 by creating lane-readable scoring windows for each challenge rather than incidental central-lane hits.
