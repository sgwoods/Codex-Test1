...
Generated: `2026-05-15T01:45:24.695Z`
...
| Alien entry and challenge-stage novelty | 7.8/10 | >=7.5 first gate; >=9.0 mature | New high-priority long-cycle gameplay-authenticity gate |
...
| 2 | Aurora audio cue comparison and event-gap reports | audio cue scoring | waveform/spectral/alignment/semantic reports | 21 compared cues; semantic 9.78/10; 0 attention rows | semantic-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-event-gap/2026-05-15-f32c4a0d-dirty-014257/report.json | Tune the highest segment-level gap next: playerShot onset. Rerun audio comparison and event-gap analysis after the change. |
...
- Quality report: `reference-artifacts/analyses/quality-conformance/2026-05-15-f32c4a0d/report.json`
...
- Level-arc report: `reference-artifacts/analyses/level-arc-conformance/2026-05-15-f32c4a0d/report.json`
