...
Generated: `2026-05-09T10:39:03.334Z`
...
| --- | --- | --- | --- |
| Overall quality | 9/10 | >=9.3 | Full score refresh after all major cycles |
| Audio identity | 7.3/10 | >=7.5 | Primary user-experience gap |
| Level arc | 8.3/10 | >=8.8 | Long-play gameplay-quality gate |
| Boss entry and formation grammar | 6.9/10 | >=8.0 first gate; >=9.0 mature | New measured gate for stage choreography |
| Alien entry / formations | 6.9/10 measured | >=9.2 with path/rack scorer | Now backed by boss/formation grammar |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Audio identity, event feedback, and cue alignment | 7.3/10 | medium-high | 21 cue/event comparisons with waveform, spectral, overlap, alignment, and semantic event-mapping features | high; cpu, model-api, openai-api | 95 runs; 76.7 min wall; 135 min CPU | 7.5-8.0 | Measured release category; weakest axis | Largest current score gap and high user-experience impact: shots, explosions, boss damage, challenge results, capture/rescue feedback. | High; 3-6 hrs local/model-assisted analysis | Tune the highest segment-level audio gap next: challengeResults onset. Rerun audio comparison, event-gap analysis, and quality scoring after the change. | reference-artifacts/analyses/quality-conformance/2026-05-09-4874ced4/report.json |
| 2 | Level arc and encounter shape | 8.3/10 | medium-high | multi-submetric level-arc report with stage families, challenge layers, pressure, reward, and persona evidence | low; cpu, browser | 125 runs; 22 min wall; 36.3 min CPU | 8.8-9.0 | Measured release category | Controls whether long play feels like Galaga-like escalation rather than repeated pressure. | Medium-high; 2-5 hrs | Use the top-ranked opportunity window to add or widen deterministic evidence before changing gameplay tuning. | reference-artifacts/analyses/level-arc-conformance/2026-05-09-4874ced4/report.json |
| 3 | Boss entry and formation grammar | 6.9/10 | medium | first-class boss/formation scorer using stage-window event grammar, boss timing, escort composition, challenge identity, and explicit path/slot measurement debt | guardrail; cpu, browser | 125 runs; 22 min wall; 36.3 min CPU | 8.0-8.5 first gate; 9.0+ with path/slot extraction | Measured release category; new first-class axis | Boss entries, escorts, formation settling, and challenge set pieces are core Galaga choreography and directly affect whether stages feel authored. | Medium-high; 2-5 hrs, then recurring low-cost guardrail | Advance Path shape and set-formation precision: 0 motion hints and 0 formation slot hints across 6 windows. | reference-artifacts/analyses/quality-conformance/2026-05-09-4874ced4/report.json |
...
| --- | --- | --- |
| Latest overall conformance | 9/10 | Primary quality roll-up for release notes and scorecards |
| Latest level-arc conformance | 8.3/10 | Long-play gameplay-shape gate |
| Metric points scanned | 620 | History depth behind score trends |
| Score deltas found | 88 | Past-goal movement available for review |
...
| 2 | Level arc and encounter shape | 8.3/10 | 8.8-9.0 | +0.5 | Medium-high; 2-5 hrs | cpu, browser | 125 runs; 22 min wall; 36.3 min CPU | Expected lift 0.24/10 on metric, 0.02/10 overall; investment score 1.82. | Use the top-ranked opportunity window to add or widen deterministic evidence before changing gameplay tuning. |
| 3 | Boss entry and formation grammar | 6.9/10 | 8.0-8.5 first gate; 9.0+ with path/slot extraction | +1.1 | Medium-high; 2-5 hrs, then recurring low-cost guardrail | cpu, browser | 125 runs; 22 min wall; 36.3 min CPU | Guardrail spend: value is preventing regression rather than raising the score. | Advance Path shape and set-formation precision: 0 motion hints and 0 formation slot hints across 6 windows. |
...
| 5 | Stage 4 pressure exact replay / pressure curve precision | 7/10 | 8.2-8.6 | +1.2 | Medium-high; prior runs ~12.8 min wall / 18.5 min CPU | cpu, browser | 28 runs; 12.8 min wall; 18.5 min CPU | Expected lift 0.35/10 on metric, 0.029/10 overall; investment score 1.63. | Run focused source-window replay matching after the Stage 12 loop validates candidate mechanics. |
| 6 | Alien entry to levels: formation, timing, and methods | 6.9/10 | 9.0-9.4 with path and rack-slot scorer | +2.1 | Medium; 1-3 hrs plus visual review | cpu, browser | 64 runs; 11.1 min wall; 15.8 min CPU | Estimated cost/value; dedicated investment candidate not yet generated. | Promote stage-entry contact sheets, path labels, and formation slot coordinates across early/mid/late levels. |
...
| 2 | Aurora audio cue comparison and event-gap reports | audio cue scoring | waveform/spectral/alignment/semantic reports | 21 compared cues; semantic 9.76/10; 0 attention rows | semantic-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-event-gap/2026-05-09-4874ced4-dirty/report.json | Tune the highest segment-level gap next: challengeResults onset. Rerun audio comparison and event-gap analysis after the change. |
| 3 | Boss entry and formation grammar scorer | formation grammar / boss entry / challenge identity | event grammar, timing, stage-signature, and measurement-debt report | 6 boss/formation windows | scored | medium | Boss entry and formation grammar | reference-artifacts/analyses/formation-boss-grammar-conformance/2026-05-09-4874ced4/report.json | Promote frame-level boss/escort path traces and formation rack slot coordinates so visual choreography can be scored directly. |
| 4 | Level arc and encounter-shape evidence | level arc / challenge / reward | stage signatures, pressure windows, persona reports | 6/6 stage families; 6/6 evidence windows | scored | medium-high | Level arc and encounter shape | reference-artifacts/analyses/level-arc-conformance/2026-05-09-4874ced4/report.json | Add more long-play reference windows and expert-route scoring for challenge/reward opportunities. |
...
![score-trends](reference-artifacts/analyses/conformance-economics/2026-05-09-4874ced4/score-trends.svg)

![largest-score-deltas](reference-artifacts/analyses/conformance-economics/2026-05-09-4874ced4/largest-score-deltas.svg)

![compute-minutes-by-resource](reference-artifacts/analyses/conformance-economics/2026-05-09-4874ced4/compute-minutes-by-resource.svg)

![cost-per-positive-score-point](reference-artifacts/analyses/conformance-economics/2026-05-09-4874ced4/cost-per-positive-score-point.svg)
...
- Quality report: `reference-artifacts/analyses/quality-conformance/2026-05-09-4874ced4/report.json`
- Investment priority report: `reference-artifacts/analyses/conformance-investment-priorities/2026-05-09-4874ced4/report.json`
- Level-arc report: `reference-artifacts/analyses/level-arc-conformance/2026-05-09-4874ced4/report.json`
- Economics report: `reference-artifacts/analyses/conformance-economics/2026-05-09-4874ced4/report.json`
