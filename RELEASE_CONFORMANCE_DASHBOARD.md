...
Generated: `2026-05-11T18:05:06.932Z`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Audio identity, event feedback, and cue alignment | 7.2/10 | medium-high | 21 cue/event comparisons with waveform, spectral, overlap, alignment, and semantic event-mapping features | high; cpu, model-api, openai-api | 245 runs; 173.6 min wall; 309.7 min CPU | 7.5-8.0 | Measured release category; weakest axis | Largest current score gap and high user-experience impact: shots, explosions, boss damage, challenge results, capture/rescue feedback. | High; 3-6 hrs local/model-assisted analysis | Run a contract-aware candidate pass for playerHit, then rerun promotion precheck and live validation. | reference-artifacts/analyses/quality-conformance/2026-05-11-23c856ad/report.json; reference-artifacts/analyses/aurora-audio-cue-contracts/2026-05-11-23c856ad-dirty-180211/report.json |
...
| Metric points scanned | 1173 | History depth behind score trends |
| Score deltas found | 125 | Past-goal movement available for review |
| Measured runs | 472 | Tracked harness/model/local compute work |
| Tracked wall time | 319.5 min | Human clock-time planning input |
| Tracked CPU time | 506.5 min | Local compute-cost planning input |
| Tracked artifact growth | 795.6 MB | Evidence volume and storage/review-cost proxy |
...
| --- | --- | --- | --- | --- |
| Audio conformance and cue feedback | 323 | 264.7 min | 89.9% | Moves the moment-to-moment arcade feel: impact clarity, ambience identity, reward/loss feedback, and player understanding. |
| Gameplay behavior and level complexity | 138 | 25 min | 8.5% | Moves player-facing pressure, stage shape, alien entry novelty, challenge-stage learning value, and long-play texture. |
| Harness, ingestion, and assessment logic | 4 | 4.8 min | 1.6% | Moves reusable automation: scorers, artifact extraction, candidate loops, measurement confidence, and future game ingestion. |
...
| Dashboard, docs, and release planning | 4 | 0 min | 0% | Moves decision quality: what to invest in next, how to explain releases, and how to keep dev/beta/prod evidence aligned. |

| Project part | Positive score movement | Share | Player/designer meaning |
| --- | --- | --- | --- |
| Gameplay complexity and stage arc | +46.2 | 75.4% | Player-perceived variety, pressure, alien choreography, challenge-stage novelty, and long-play learning curve. |
| Core mechanics and control feel | +7 | 11.4% | Player-perceived fairness, responsiveness, collision quality, and trust in combat outcomes. |
| Audio feedback and event clarity | +5.5 | 9% | Player-perceived clarity from sounds that explain danger, reward, loss, and arcade identity. |
| Overall release-quality rollup | +2.6 | 4.2% | Composite release score movement that reflects several subsystems at once. |

### Resource And Time Usage

| Resource | Measured runs | Wall time | CPU time |
| --- | --- | --- | --- |
| cpu | 470 | 294.5 min | 506.5 min |
| browser | 167 | 180.9 min | 314.9 min |
...
| --- | --- | --- | --- |
| audio | 245 | 173.6 min | 309.7 min |
| audio-focus-candidate | 27 | 66 min | 121.8 min |
| conformance-economics | 93 | 46.4 min | 30.7 min |
| player-hit | 20 | 29.5 min | 53.8 min |
| audio-theme-comparison | 24 | 29.1 min | 53.8 min |
| dashboard | 9 | 25 min | 0 min |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Audio identity, event feedback, and cue alignment | 7.2/10 | 7.5-8.0 | +0.3 | High; 3-6 hrs local/model-assisted analysis | cpu, model-api, openai-api | 245 runs; 173.6 min wall; 309.7 min CPU | Expected lift 0.7/10 on metric, 0.058/10 overall; investment score 2.96. | Run a contract-aware candidate pass for playerHit, then rerun promotion precheck and live validation. |
...
| 2 | Aurora audio cue comparison and event-gap reports | audio cue scoring | waveform/spectral/alignment/semantic reports | 21 compared cues; semantic 9.78/10; 0 attention rows | semantic-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-event-gap/2026-05-11-23c856ad-dirty-180116/report.json | Tune the highest segment-level gap next: playerHit tail. Rerun audio comparison and event-gap analysis after the change. |
| 3 | Aurora Audio Conformance Lab v2 | audio candidate loop / family promotion decisions | cue-family risk, candidate history, keeper decision, promotion gate | 8/8 target cues swept; 1 keeper candidates tracked; runtime promotions 0 | family-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-conformance-lab-v2/2026-05-11-23c856ad-dirty/report.json | Run a contract-aware candidate pass for playerHit, then rerun promotion precheck and live validation. |
| 4 | Aurora audio cue contracts | audio semantic contract / theme latitude / promotion safety | cue contract readiness, theme lanes, runtime-trial blockers | 8 contracts; readiness 9.1/10; blocked 8 | contract-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-cue-contracts/2026-05-11-23c856ad-dirty-180211/report.json | Run a contract-aware candidate pass for playerHit, then rerun promotion precheck and live validation. |
...
![score-trends](reference-artifacts/analyses/conformance-economics/2026-05-11-23c856ad/score-trends.svg)

![largest-score-deltas](reference-artifacts/analyses/conformance-economics/2026-05-11-23c856ad/largest-score-deltas.svg)

![compute-minutes-by-resource](reference-artifacts/analyses/conformance-economics/2026-05-11-23c856ad/compute-minutes-by-resource.svg)

![cost-per-positive-score-point](reference-artifacts/analyses/conformance-economics/2026-05-11-23c856ad/cost-per-positive-score-point.svg)

![gpu-equivalent-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-11-23c856ad/gpu-equivalent-use-by-purpose.svg)

![cpu-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-11-23c856ad/cpu-use-by-purpose.svg)

![gameplay-improvement-by-project-part](reference-artifacts/analyses/conformance-economics/2026-05-11-23c856ad/gameplay-improvement-by-project-part.svg)
...
- Quality report: `reference-artifacts/analyses/quality-conformance/2026-05-11-23c856ad/report.json`
...
- Level-arc report: `reference-artifacts/analyses/level-arc-conformance/2026-05-11-23c856ad/report.json`
- Economics report: `reference-artifacts/analyses/conformance-economics/2026-05-11-23c856ad/report.json`
