...
- Score: 8.3/10
- Read: 5/5 challenge timing checks pass and 3/3 content layers are blueprinted; opportunity-window readiness is 4.5/10.
...
- Score: 7.5/10
- Read: 3/3 source pressure/loss windows are found, but 0 reproduce as exact losses under replay. Pressure-collision replay diagnostics classify 2 as same-window or exact collision pressure.

### Boss and reward opportunity design
- Score: 8.1/10
- Read: 3/3 capture/rescue scenarios match; level-arc opportunity windows show mean reward/opportunity signal 2.1/10.
...
- late-run-cleanup-or-failure has late-stage pressure evidence but low reward/opportunity signal (1.3/10). Strategy: Measure boss/escort score opportunities, hit-before-loss events, and clear/failure outcomes; then add one visible late-stage reward window rather than increasing raw attack density.
