...
- Read: Close-shot responsiveness passed, and movement-fire post-shot travel was 55.97, with shot delay -5ms.
...
- Read: Level arc score is 8.5/10 with 6/6 stage families blueprinted and 6/6 evidence windows present; weakest submetric is Pressure curve over time (7.5/10).
...
- Read: Audio score blends cue identity, active reference similarity, reference-window precision, overlap timing, cue alignment, and semantic event mapping. 0/21 reference windows still need tighter segmentation; 7 candidate subwindows were found; semantic event score is 9.76/10 with 0 semantic attention rows and 0 shared-reference risks.
...
- Audio identity and cue alignment: 7.9/10
- Stage-1 opening timing fidelity: 8.5/10
- Level arc and encounter shape: 8.5/10
