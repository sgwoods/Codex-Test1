...
| 2 | Tighten level-arc opportunity coverage and late reward reads | level-arc | 1.6 | 0.022 | 1.95 | Widen mid-run/late-run evidence coverage and add a Stage 14 reward-route probe before changing gameplay tuning. |
