...
- Score: 6.7/10
- Windows: 6
- Full coverage windows: 4/6
- Mean pressure index: 4.8/10
- Mean reward index: 3.4/10
- Mean identity index: 7/10
- Skill-route reward windows: 3
- Outcome reward windows: 3
- Outcome special reward bonus: 4800
- Highest priority opportunity: stage-1-baseline-missing-event-coverage
...
| late-run-cleanup-or-failure | 12 | 7.2 | 5.4 (base 1.8; skill 9) | 7.3 | none | player_hit, wave_clear, game_over; notes: player_hit=satisfied-by-widened-outcome-route, wave_clear=satisfied-by-widened-endpoint-route, game_over=not-required |
| late-run-escort-variant | 14 | 6.6 | 6 (base 2.1; skill 10) | 7.3 | none | player_hit, wave_clear, game_over; notes: player_hit=satisfied-by-widened-outcome-route, wave_clear=satisfied-by-widened-endpoint-route, game_over=not-required |
| mid-run-entry-variant | 8 | 4.3 | 0.6 | 6.5 | escort_dive_start | escort_dive_start, player_hit, wave_clear; notes: player_hit=satisfied-by-widened-outcome-route, wave_clear=satisfied-by-widened-endpoint-route |
| mid-run-pressure | 6 | 7 | 1.8 (base 1.2; skill 2.3) | 7.3 | none | flank_dive_start, wave_clear; notes: flank_dive_start=not-applicable, wave_clear=satisfied-by-widened-endpoint-route |
| stage-1-baseline | 1 | 2.4 | 0 | 4.9 | player_shot, wave_clear | player_shot, wave_clear |
