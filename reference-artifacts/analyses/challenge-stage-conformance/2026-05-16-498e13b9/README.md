...
Generated: 2026-05-16T20:56:21.111Z
Commit: 498e13b9
...
| --- | --- | ---: | ---: | ---: | --- | --- | --- | --- |
| 3 | 1 | 6/10 | 6/10 | 7.2/10 | challenge-1-arrival-group-1 (6.8/10) | first-challenge-peel | pass | Reference target hit; remaining work is trajectory precision and active motion scoring. |
| 7 | 2 | 6/10 | 6/10 | 8.3/10 | challenge-2-arrival-group-1 (6.6/10) | cross-sweep | pass | Cross-sweep identity is visible in labels, but the measured vector still lands closest to the same challenge-2 reference as most other challenge stages. |
| 11 | 3 | 6.7/10 | 6.7/10 | 8/10 | challenge-3-arrival-group-1 (7.4/10) | hook-arc | pass | Dragonfly family appears, but sprite-motion novelty and tracked Galaga challenge-3 path phases are not yet scored. |
| 15 | 4 | 6.5/10 | 6.5/10 | 7.7/10 | challenge-3-arrival-group-1 (6.8/10) | boss-led-loop | pass | Boss-led-loop now lands on the challenge-3 reference, but late-stage reference labels and high-bonus readability probes are still thin. |
| 19 | 5 | 4.9/10 | 5.3/10 | 7.5/10 | challenge-3-arrival-group-1 (7.3/10) | crown-split-cascade | pass | Stage 19 now has crown-split-cascade runtime path extraction, but Galaga late-challenge reference labels and high-bonus readability probes are still missing. |


## Stage 3 / Challenge 1

**Current score:** interesting factor 6/10; challenge conformance 6/10.
...
**Movement read:** Trajectory vector best-match score 6.8/10 against challenge-1-arrival-group-1; xRange 0.5542, yRange 0.0621, pathLength 0.1951.
...
**Movement read:** Trajectory vector best-match score 6.6/10 against challenge-2-arrival-group-1; xRange 0.557, yRange 0.1243, pathLength 0.3259.
...
**Current score:** interesting factor 6.7/10; challenge conformance 6.7/10.
...
**Aurora current:** stingray-crown-hook-hybrid / hook-arc; lanes boss, rogue, but, bee, boss, bee, but, rogue; first-wave types boss, rogue, but, bee, boss, bee, but, rogue; visual families dragonfly; group identity 8/10.
...
**Movement read:** Trajectory vector best-match score 7.4/10 against challenge-3-arrival-group-1; xRange 0.7479, yRange 0.1316, pathLength 0.5787.
...
**Current score:** interesting factor 6.5/10; challenge conformance 6.5/10.
...
**Movement read:** Trajectory vector best-match score 6.8/10 against challenge-3-arrival-group-1; xRange 0.6455, yRange 0.1612, pathLength 0.4834.
...
**Current score:** interesting factor 4.9/10; challenge conformance 5.3/10.
...
**Movement read:** Trajectory vector best-match score 7.3/10 against challenge-3-arrival-group-1; xRange 0.7536, yRange 0.1536, pathLength 0.6406.
...
- Raise challenge-stage interesting factor from 6/10 toward 6.0/10 without regressing no-shot/no-kill guardrails.
