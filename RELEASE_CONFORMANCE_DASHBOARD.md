...
Generated: `2026-05-19T00:57:28.317Z`
...
| Metric points scanned | 1924 | History depth behind score trends |
| Score deltas found | 162 | Past-goal movement available for review |
| Measured runs | 815 | Tracked harness/model/local compute work |
| Tracked wall time | 937.8 min | Human clock-time planning input |
| Tracked CPU time | 923.3 min | Local compute-cost planning input |
| Tracked artifact growth | 1306.7 MB | Evidence volume and storage/review-cost proxy |
...
| --- | --- | --- | --- | --- |
| Audio conformance and cue feedback | 510 | 504.2 min | 88% | Moves the moment-to-moment arcade feel: impact clarity, ambience identity, reward/loss feedback, and player understanding. |
| Gameplay behavior and level complexity | 275 | 59.2 min | 10.3% | Moves player-facing pressure, stage shape, alien entry novelty, challenge-stage learning value, and long-play texture. |
| Harness, ingestion, and assessment logic | 8 | 9.1 min | 1.6% | Moves reusable automation: scorers, artifact extraction, candidate loops, measurement confidence, and future game ingestion. |
...
| --- | --- | --- | --- |
| Gameplay complexity and stage arc | +49.3 | 73.7% | Player-perceived variety, pressure, alien choreography, challenge-stage novelty, and long-play learning curve. |
...
| cpu | 791 | 547.4 min | 876.8 min |
| browser | 290 | 406.1 min | 627.7 min |
...
| 4.5 | Direct target sprite and impact feedback conformance | 4.5/10 | >=5.5 before next beta claim; >=7.5 mature preview | +1 | Medium-high; 2-5 hrs renderer/crop/harness work plus visual review | cpu | 16 runs; 17.6 min wall; 20.4 min CPU | Estimated cost/value; dedicated investment candidate not yet generated. | Raise direct sprite target score and impact/explosion feedback together; current impact/explosion static read is 5.9/10. |
...
| 2 | Aurora audio cue comparison and event-gap reports | audio cue scoring | waveform/spectral/alignment/semantic reports | 21 compared cues; semantic 9.78/10; 0 attention rows | semantic-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-event-gap/2026-05-19-6fd7f6ad-dirty-004739/report.json | Tune the highest segment-level gap next: challengePerfect onset. Rerun audio comparison and event-gap analysis after the change. |
...
![score-trends](reference-artifacts/analyses/conformance-economics/2026-05-19-6fd7f6ad/score-trends.svg)

![largest-score-deltas](reference-artifacts/analyses/conformance-economics/2026-05-19-6fd7f6ad/largest-score-deltas.svg)

![compute-minutes-by-resource](reference-artifacts/analyses/conformance-economics/2026-05-19-6fd7f6ad/compute-minutes-by-resource.svg)

![cost-per-positive-score-point](reference-artifacts/analyses/conformance-economics/2026-05-19-6fd7f6ad/cost-per-positive-score-point.svg)

![gpu-equivalent-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-19-6fd7f6ad/gpu-equivalent-use-by-purpose.svg)

![cpu-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-19-6fd7f6ad/cpu-use-by-purpose.svg)

![gameplay-improvement-by-project-part](reference-artifacts/analyses/conformance-economics/2026-05-19-6fd7f6ad/gameplay-improvement-by-project-part.svg)
...
- Quality report: `reference-artifacts/analyses/quality-conformance/2026-05-19-6fd7f6ad/report.json`
...
- Level-arc report: `reference-artifacts/analyses/level-arc-conformance/2026-05-19-6fd7f6ad/report.json`
- Economics report: `reference-artifacts/analyses/conformance-economics/2026-05-19-6fd7f6ad/report.json`
