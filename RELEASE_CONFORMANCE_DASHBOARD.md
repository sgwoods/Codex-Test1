...
Generated: `2026-05-17T12:58:06.998Z`
...
| Metric points scanned | 1671 | History depth behind score trends |
| Score deltas found | 152 | Past-goal movement available for review |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Audio identity, event feedback, and cue alignment | 7/10 | 7.5-8.0 | +0.5 | High; 3-6 hrs local/model-assisted analysis | cpu, model-api, openai-api | 309 runs; 253.7 min wall; 459.4 min CPU | Expected lift 0.7/10 on metric, 0.058/10 overall; investment score 3. | Challenge Perfect runtime trial rejected perfect-clean-onset-soft-tail; do not directly promote the focused keeper. Do not promote Challenge Perfect from isolated onset/body candidates. Replace the next audio strategy with full-phrase/segment-boundary work: stabilize the scorer on canonical reference-vs-reference capture, then generate candidates that optimize onset, body, tail, and live capture segmentation together. |
| 2 | Alien entry and challenge-stage novelty | 8.3/10 | 7.5 first gate; 9.0+ mature | at target | High; long-cycle CPU/browser extraction plus reference contact-sheet and path-labeling pass | cpu, browser | 221 runs; 26.4 min wall; 44.3 min CPU | Estimated cost/value; dedicated investment candidate not yet generated. | Attack Regular-entry geometry separation: Minimum regular geometry distance 0.07; mean regular geometry distance 0.118; closest pair late-run-cleanup-or-failure / late-run-escort-variant. |
...
| 8 | Challenge-stage variation and new alien/formations introduction | 6.1/10 | 9.0-9.4 with dedicated scorer | +2.9 | Medium-high; 2-4 hrs | cpu, browser | 111 runs; 25.3 min wall; 33.6 min CPU | Estimated cost/value; dedicated investment candidate not yet generated. | Close dedicated challenge-stage gaps: challenge stages are still not authored enough as memorable Galaga-like set pieces: 1 sampled stage(s) still best-match the same Galaga challenge-2 reference, stage 3 now lands on the first-challenge bee-line reference but needs stronger trajectory precision, active sprite-motion novelty is unscored, and stage 19 lacks reference grounding. |
...
| 2 | Aurora audio cue comparison and event-gap reports | audio cue scoring | waveform/spectral/alignment/semantic reports | 21 compared cues; semantic 9.78/10; 0 attention rows | semantic-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-event-gap/2026-05-17-f9e7374c-dirty-125416/report.json | Tune the highest segment-level gap next: challengePerfect onset. Rerun audio comparison and event-gap analysis after the change. |
...
![score-trends](reference-artifacts/analyses/conformance-economics/2026-05-17-f9e7374c/score-trends.svg)

![largest-score-deltas](reference-artifacts/analyses/conformance-economics/2026-05-17-f9e7374c/largest-score-deltas.svg)

![compute-minutes-by-resource](reference-artifacts/analyses/conformance-economics/2026-05-17-f9e7374c/compute-minutes-by-resource.svg)

![cost-per-positive-score-point](reference-artifacts/analyses/conformance-economics/2026-05-17-f9e7374c/cost-per-positive-score-point.svg)

![gpu-equivalent-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-17-f9e7374c/gpu-equivalent-use-by-purpose.svg)

![cpu-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-17-f9e7374c/cpu-use-by-purpose.svg)

![gameplay-improvement-by-project-part](reference-artifacts/analyses/conformance-economics/2026-05-17-f9e7374c/gameplay-improvement-by-project-part.svg)
...
- Quality report: `reference-artifacts/analyses/quality-conformance/2026-05-17-f9e7374c/report.json`
- Investment priority report: `reference-artifacts/analyses/conformance-investment-priorities/2026-05-17-f9e7374c/report.json`
- Level-arc report: `reference-artifacts/analyses/level-arc-conformance/2026-05-17-f9e7374c/report.json`
- Economics report: `reference-artifacts/analyses/conformance-economics/2026-05-17-f9e7374c/report.json`
