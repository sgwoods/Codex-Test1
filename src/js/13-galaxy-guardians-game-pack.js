...
const GUARDIANS_AUDIO_THEMES=Object.freeze({
 'guardians-signal':Object.freeze({
  ...
  cues:Object.freeze({
   ...
   playerLoss:Object.freeze({tones:Object.freeze([{freq:2370,duration:.064,wave:'square',volume:.018,slide:-820,lpHz:5400},{freq:1680,duration:.128,wave:'square',volume:.0152,slide:-610,detune:-.004,lpHz:3900,delay:.028},{freq:1100,duration:.118,wave:'square',volume:.0104,slide:-360,lpHz:2900,delay:.12},{freq:760,duration:.17,wave:'square',volume:.0072,slide:-180,detune:.003,lpHz:2200,delay:.215}]),noise:Object.freeze([{duration:.18,volume:.013,hp:980,delay:.008},{duration:.1,volume:.0048,hp:540,delay:.145}])}),
