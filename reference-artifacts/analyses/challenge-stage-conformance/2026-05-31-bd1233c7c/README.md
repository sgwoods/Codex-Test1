...
Generated: 2026-05-31T17:51:25.199Z
Commit: bd1233c7c
...
**Current score:** interesting factor 4/10; challenge conformance 4/10. Movement 3.7/10, graphics 4.4/10, alien novelty 3.9/10, progression 3.2/10, player shot opportunity 5/10.
...
**Aurora current:** first-challenge-peel / first-challenge-peel; lanes bee, bee, bee, bee, but, but, but, but; first-wave types bee, bee, bee, bee, but, but, but, but; visual families classic; strict movement 3.7/10, graphics 4.4/10, alien novelty 3.9/10, shot opportunity 5/10, target-contract fit 6.9/10.
...
**Movement read:** Strict movement score 3.7/10 against challenge-1-arrival-group-1: y-range fit 0.88, path-length fit 0.41, turn fit 1, object-track fit 0.31. Current probes now include runtime object tracks compared against CPU-extracted Galaga target-video object tracks where available. Legacy broad vector best-match was 7.8/10 against challenge-1-arrival-group-1; xRange 0.7668, yRange 0.2467, pathLength 0.2808.
...
**Target contract read:** Target contract fit is 6.9/10 for Challenging Stage 2-3 target-video object tracks: group count 1, path-family order 1, type order 1, family order 1, object-track 0.31 via direct target-video tracks. This is a group/object-track read, not frame-perfect sprite identity recognition.

**Per-group movement rows:**
| Group | Status | Fit | Aurora runtime | Galaga target | Gap |
| --- | --- | ---: | --- | --- | --- |
| 1 | measured | 2.9/10 | left -> center; start 1s; end 16s; path 0.35 | left -> center; start 0s; end 3.25s; path 0.02 |  |
| 2 | measured | 3.2/10 | center -> center; start 4.75s; end 16s; path 0.59 | center -> center; start 4.38s; end 10.5s; path 0.25 |  |
| 3 | measured | 2.5/10 | center -> center; start 7.5s; end 16s; path 0.49 | left -> center; start 7.75s; end 11.88s; path 0.28 |  |
| 4 | measured | 3.7/10 | right -> center; start 10.25s; end 16s; path 0.36 | center -> center; start 11.25s; end 15.88s; path 0.32 |  |
| 5 | measured | 4.2/10 | left -> left; start 14s; end 16s; path 0.11 | center -> center; start 15.25s; end 15.88s; path 0.09 |  |

**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 58 sampled windows; 60% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.19.
...
**Current score:** interesting factor 4.4/10; challenge conformance 4.3/10. Movement 4.6/10, graphics 4.2/10, alien novelty 3.9/10, progression 3.2/10, player shot opportunity 6/10.
...
**Aurora current:** scorpion-cross-sweep / cross-sweep; lanes but, boss, rogue, bee, bee, rogue, boss, but; first-wave types but, boss, rogue, bee, bee, rogue, boss, but; visual families classic; strict movement 4.6/10, graphics 4.2/10, alien novelty 3.9/10, shot opportunity 6/10, target-contract fit 7.2/10.
...
**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 34 sampled windows; 91% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.38.
...
**Current score:** interesting factor 4.4/10; challenge conformance 4.4/10. Movement 4.4/10, graphics 4.6/10, alien novelty 3.9/10, progression 3.2/10, player shot opportunity 6.1/10.
...
**Aurora current:** stingray-crown-hook-hybrid / hook-arc; lanes boss, rogue, but, bee, boss, bee, but, rogue; first-wave types boss, rogue, but, bee, boss, bee, but, rogue; visual families dragonfly; strict movement 4.4/10, graphics 4.6/10, alien novelty 3.9/10, shot opportunity 6.1/10, target-contract fit 7.3/10.
...
**Target contract read:** Target contract fit is 7.3/10 for Challenging Stage 10-11 target-video object tracks: group count 1, path-family order 1, type order 1, family order 1, object-track 0.52 via direct target-video tracks. This is a group/object-track read, not frame-perfect sprite identity recognition.
...
| 3 | measured | 3.2/10 | center -> center; start 4.75s; end 7s; path 0.84 | right -> center; start 4.38s; end 8.38s; path 0.25 |  |
| 4 | measured | 4.8/10 | center -> center; start 8.25s; end 11.75s; path 1.42 | center -> center; start 7.88s; end 12.88s; path 0.22 |  |
| 5 | measured | 5.6/10 | center -> center; start 12.25s; end 14.25s; path 1.05 | center -> center; start 12.13s; end 15.88s; path 0.21 |  |

**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 47 sampled windows; 100% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.32.
...
**Current score:** interesting factor 4.3/10; challenge conformance 4.3/10. Movement 4.3/10, graphics 4.6/10, alien novelty 3.9/10, progression 2.7/10, player shot opportunity 6.3/10.
...
**Aurora current:** pink-serpentine-late / pink-serpentine; lanes boss, rogue, but, bee, bee, but, rogue, boss; first-wave types boss, rogue, but, bee, bee, but, rogue, boss; visual families galboss; strict movement 4.3/10, graphics 4.6/10, alien novelty 3.9/10, shot opportunity 6.3/10, target-contract fit 5.1/10.
...
**Movement read:** Strict movement score 4.3/10 against challenge-4-pink-serpentine-group-1: y-range fit 1, path-length fit 0.79, turn fit 1, object-track fit 0.46. Current probes now include runtime object tracks compared against CPU-extracted Galaga target-video object tracks where available. Legacy broad vector best-match was 8.2/10 against challenge-4-pink-serpentine-group-1; xRange 0.4269, yRange 0.6554, pathLength 0.7407.
...
**Target contract read:** Target contract fit is 5.1/10 for Challenging Stage 14-15 target-video object tracks: group count 1, path-family order 0, type order 0, family order 0, object-track 0.46 via direct target-video tracks. This is a group/object-track read, not frame-perfect sprite identity recognition.

**Per-group movement rows:**
| Group | Status | Fit | Aurora runtime | Galaga target | Gap |
| --- | --- | ---: | --- | --- | --- |
| 1 | measured | 4.6/10 | right -> center; start 0.25s; end 2.5s; path 1.08 | center -> center; start 0s; end 3.25s; path 0.13 |  |
| 2 | measured | 4.2/10 | center -> center; start 0.75s; end 2.25s; path 0.39 | center -> center; start 0.5s; end 3.25s; path 0.25 |  |
| 3 | measured | 5.7/10 | center -> center; start 3s; end 4.5s; path 0.73 | center -> center; start 2.88s; end 6.63s; path 0.15 |  |
| 4 | measured | 4.4/10 | right -> center; start 6.5s; end 7s; path 0.72 | center -> center; start 6.38s; end 9.88s; path 0.13 |  |
| 5 | measured | 3.2/10 | left -> left; start 13.25s; end 15s; path 0.36 | left -> right; start 13.13s; end 15.88s; path 0.01 |  |

**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 23 sampled windows; 100% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.26.
...
**Current score:** interesting factor 4.2/10; challenge conformance 4.2/10. Movement 4.1/10, graphics 4.7/10, alien novelty 3.9/10, progression 3.1/10, player shot opportunity 5.4/10.
...
**Aurora current:** pink-green-cascade / pink-green-cascade; lanes rogue, boss, but, bee, boss, but, bee, rogue; first-wave types rogue, boss, but, bee, boss, but, bee, rogue; visual families galboss; strict movement 4.1/10, graphics 4.7/10, alien novelty 3.9/10, shot opportunity 5.4/10, target-contract fit 3.8/10.
...
**Movement read:** Strict movement score 4.1/10 against challenge-5-pink-green-cascade-group-1: y-range fit 0.81, path-length fit 1, turn fit 1, object-track fit 0.2. Current probes now include runtime object tracks compared against CPU-extracted Galaga target-video object tracks where available. Legacy broad vector best-match was 8.9/10 against challenge-5-pink-green-cascade-group-1; xRange 1.0187, yRange 0.3891, pathLength 1.7404.
...
**Target contract read:** Target contract fit is 3.8/10 for Challenging Stage 18-19 target-video object tracks: group count 1, path-family order 0, type order 0, family order 0, object-track 0.2 via direct target-video tracks. This is a group/object-track read, not frame-perfect sprite identity recognition.

**Per-group movement rows:**
| Group | Status | Fit | Aurora runtime | Galaga target | Gap |
| --- | --- | ---: | --- | --- | --- |
| 1 | measured | 3.7/10 | left -> left; start 0.25s; end 15s; path 1.99 | left -> left; start 0s; end 3.25s; path 0.18 |  |
| 2 | measured | 3.1/10 | left -> left; start 1.5s; end 16s; path 1.87 | right -> right; start 3.13s; end 7.5s; path 0.13 |  |
| 3 | measured | 1.9/10 | left -> left; start 2.5s; end 15.75s; path 1.98 | left -> left; start 7.38s; end 10.88s; path 0.14 |  |
| 4 | measured | 1.3/10 | right -> left; start 3.5s; end 16s; path 2.6 | right -> center; start 10.63s; end 13s; path 0.2 |  |
| 5 | measured | 2.5/10 | right -> right; start 4.75s; end 16s; path 1.49 | left -> center; start 12.88s; end 15.88s; path 0.16 |  |

**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 64 sampled windows; 83% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.19.
...
- Sprite-motion correspondence is 6.18/10: runtime flapping/cadence is visible, but target frame timing is still frame-labeled-segmented-reference-windows and weakest motion row is bee-zako-pulse-pair.
- Alien/stage novelty is only 3.9/10: the current type mix does not yet prove Galaga-like new alien introductions, memorable challenge-specific roles, or distinct bonus-stage learning patterns.
- Target-contract fit is only 3.8/10: the runtime group order, path families, type/family mix, or group count still misses the first-pass media-backed challenge contract.
...
**Current score:** interesting factor 4.3/10; challenge conformance 4.3/10. Movement 4.4/10, graphics 4.6/10, alien novelty 3.9/10, progression 2.7/10, player shot opportunity 5.8/10.

**Legacy broad coverage score:** 6.9/10. This is retained as diagnostic evidence only; it no longer counts as the player-facing conformance score.

**Original target:** Challenging Stage 22-23 should emphasize green ladder rhythm and split exits.

**Aurora current:** green-ladder-split / green-ladder-split; lanes bee, but, rogue, boss, boss, rogue, but, bee; first-wave types bee, but, rogue, boss, boss, rogue, but, bee; visual families dragonfly; strict movement 4.4/10, graphics 4.6/10, alien novelty 3.9/10, shot opportunity 5.8/10, target-contract fit 4.5/10.

**Graphics read:** Strict graphics score 4.6/10. Current visible family/type labels are present, Direct runtime-vs-Galaga target-crop comparator reads 5.97/10 overall and 3.86/10 for challenge specialty sprites; weakest challenge crop is challenge-mosquito at 3.68/10. Runtime sprite-motion hook observed 2 visual family/families, 1 path pose family/families, 6/6 animation phase buckets, both flap state(s), and 30 object-tracked silhouette track(s). Aurora runtime motion corresponds to 3 frame-labeled segmented-reference target row(s), average 6.2/10; phase-order average is 4.8/10. Weakest row bee-zako-pulse-pair at 5.42/10. Graphics remain capped at 5.1/10 until object tracks are compared as full temporal Galaga target-crop sequences, rotations, dive poses, and capture/rescue transitions.

**Movement read:** Strict movement score 4.4/10 against challenge-6-green-ladder-split-group-3: y-range fit 0.96, path-length fit 1, turn fit 1, object-track fit 0.35. Current probes now include runtime object tracks compared against CPU-extracted Galaga target-video object tracks where available. Legacy broad vector best-match was 9.1/10 against challenge-6-green-ladder-split-group-3; xRange 1.0732, yRange 0.688, pathLength 1.973.
...
**Target contract read:** Target contract fit is 4.5/10 for Challenging Stage 22-23 target-video object tracks: group count 1, path-family order 0, type order 0, family order 0, object-track 0.35 via direct target-video tracks. This is a group/object-track read, not frame-perfect sprite identity recognition.

**Per-group movement rows:**
| Group | Status | Fit | Aurora runtime | Galaga target | Gap |
| --- | --- | ---: | --- | --- | --- |
| 1 | measured | 3.3/10 | right -> right; start 1.5s; end 14s; path 1.53 | right -> right; start 0s; end 2.63s; path 0.17 |  |
| 2 | measured | 4/10 | left -> left; start 1.5s; end 16s; path 1.96 | left -> center; start 2.63s; end 6.75s; path 0.14 |  |
| 3 | measured | 3.7/10 | right -> right; start 3s; end 16s; path 1.91 | center -> center; start 5.75s; end 10s; path 0.12 |  |
| 4 | measured | 3.5/10 | left -> left; start 4s; end 16s; path 1.2 | center -> left; start 9.63s; end 14.13s; path 0.18 |  |
| 5 | measured | 3.3/10 | right -> right; start 5.75s; end 16s; path 0.9 | center -> right; start 14s; end 15.88s; path 0.17 |  |

**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 62 sampled windows; 89% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.17.
...
**Current score:** interesting factor 4.3/10; challenge conformance 4.3/10. Movement 4.6/10, graphics 4.7/10, alien novelty 3.9/10, progression 2.7/10, player shot opportunity 5.1/10.

**Legacy broad coverage score:** 7/10. This is retained as diagnostic evidence only; it no longer counts as the player-facing conformance score.

**Original target:** Challenging Stage 26-27 should introduce a yellow diagonal fan with a memorable scoring lane.

**Aurora current:** yellow-diagonal-fan / yellow-diagonal-fan; lanes boss, bee, but, rogue, rogue, but, bee, boss; first-wave types boss, bee, but, rogue, rogue, but, bee, boss; visual families crown; strict movement 4.6/10, graphics 4.7/10, alien novelty 3.9/10, shot opportunity 5.1/10, target-contract fit 4.2/10.
...
**Movement read:** Strict movement score 4.6/10 against challenge-7-yellow-diagonal-fan-group-5: y-range fit 1, path-length fit 1, turn fit 1, object-track fit 0.29. Current probes now include runtime object tracks compared against CPU-extracted Galaga target-video object tracks where available. Legacy broad vector best-match was 9.6/10 against challenge-7-yellow-diagonal-fan-group-5; xRange 1.0706, yRange 0.5976, pathLength 2.1754.
...
**Target contract read:** Target contract fit is 4.2/10 for Challenging Stage 26-27 target-video object tracks: group count 1, path-family order 0, type order 0, family order 0, object-track 0.29 via direct target-video tracks. This is a group/object-track read, not frame-perfect sprite identity recognition.

**Per-group movement rows:**
| Group | Status | Fit | Aurora runtime | Galaga target | Gap |
| --- | --- | ---: | --- | --- | --- |
| 1 | measured | 3.4/10 | right -> right; start 0.25s; end 4s; path 0.2 | right -> right; start 0s; end 2s; path 0.1 |  |
| 2 | measured | 3.3/10 | left -> left; start 1s; end 5s; path 0.21 | right -> left; start 1.25s; end 5.5s; path 0.19 |  |
| 3 | measured | 3.1/10 | left -> right; start 2.5s; end 10.75s; path 2.14 | center -> left; start 4.75s; end 7.63s; path 0.14 |  |
| 4 | measured | 3.3/10 | left -> left; start 3.25s; end 6.75s; path 0.19 | center -> left; start 9.13s; end 11.25s; path 0.14 |  |
| 5 | measured | 2.8/10 | left -> right; start 8.25s; end 11.5s; path 0.72 | center -> right; start 10.38s; end 12s; path 0.09 |  |

**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 49 sampled windows; 71% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.17.
...
**Current score:** interesting factor 4.4/10; challenge conformance 4.4/10. Movement 4.6/10, graphics 4.7/10, alien novelty 3.9/10, progression 3.1/10, player shot opportunity 5.7/10.
...
**Aurora current:** blue-purple-finale / blue-purple-finale; lanes rogue, boss, bee, but, but, bee, boss, rogue; first-wave types rogue, boss, bee, but, but, bee, boss, rogue; visual families stingray; strict movement 4.6/10, graphics 4.7/10, alien novelty 3.9/10, shot opportunity 5.7/10, target-contract fit 4.2/10.

**Graphics read:** Strict graphics score 4.7/10. Current visible family/type labels are present, Direct runtime-vs-Galaga target-crop comparator reads 5.97/10 overall and 3.86/10 for challenge specialty sprites; weakest challenge crop is challenge-mosquito at 3.68/10. Runtime sprite-motion hook observed 3 visual family/families, 3 path pose family/families, 6/6 animation phase buckets, both flap state(s), and 22 object-tracked silhouette track(s). Aurora runtime motion corresponds to 3 frame-labeled segmented-reference target row(s), average 6.2/10; phase-order average is 4.8/10. Weakest row bee-zako-pulse-pair at 5.42/10. Graphics remain capped at 5.1/10 until object tracks are compared as full temporal Galaga target-crop sequences, rotations, dive poses, and capture/rescue transitions.

**Movement read:** Strict movement score 4.6/10 against challenge-8-blue-purple-finale-group-3: y-range fit 1, path-length fit 1, turn fit 1, object-track fit 0.28. Current probes now include runtime object tracks compared against CPU-extracted Galaga target-video object tracks where available. Legacy broad vector best-match was 9.6/10 against challenge-8-blue-purple-finale-group-3; xRange 0.9949, yRange 0.6363, pathLength 2.9186.
...
| Group | Status | Fit | Aurora runtime | Galaga target | Gap |
| --- | --- | ---: | --- | --- | --- |
| 1 | measured | 2.6/10 | left -> left; start 0.25s; end 14s; path 2.98 | center -> center; start 1s; end 3s; path 0.16 |  |
| 2 | measured | 4.1/10 | left -> left; start 2.5s; end 14.5s; path 1.52 | right -> center; start 2.38s; end 5.25s; path 0.16 |  |
| 3 | measured | 2.6/10 | left -> left; start 2s; end 16s; path 3.25 | left -> center; start 5.38s; end 10.13s; path 0.21 |  |
| 4 | measured | 3.4/10 | right -> left; start 3.25s; end 12s; path 1.99 | center -> center; start 10.75s; end 15.38s; path 0.15 |  |
| 5 | measured | 2.9/10 | right -> center; start 5s; end 16s; path 1.88 | center -> center; start 13.5s; end 15.88s; path 0.11 |  |

**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 63 sampled windows; 84% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.15.
...
- Raise player shot opportunity from 5.7/10 by creating lane-readable scoring windows for each challenge rather than incidental central-lane hits.
