...
- Read: Close-shot responsiveness passed, and movement-fire post-shot travel was 51.19, with shot delay 4ms.
...
- Read: Audio score blends cue identity, active reference similarity, reference-window precision, overlap timing, and cue alignment. 0/21 reference windows still need tighter segmentation; 21 candidate subwindows were found; active Aurora-vs-reference duration delta averages 0.258s.
...
- Audio identity and cue alignment: 7.4/10
