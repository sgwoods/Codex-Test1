...
Generated: `2026-05-17T16:52:30.042Z`
...
| Challenge-stage set-piece conformance | 2.8/10 | >=3.5 first honest gate; >=6.0 next major gate; >=9.0 mature | Strict movement/graphics/alien-novelty gate; safety does not inflate this score |
...
| Challenge variation | 2.8/10 measured | >=9.2 with dedicated scorer | Dedicated stage-by-stage challenge conformance gate |
...
| 2 | Aurora audio cue comparison and event-gap reports | audio cue scoring | waveform/spectral/alignment/semantic reports | 21 compared cues; semantic 9.78/10; 0 attention rows | semantic-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-event-gap/2026-05-17-e56c602d-dirty-165222/report.json | Tune the highest segment-level gap next: challengePerfect onset. Rerun audio comparison and event-gap analysis after the change. |
...
- Quality report: `reference-artifacts/analyses/quality-conformance/2026-05-17-e56c602d/report.json`
...
- Level-arc report: `reference-artifacts/analyses/level-arc-conformance/2026-05-17-e56c602d/report.json`
