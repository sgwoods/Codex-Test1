...
Generated: `2026-05-08T13:34:13.474Z`
...
| Metric points scanned | 512 | History depth behind score trends |
| Score deltas found | 70 | Past-goal movement available for review |
| Measured runs | 86 | Tracked harness/model/local compute work |
| Tracked wall time | 34 min | Human clock-time planning input |
...
| --- | --- | --- | --- |
| cpu | 86 | 34 min | 53 min |
| browser | 47 | 30.7 min | 49.2 min |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Audio identity, event feedback, and cue alignment | 7.4/10 | 7.5-8.0 | +0.1 | High; 3-6 hrs local/model-assisted analysis | cpu, model-api, openai-api | Run a longer audio segmentation/model-assisted analysis cycle. |
...
![score-trends](reference-artifacts/analyses/conformance-economics/2026-05-08-dfb47de/score-trends.svg)

![largest-score-deltas](reference-artifacts/analyses/conformance-economics/2026-05-08-dfb47de/largest-score-deltas.svg)

![compute-minutes-by-resource](reference-artifacts/analyses/conformance-economics/2026-05-08-dfb47de/compute-minutes-by-resource.svg)
...
- Level-arc report: `reference-artifacts/analyses/level-arc-conformance/2026-05-08-dfb47de/report.json`
- Economics report: `reference-artifacts/analyses/conformance-economics/2026-05-08-dfb47de/report.json`
