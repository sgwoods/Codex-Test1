...
Generated: `2026-06-12T01:18:42.299Z`
Latest artifact: `reference-artifacts/analyses/conformance-economics/2026-06-12-5d9fe6d5/report.json`
...
| Measured runs | 984 | Commands or manual entries logged in the economics ledger. |
| Local CPU tracked wall | 585.6 min | Main measured engine for harness execution, report generation, waveform/spectral work, and scoring. |
| Browser-backed local wall | 434.2 min | Subset of local work that exercised Chromium/gameplay runtime. |
| GPU-equivalent tracked wall | 630.8 min | Declared Codex/model/API/GPU usage. This is currently small and under-instrumented. |
| GPU-equivalent share | 64.3% | Approximate declared cloud/model share of tracked wall time. |
| Artifact growth | 1512.8 MB | Evidence volume and review/storage-cost proxy. |
...
| --- | --- | --- | --- | --- |
| gpu-equivalent | 18 | 630.8 min | 1.2 min | 64.3% |
| cpu | 938 | 585.6 min | 938.2 min | 59.7% |
| browser | 365 | 434.2 min | 668.8 min | 44.3% |
| codex | 13 | 365.7 min | 1.2 min | 37.3% |
| openai-gpu-equivalent | 1 | 75 min | 0 min | 7.6% |
| model-api | 2 | 25 min | 0 min | 2.5% |
| local-browser | 4 | 17 min | 30.8 min | 1.7% |
...
| sprite-conformance | 17 | 75.4 min | 0.6 min |
...
| level-arc | 97 | 8.811 | 3.4 | 2.59 | tracked-spend-and-score-movement |
| audio | 317 | 254.312 | 5.8 | 43.85 | tracked-spend-and-score-movement |
...
![Conformance score trends](reference-artifacts/analyses/conformance-economics/2026-06-12-5d9fe6d5/score-trends.svg)
...
![Local CPU use by purpose](reference-artifacts/analyses/conformance-economics/2026-06-12-5d9fe6d5/cpu-use-by-purpose.svg)
