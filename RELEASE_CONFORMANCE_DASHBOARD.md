...
Generated: `2026-05-09T13:09:38.794Z`
...
| Alien entry and challenge-stage novelty | 4.5/10 | >=7.5 first gate; >=9.0 mature | New high-priority long-cycle gameplay-authenticity gate |
| Boss entry and formation grammar | 8.4/10 | >=8.0 first gate; >=9.0 mature | New measured gate for stage choreography |
| Alien entry / formations | 5.2/10 measured | >=9.2 with path/rack scorer | Now backed by dedicated alien-entry/challenge variation scorer |
| Challenge variation | 4/10 measured | >=9.2 with dedicated scorer | New explicit gate |
...
| 6 | Stage 4 pressure exact replay / pressure curve precision | 7.5/10 | medium | narrow pressure/loss replay windows; exact replay coverage still limited | medium; cpu, browser | 28 runs; 12.8 min wall; 18.5 min CPU | 8.2-8.6 | Measured level-arc weak submetric | Pressure should be learnable and reproducible, not merely present in one run. | Medium-high; prior runs ~12.8 min wall / 18.5 min CPU | Run focused source-window replay matching after the Stage 12 loop validates candidate mechanics. | reference-artifacts/analyses/level-arc-conformance/2026-05-09-29a80ab4/report.json |
| 7 | Alien entry to levels: formation, timing, and methods | 5.2/10 | medium | composite proxy from opening timing, geometry, and movement grammar | estimated; cpu, browser | 65 runs; 11.2 min wall; 16.1 min CPU | 9.0-9.4 with path and rack-slot scorer | Dedicated alien-entry submetric | Entry formations and rack timing are a first-order arcade authenticity signal before combat even starts. | Medium; 1-3 hrs plus visual review | Raise regular-stage minimum signature distance and add stage-specific alien entry scripts before retuning broad level arc. | reference-artifacts/analyses/alien-entry-challenge-variation/2026-05-09-6cd0cb17/report.json |
| 8 | Challenge-stage variation and new alien/formations introduction | 4/10 | medium | composite proxy from challenge timing, challenge identity, and non-repetition | estimated; cpu, browser | 65 runs; 11.2 min wall; 16.1 min CPU | 9.0-9.4 with dedicated scorer | Dedicated challenge trajectory/novelty submetric | Challenge stages should teach new motion/reward patterns, not only pause normal combat. | Medium-high; 2-4 hrs | Expand challenge evidence to at least four windows, then add distinct sweep/arc/lane/boss-led trajectory families. | reference-artifacts/analyses/alien-entry-challenge-variation/2026-05-09-6cd0cb17/report.json |
...
| 2 | Alien entry and challenge-stage novelty | 4.5/10 | 7.5 first gate; 9.0+ mature | +3 | High; long-cycle CPU/browser extraction plus reference contact-sheet and path-labeling pass | cpu, browser | 126 runs; 22.2 min wall; 36.5 min CPU | Estimated cost/value; dedicated investment candidate not yet generated. | Attack Challenging-stage alien novelty and introduction: 1/4 challenge evidence windows; challenge entity signatures bee\|boss\|but. |
| 3 | Level arc and encounter shape | 8.4/10 | 8.8-9.0 | +0.4 | Medium-high; 2-5 hrs | cpu, browser | 126 runs; 22.2 min wall; 36.5 min CPU | Expected lift 0.24/10 on metric, 0.02/10 overall; investment score 1.79. | Use the top-ranked opportunity window to add or widen deterministic evidence before changing gameplay tuning. |
...
| 6 | Stage 4 pressure exact replay / pressure curve precision | 7.5/10 | 8.2-8.6 | +0.7 | Medium-high; prior runs ~12.8 min wall / 18.5 min CPU | cpu, browser | 28 runs; 12.8 min wall; 18.5 min CPU | Expected lift 0.35/10 on metric, 0.029/10 overall; investment score 1.61. | Run focused source-window replay matching after the Stage 12 loop validates candidate mechanics. |
| 7 | Alien entry to levels: formation, timing, and methods | 5.2/10 | 9.0-9.4 with path and rack-slot scorer | +3.8 | Medium; 1-3 hrs plus visual review | cpu, browser | 65 runs; 11.2 min wall; 16.1 min CPU | Estimated cost/value; dedicated investment candidate not yet generated. | Raise regular-stage minimum signature distance and add stage-specific alien entry scripts before retuning broad level arc. |
| 8 | Challenge-stage variation and new alien/formations introduction | 4/10 | 9.0-9.4 with dedicated scorer | +5 | Medium-high; 2-4 hrs | cpu, browser | 65 runs; 11.2 min wall; 16.1 min CPU | Estimated cost/value; dedicated investment candidate not yet generated. | Expand challenge evidence to at least four windows, then add distinct sweep/arc/lane/boss-led trajectory families. |
