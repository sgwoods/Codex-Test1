...
Generated: `2026-05-10T18:53:26.647Z`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Audio identity, event feedback, and cue alignment | 7/10 | medium-high | 21 cue/event comparisons with waveform, spectral, overlap, alignment, and semantic event-mapping features | high; cpu, model-api, openai-api | 209 runs; 159.3 min wall; 285.9 min CPU | 7.5-8.0 | Measured release category; weakest axis | Largest current score gap and high user-experience impact: shots, explosions, boss damage, challenge results, capture/rescue feedback. | High; 3-6 hrs local/model-assisted analysis | StagePulse candidate cadence-refined-triangle-body-pocket is a measured near miss: full-theme precheck shows improvement, but focused masking/stability gates reject promotion. Next build a stronger low-brightness, low-variance pressure-bed generator, then rerun focused repeats and promotion precheck. | reference-artifacts/analyses/quality-conformance/2026-05-10-705e445c/report.json; reference-artifacts/analyses/aurora-audio-cue-contracts/2026-05-10-705e445c-dirty-185318/report.json |
...
| Metric points scanned | 1062 | History depth behind score trends |
| Score deltas found | 119 | Past-goal movement available for review |
| Measured runs | 391 | Tracked harness/model/local compute work |
| Tracked wall time | 254.7 min | Human clock-time planning input |
| Tracked CPU time | 396.4 min | Local compute-cost planning input |
| Tracked artifact growth | 646 MB | Evidence volume and storage/review-cost proxy |
...
| --- | --- | --- | --- | --- |
| Audio conformance and cue feedback | 264 | 203.2 min | 88.4% | Moves the moment-to-moment arcade feel: impact clarity, ambience identity, reward/loss feedback, and player understanding. |
...
| --- | --- | --- | --- |
| cpu | 389 | 229.7 min | 396.4 min |
| browser | 137 | 124.5 min | 215.9 min |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Audio identity, event feedback, and cue alignment | 7/10 | 7.5-8.0 | +0.5 | High; 3-6 hrs local/model-assisted analysis | cpu, model-api, openai-api | 209 runs; 159.3 min wall; 285.9 min CPU | Expected lift 0.7/10 on metric, 0.058/10 overall; investment score 3.04. | StagePulse candidate cadence-refined-triangle-body-pocket is a measured near miss: full-theme precheck shows improvement, but focused masking/stability gates reject promotion. Next build a stronger low-brightness, low-variance pressure-bed generator, then rerun focused repeats and promotion precheck. |
...
| 2 | Aurora audio cue comparison and event-gap reports | audio cue scoring | waveform/spectral/alignment/semantic reports | 21 compared cues; semantic 9.78/10; 0 attention rows | semantic-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-event-gap/2026-05-10-705e445c-dirty-185032/report.json | Tune the highest segment-level gap next: stagePulse onset. Rerun audio comparison and event-gap analysis after the change. |
...
| 4 | Aurora audio cue contracts | audio semantic contract / theme latitude / promotion safety | cue contract readiness, theme lanes, runtime-trial blockers | 8 contracts; readiness 9.1/10; blocked 3 | contract-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-cue-contracts/2026-05-10-705e445c-dirty-185318/report.json | StagePulse candidate cadence-refined-triangle-body-pocket is a measured near miss: full-theme precheck shows improvement, but focused masking/stability gates reject promotion. Next build a stronger low-brightness, low-variance pressure-bed generator, then rerun focused repeats and promotion precheck. |
...
![score-trends](reference-artifacts/analyses/conformance-economics/2026-05-10-705e445c/score-trends.svg)
...
![cpu-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-10-705e445c/cpu-use-by-purpose.svg)
...
- Quality report: `reference-artifacts/analyses/quality-conformance/2026-05-10-705e445c/report.json`
...
- Level-arc report: `reference-artifacts/analyses/level-arc-conformance/2026-05-10-705e445c/report.json`
- Economics report: `reference-artifacts/analyses/conformance-economics/2026-05-10-705e445c/report.json`
