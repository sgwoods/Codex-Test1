...
Generated: `2026-05-11T18:04:50.274Z`
Latest artifact: `reference-artifacts/analyses/conformance-economics/2026-05-11-23c856ad/report.json`
...
| Measured runs | 472 | Commands or manual entries logged in the economics ledger. |
| Local CPU tracked wall | 294.5 min | Main measured engine for harness execution, report generation, waveform/spectral work, and scoring. |
| Browser-backed local wall | 180.9 min | Subset of local work that exercised Chromium/gameplay runtime. |
| GPU-equivalent tracked wall | 25.8 min | Declared Codex/model/API/GPU usage. This is currently small and under-instrumented. |
| GPU-equivalent share | 8.1% | Approximate declared cloud/model share of tracked wall time. |
| Artifact growth | 795.6 MB | Evidence volume and review/storage-cost proxy. |
...
| --- | --- | --- | --- | --- |
| cpu | 470 | 294.5 min | 506.5 min | 92.2% |
| browser | 167 | 180.9 min | 314.9 min | 56.6% |
| gpu-equivalent | 8 | 25.8 min | 1.2 min | 8.1% |
| codex | 7 | 25.7 min | 1.2 min | 8.1% |
| model-api | 2 | 25 min | 0 min | 7.8% |
...
| audio-event-gap | 34 | 16.2 min | 29.4 min |
...
| overall-quality | 2 | 2.178 | 2.6 | 0.84 | tracked-spend-and-score-movement |
...
| audio | 245 | 173.572 | 5.5 | 31.56 | tracked-spend-and-score-movement |
...
![Conformance score trends](reference-artifacts/analyses/conformance-economics/2026-05-11-23c856ad/score-trends.svg)
...
![Local CPU use by purpose](reference-artifacts/analyses/conformance-economics/2026-05-11-23c856ad/cpu-use-by-purpose.svg)
