...
| --- | --- | --- | --- | --- | --- |
| Aurora Galactica current dev line | 9.2/10 | strongest Player movement conformance 10/10; weakest Audio identity and cue alignment 7.3/10; alien entry/challenge variation 7.8/10; audio contract readiness 9.09/10 | release-quality conformance score plus audio cue-contract read | Audio identity and cue alignment (7.3/10) | reference-artifacts/analyses/quality-conformance/2026-05-11-44ac29aa/report.json; reference-artifacts/analyses/aurora-audio-cue-contracts/latest.json |
...
| --- | --- | --- | --- | --- | --- |
| Current dev baseline | 9.2/10 | audio 7.3; movement 10; boss/formation 9.2; alien/challenge 7.8; stage opening 8.5; challenge timing 9.2; shell integrity 9.2 | 7.7/10 reference; 6.9/10 playtest | maturity 7; gate coverage 9.5; public readiness 3.9; audio feel 6.4 | Baseline for the next beta-candidate discussion, now weighted by local playtest feel. |
...
| Audio identity / acoustic fit | 7.3/10 | 7.6/10 in `1.4` | 6.4/10 playtest; 6.4/10 reference category | contract-aware composite cue cleanup in `1.4`; 7.0/10 playtest in `1.4` | Audio is the weakest shared conformance area today, now led by `playerHit` body segmentation. |
...
| Audio identity and cue alignment | 7.3/10 | audio-cue-alignment correspondence, aurora-audio-theme-comparison, galaga-audio-overlap, aurora-audio-event-gap semantic read, audio-cue-contracts, audio-promotion-precheck, audio-runtime-trials | Audio score blends cue identity, active reference similarity, reference-window precision, overlap timing, cue alignment, semantic event mapping, and acoustic event-gap severity. Semantic event score is 9.78/10, acoustic event score is 5.45/10, and highest segment risk is now playerHit body. Cue-contract readiness is 9.09/10. The latest playerHit runtime trial was rejected and rolled back because focused/precheck wins did not survive full-theme scoring; next step is a contract-aware composite cue strategy for ship-loss onset/body/tail. |
