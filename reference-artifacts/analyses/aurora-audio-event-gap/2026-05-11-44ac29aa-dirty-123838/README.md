...
Generated: `2026-05-11T12:38:38.490Z`
...
- Average worst segment risk delta: 0.71/10
- Highest-risk cue changed: yes (stagePulse -> playerHit)
- Strongest improvement: gameStart (-1.73)
- Strongest regression: playerHit (+5.32)

| Cue | Gap delta | Segment delta | Duration delta | Centroid delta |
| --- | ---: | ---: | ---: | ---: |
| playerHit | 5.81 | 5.32 | 0.036s | 740.4 Hz |
| enemyBoom | 1.78 | 3.82 | 0.071s | 523 Hz |
| bossHit | 1.92 | 3.4 | 0.11s | 447.1 Hz |
| captureRetreat | 1.57 | 2.02 | 0.011s | 619.1 Hz |
| gameStart | -0.04 | -1.73 | 0.12s | -51.3 Hz |
| enemyHit | 0.67 | 1.67 | 0.041s | 490.4 Hz |
| highScoreOther | -0.4 | -1.65 | -0.088s | -84.3 Hz |
| captureBeam | -0.19 | 1.23 | -0.13s | -73.6 Hz |
| capturedFighterDestroyed | 0.39 | 1.22 | -0.008s | 335.9 Hz |
| challengeResults | 0.22 | -0.89 | -0.028s | -36.3 Hz |
