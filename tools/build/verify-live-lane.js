  ...
  if(lane === 'dev'){
    return {
      ...
      assetUrls: [
        ...
        'https://sgwoods.github.io/Aurora-Galactica/dev/release-notes.html',
  ...
  if(lane === 'beta'){
    return {
      ...
      assetUrls: [
        ...
        'https://sgwoods.github.io/Aurora-Galactica/beta/release-notes.html',
  ...
  if(lane === 'production'){
    return {
      ...
      assetUrls: [
        ...
        'https://sgwoods.github.io/Aurora-Galactica/release-notes.html',
