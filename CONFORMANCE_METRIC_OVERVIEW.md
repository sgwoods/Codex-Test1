...
| Guardians 0.1 preview | `7.1/10` reference conformance | Dev-preview | Score/progression plus visible attract/score surfaces are now harnessed, but timing, pacing, audio, and sprite fidelity still need reference-derived work. |
...
| --- | ---: | --- | ---: | --- | --- |
| Current dev baseline | `8.8/10` | audio 6.1; movement 8.1; stage opening 8.5; challenge timing 8.4; shell integrity 9.2 | `7.1/10` | maturity 5.8; gate coverage 9.1; public readiness 3.7; audio fit 4.5 | Baseline for the next beta-candidate discussion. |
...
xychart-beta
  ...
  line "Galaxy Guardians" [7.1, 7.2, 7.8, 8.2, 8.5, 9.0]
```
...
| Evidence and replay durability | scorecard artifacts exist; video publishing is not yet a full product surface | replay/video evidence >= 8.8 in `1.5` | evidence durability `8.8/10` | event-log durability >= 9.0 in `1.5` | Shared videos and source-controlled artifacts should become normal release evidence. |
...
| Metric | Score | Read |
| --- | ---: | --- |
| Reference conformance | `7.1/10` | Useful development-preview baseline, with score/progression and attract/score surfaces now harnessed while timing/pace/visual feel still score conservatively. |
...
| Implementation gate coverage | `9.1/10` | Most 0.1 runtime/visual/audio/platform gates are durable and rerunnable. |
| Public release readiness | `3.7/10` | The preview remains intentionally dev-only and should not be treated as public playable yet. |
...
| Evidence durability | `8.8/10` | Good | Reference profile, event log, identity artifacts, score/progression and attract/score-surface artifacts, and gates are source-controlled and rerunnable. |
