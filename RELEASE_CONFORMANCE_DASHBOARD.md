...
Generated: `2026-05-16T15:57:22.876Z`
...
| Challenge variation | 5.7/10 measured | >=9.2 with dedicated scorer | Dedicated stage-by-stage challenge conformance gate |
...
| 4 | Boss entry and formation grammar | 9.4/10 | medium | first-class boss/formation scorer using stage-window event grammar, boss timing, escort composition, challenge identity, and explicit path/slot measurement debt | high; cpu, browser | 160 runs; 24 min wall; 39.7 min CPU | 8.0-8.5 first gate; 9.0+ with path/slot extraction | Measured release category; new first-class axis | Boss entries, escorts, formation settling, and challenge set pieces are core Galaga choreography and directly affect whether stages feel authored. | Medium-high; 2-5 hrs, then recurring low-cost guardrail | Advance Path shape and set-formation precision: 680 tracks classified into path families; expected family coverage 1; accepted Galaga labels 6 regular / 4 challenge; trajectory-vector/rack score 5.5/10 (reference-trajectory-vector-comparison-active-no-cap-lift); cap 8.2/10 (media-backed-reference-label-cap). | reference-artifacts/analyses/quality-conformance/2026-05-16-08c327dd/report.json |
...
| Metric points scanned | 1561 | History depth behind score trends |
| Score deltas found | 147 | Past-goal movement available for review |
| Measured runs | 660 | Tracked harness/model/local compute work |
| Tracked wall time | 428.5 min | Human clock-time planning input |
| Tracked CPU time | 714.4 min | Local compute-cost planning input |
| Tracked artifact growth | 1050.1 MB | Evidence volume and storage/review-cost proxy |
...
| --- | --- | --- | --- | --- |
| Audio conformance and cue feedback | 415 | 363.9 min | 90.2% | Moves the moment-to-moment arcade feel: impact clarity, ambience identity, reward/loss feedback, and player understanding. |
| Gameplay behavior and level complexity | 230 | 31.4 min | 7.8% | Moves player-facing pressure, stage shape, alien entry novelty, challenge-stage learning value, and long-play texture. |
...
| --- | --- | --- | --- |
| Gameplay complexity and stage arc | +47.6 | 73.7% | Player-perceived variety, pressure, alien choreography, challenge-stage novelty, and long-play learning curve. |
...
| Audio feedback and event clarity | +6.1 | 9.4% | Player-perceived clarity from sounds that explain danger, reward, loss, and arcade identity. |
...
| --- | --- | --- | --- |
| cpu | 641 | 378.1 min | 668 min |
| browser | 230 | 265.4 min | 470.2 min |
...
| 8 | Challenge-stage variation and new alien/formations introduction | 5.7/10 | 9.0-9.4 with dedicated scorer | +3.3 | Medium-high; 2-4 hrs | cpu, browser | 109 runs; 24.1 min wall; 32.1 min CPU | Estimated cost/value; dedicated investment candidate not yet generated. | Close dedicated challenge-stage gaps: challenge stages are still not authored enough as memorable Galaga-like set pieces: 2 sampled stage(s) still best-match the same Galaga challenge-2 reference, stage 3 now lands on the first-challenge bee-line reference but needs stronger trajectory precision, active sprite-motion novelty is unscored, and stage 19 lacks reference grounding. |
...
| 2 | Aurora audio cue comparison and event-gap reports | audio cue scoring | waveform/spectral/alignment/semantic reports | 21 compared cues; semantic 9.78/10; 0 attention rows | semantic-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-event-gap/2026-05-16-08c327dd-dirty-155303/report.json | Tune the highest segment-level gap next: challengePerfect onset. Rerun audio comparison and event-gap analysis after the change. |
...
![score-trends](reference-artifacts/analyses/conformance-economics/2026-05-16-08c327dd/score-trends.svg)

![largest-score-deltas](reference-artifacts/analyses/conformance-economics/2026-05-16-08c327dd/largest-score-deltas.svg)

![compute-minutes-by-resource](reference-artifacts/analyses/conformance-economics/2026-05-16-08c327dd/compute-minutes-by-resource.svg)

![cost-per-positive-score-point](reference-artifacts/analyses/conformance-economics/2026-05-16-08c327dd/cost-per-positive-score-point.svg)

![gpu-equivalent-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-16-08c327dd/gpu-equivalent-use-by-purpose.svg)

![cpu-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-16-08c327dd/cpu-use-by-purpose.svg)

![gameplay-improvement-by-project-part](reference-artifacts/analyses/conformance-economics/2026-05-16-08c327dd/gameplay-improvement-by-project-part.svg)
...
- Investment priority report: `reference-artifacts/analyses/conformance-investment-priorities/2026-05-16-08c327dd/report.json`
- Level-arc report: `reference-artifacts/analyses/level-arc-conformance/2026-05-16-08c327dd/report.json`
- Economics report: `reference-artifacts/analyses/conformance-economics/2026-05-16-08c327dd/report.json`
