...
Generated: `2026-05-11T18:01:34.893Z`
...
- Source metrics: `reference-artifacts/analyses/aurora-audio-promotion-precheck/2026-05-11-23c856ad-dirty-180134-playerHit/candidate-theme-metrics.json`
- Compared cues: 21
...
- Strongest improvement: playerHit (0.03)
- Strongest regression: playerHit (+0.03)

| Cue | Gap delta | Segment delta | Duration delta | Centroid delta |
| --- | ---: | ---: | ---: | ---: |
| playerHit | -2.6 | 0.03 | -0.57s | -131.4 Hz |
...
| 3 | playerHit | Ship Loss (promotion precheck) | 3.59 | medium-high | curated-reference-segmentation | 0.002s | 631.8 Hz | body | 7.4 | Tune the body segment first: body timing/duration differs enough to tune event pacing before timbre. |
