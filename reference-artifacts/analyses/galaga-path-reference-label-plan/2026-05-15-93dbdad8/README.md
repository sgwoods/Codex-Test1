...
- Score: 6.9/10
- Status: source-anchor-readme-ready-frame-media-needed
- Current alien-entry/challenge score: 8/10
...
| reference-artifacts/analyses/challenge-stage-reference/README.md | challenge-stage-arrival-and-results-reference | yes | 1 | 0 | no |
| reference-artifacts/analyses/first-challenge-stage/README.md | first-challenge-motion-and-scoreability-reference | yes | 1 | 0 | no |
| reference-artifacts/analyses/release-reference-pack/README.md | release-window-capture-transition-and-pressure-reference | yes | 1 | 0 | no |
