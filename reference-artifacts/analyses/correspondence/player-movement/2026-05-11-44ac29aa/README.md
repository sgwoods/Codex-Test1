...
- Tap correction abs delta: 12.42
- Hold travel delta: 98.01
- Hold settle after release (ms): 207
- Reversal cross ms: 216
- Shot delay while moving (ms): 1
- Post-shot travel: 52.2
- Max frame step: 12.12

## Current metric gaps

- holdDelta: value 98.01, target {"min":67,"max":97}, gap 1.01
