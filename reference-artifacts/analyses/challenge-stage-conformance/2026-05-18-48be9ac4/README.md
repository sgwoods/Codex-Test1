...
Generated: 2026-05-18T18:54:45.258Z
Commit: 48be9ac4
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |
| 3 | 1 | 3.9/10 | 3.3/10 | 4.2/10 | 3.9/10 | 5.7/10 | 3.8/10 | challenge-1-late-wave-group-4 (8.7/10 legacy) | pass | Movement conformance is only 3.3/10 under the strict scorer: current paths are too short/shallow and do not yet show the sweeping, turning, learnable Galaga challenge-stage trajectories.<br>Alien/stage novelty is only 3.9/10: the current type mix does not yet prove Galaga-like new alien introductions, memorable challenge-specific roles, or distinct bonus-stage learning patterns. |
| 7 | 2 | 3.8/10 | 3.4/10 | 3.9/10 | 3.9/10 | 4.9/10 | 3.7/10 | challenge-2-arrival-group-1 (9.4/10 legacy) | pass | Movement conformance is only 3.4/10 under the strict scorer: current paths are too short/shallow and do not yet show the sweeping, turning, learnable Galaga challenge-stage trajectories.<br>Graphical conformance is only 3.9/10: runtime object-track silhouettes are now measured, but they are not yet matched frame-by-frame against Galaga target sprite crops, rotations, dive poses, and pulsing/flapping cadence.<br>Alien/stage novelty is only 3.9/10: the current type mix does not yet prove Galaga-like new alien introductions, memorable challenge-specific roles, or distinct bonus-stage learning patterns.<br>Cross-sweep identity now lands on the expected Challenge 2 reference family; next work is trajectory precision and active visual novelty, not basic identity. |
| 11 | 3 | 3.9/10 | 3.5/10 | 4.4/10 | 3.9/10 | 4.7/10 | 3.9/10 | challenge-3-arrival-group-1 (9.6/10 legacy) | pass | Movement conformance is only 3.5/10 under the strict scorer: current paths are too short/shallow and do not yet show the sweeping, turning, learnable Galaga challenge-stage trajectories.<br>Alien/stage novelty is only 3.9/10: the current type mix does not yet prove Galaga-like new alien introductions, memorable challenge-specific roles, or distinct bonus-stage learning patterns.<br>Dragonfly/boss-led identity now lands on the expected Challenge 3 reference family, but sprite-motion novelty and tracked Galaga challenge-3 path phases are not yet scored. |
| 15 | 4 | 4/10 | 3.7/10 | 4.4/10 | 3.9/10 | 5.1/10 | 4/10 | challenge-4-pink-serpentine-group-5 (10/10 legacy) | pass | Movement conformance is only 3.7/10 under the strict scorer: current paths are too short/shallow and do not yet show the sweeping, turning, learnable Galaga challenge-stage trajectories.<br>Alien/stage novelty is only 3.9/10: the current type mix does not yet prove Galaga-like new alien introductions, memorable challenge-specific roles, or distinct bonus-stage learning patterns.<br>Pink-serpentine identity now lands on its first-pass late reference, but it still needs five-group frame labels, target sprite-motion evidence, and stronger player-visible novelty before it can claim maturity. |
| 19 | 5 | 4.1/10 | 3.7/10 | 4.5/10 | 3.9/10 | 5.3/10 | 4/10 | challenge-5-pink-green-cascade-group-1 (10/10 legacy) | pass | Movement conformance is only 3.7/10 under the strict scorer: current paths are too short/shallow and do not yet show the sweeping, turning, learnable Galaga challenge-stage trajectories.<br>Alien/stage novelty is only 3.9/10: the current type mix does not yet prove Galaga-like new alien introductions, memorable challenge-specific roles, or distinct bonus-stage learning patterns.<br>Pink/green cascade identity now lands on its first-pass late reference, but the current window still needs five group labels and stronger lower-field route readability. |
| 23 | 6 | 3.8/10 | 3.2/10 | 4.4/10 | 3.9/10 | 5.4/10 | 3.8/10 | challenge-6-green-ladder-split-group-1 (8.9/10 legacy) | pass | Movement conformance is only 3.2/10 under the strict scorer: current paths are too short/shallow and do not yet show the sweeping, turning, learnable Galaga challenge-stage trajectories.<br>Alien/stage novelty is only 3.9/10: the current type mix does not yet prove Galaga-like new alien introductions, memorable challenge-specific roles, or distinct bonus-stage learning patterns.<br>Green-ladder split now lands on a Challenge 6 ladder/split reference; remaining work is fuller path length, lower reversal noise, and object-tracked group timing. |
| 27 | 7 | 3.8/10 | 3.4/10 | 4.4/10 | 3.9/10 | 4.6/10 | 3.8/10 | challenge-7-yellow-diagonal-fan-group-1 (9.5/10 legacy) | pass | Movement conformance is only 3.4/10 under the strict scorer: current paths are too short/shallow and do not yet show the sweeping, turning, learnable Galaga challenge-stage trajectories.<br>Alien/stage novelty is only 3.9/10: the current type mix does not yet prove Galaga-like new alien introductions, memorable challenge-specific roles, or distinct bonus-stage learning patterns.<br>Yellow diagonal fan now lands on a Challenge 7 diagonal-fan reference; remaining work is stronger lower-field travel and object-tracked diagonal lane timing. |
| 31 | 8 | 4/10 | 3.4/10 | 4.5/10 | 3.9/10 | 5.3/10 | 3.9/10 | challenge-8-blue-purple-finale-group-1 (9.4/10 legacy) | pass | Movement conformance is only 3.4/10 under the strict scorer: current paths are too short/shallow and do not yet show the sweeping, turning, learnable Galaga challenge-stage trajectories.<br>Alien/stage novelty is only 3.9/10: the current type mix does not yet prove Galaga-like new alien introductions, memorable challenge-specific roles, or distinct bonus-stage learning patterns.<br>Blue/purple finale is now represented as its own runtime contract, but it still needs fuller path length and active sprite-motion evidence before it feels like a late-loop capstone. |


## Stage 3 / Challenge 1

**Current score:** interesting factor 3.9/10; challenge conformance 3.8/10. Movement 3.3/10, graphics 4.2/10, alien novelty 3.9/10, progression 2.8/10, player shot opportunity 5.7/10.
...
**Aurora current:** first-challenge-peel / first-challenge-peel; lanes bee, bee, bee, bee, but, but, but, but; first-wave types bee, bee, bee, bee, but, but, but, but; visual families classic; strict movement 3.3/10, graphics 4.2/10, alien novelty 3.9/10, shot opportunity 5.7/10.

**Graphics read:** Strict graphics score 4.2/10. Current visible family/type labels are present, Direct runtime-vs-Galaga target-crop comparator reads 2.79/10 overall and 2.55/10 for challenge specialty sprites; weakest challenge crop is challenge-mosquito at 2.54/10. Runtime sprite-motion hook observed 1 visual family/families, 1 path pose family/families, 6/6 animation phase buckets, both flap state(s), and 40 object-tracked silhouette track(s). Graphics remain capped at 4.8/10 until object tracks are compared as full temporal Galaga target-crop sequences, rotations, dive poses, and capture/rescue transitions.
...
**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 9 sampled windows; 78% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.21.
...
**Current score:** interesting factor 3.8/10; challenge conformance 3.7/10. Movement 3.4/10, graphics 3.9/10, alien novelty 3.9/10, progression 3.2/10, player shot opportunity 4.9/10.
...
**Aurora current:** scorpion-cross-sweep / cross-sweep; lanes but, boss, rogue, bee, bee, rogue, boss, but; first-wave types but, boss, rogue, bee, bee, rogue, boss, but; visual families classic; strict movement 3.4/10, graphics 3.9/10, alien novelty 3.9/10, shot opportunity 4.9/10.

**Graphics read:** Strict graphics score 3.9/10. Current visible family/type labels are present, Direct runtime-vs-Galaga target-crop comparator reads 2.79/10 overall and 2.55/10 for challenge specialty sprites; weakest challenge crop is challenge-mosquito at 2.54/10. Runtime sprite-motion hook observed 3 visual family/families, 3 path pose family/families, 6/6 animation phase buckets, both flap state(s), and 39 object-tracked silhouette track(s). Graphics remain capped at 4.8/10 until object tracks are compared as full temporal Galaga target-crop sequences, rotations, dive poses, and capture/rescue transitions.

**Movement read:** Strict movement score 3.4/10 against challenge-2-arrival-group-1: y-range fit 1, path-length fit 1, turn fit 1. Current probes are still sampled summaries, so full temporal choreography is not yet proven. Legacy broad vector best-match was 9.4/10 against challenge-2-arrival-group-1; xRange 1.3571, yRange 0.7703, pathLength 0.9567.
...
**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 8 sampled windows; 50% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.09.
...
**Current score:** interesting factor 3.9/10; challenge conformance 3.9/10. Movement 3.5/10, graphics 4.4/10, alien novelty 3.9/10, progression 3.2/10, player shot opportunity 4.7/10.
...
**Aurora current:** stingray-crown-hook-hybrid / hook-arc; lanes boss, rogue, but, bee, boss, bee, but, rogue; first-wave types boss, rogue, but, bee, boss, bee, but, rogue; visual families dragonfly; strict movement 3.5/10, graphics 4.4/10, alien novelty 3.9/10, shot opportunity 4.7/10.

**Graphics read:** Strict graphics score 4.4/10. Current visible family/type labels are present, Direct runtime-vs-Galaga target-crop comparator reads 2.79/10 overall and 2.55/10 for challenge specialty sprites; weakest challenge crop is challenge-mosquito at 2.54/10. Runtime sprite-motion hook observed 3 visual family/families, 3 path pose family/families, 6/6 animation phase buckets, both flap state(s), and 36 object-tracked silhouette track(s). Graphics remain capped at 4.8/10 until object tracks are compared as full temporal Galaga target-crop sequences, rotations, dive poses, and capture/rescue transitions.

**Movement read:** Strict movement score 3.5/10 against challenge-3-arrival-group-1: y-range fit 1, path-length fit 1, turn fit 1. Current probes are still sampled summaries, so full temporal choreography is not yet proven. Legacy broad vector best-match was 9.6/10 against challenge-3-arrival-group-1; xRange 1.5143, yRange 0.7166, pathLength 1.0442.
...
**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 8 sampled windows; 50% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.23.
...
**Current score:** interesting factor 4/10; challenge conformance 4/10. Movement 3.7/10, graphics 4.4/10, alien novelty 3.9/10, progression 3.1/10, player shot opportunity 5.1/10.

**Legacy broad coverage score:** 7.2/10. This is retained as diagnostic evidence only; it no longer counts as the player-facing conformance score.
...
**Aurora current:** pink-serpentine-late / pink-serpentine; lanes boss, rogue, but, bee, bee, but, rogue, boss; first-wave types boss, rogue, but, bee, bee, but, rogue, boss; visual families galboss; strict movement 3.7/10, graphics 4.4/10, alien novelty 3.9/10, shot opportunity 5.1/10.

**Graphics read:** Strict graphics score 4.4/10. Current visible family/type labels are present, Direct runtime-vs-Galaga target-crop comparator reads 2.79/10 overall and 2.55/10 for challenge specialty sprites; weakest challenge crop is challenge-mosquito at 2.54/10. Runtime sprite-motion hook observed 2 visual family/families, 3 path pose family/families, 6/6 animation phase buckets, both flap state(s), and 37 object-tracked silhouette track(s). Graphics remain capped at 4.8/10 until object tracks are compared as full temporal Galaga target-crop sequences, rotations, dive poses, and capture/rescue transitions.

**Movement read:** Strict movement score 3.7/10 against challenge-4-pink-serpentine-group-5: y-range fit 1, path-length fit 1, turn fit 1. Current probes are still sampled summaries, so full temporal choreography is not yet proven. Legacy broad vector best-match was 10/10 against challenge-4-pink-serpentine-group-5; xRange 1.5286, yRange 0.7946, pathLength 1.0557.
...
**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 7 sampled windows; 71% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.16.
...
**Current score:** interesting factor 4.1/10; challenge conformance 4/10. Movement 3.7/10, graphics 4.5/10, alien novelty 3.9/10, progression 3.1/10, player shot opportunity 5.3/10.
...
**Aurora current:** pink-green-cascade / pink-green-cascade; lanes rogue, boss, but, bee, boss, but, bee, rogue; first-wave types rogue, boss, but, bee, boss, but, bee, rogue; visual families galboss; strict movement 3.7/10, graphics 4.5/10, alien novelty 3.9/10, shot opportunity 5.3/10.

**Graphics read:** Strict graphics score 4.5/10. Current visible family/type labels are present, Direct runtime-vs-Galaga target-crop comparator reads 2.79/10 overall and 2.55/10 for challenge specialty sprites; weakest challenge crop is challenge-mosquito at 2.54/10. Runtime sprite-motion hook observed 3 visual family/families, 3 path pose family/families, 6/6 animation phase buckets, both flap state(s), and 38 object-tracked silhouette track(s). Graphics remain capped at 4.8/10 until object tracks are compared as full temporal Galaga target-crop sequences, rotations, dive poses, and capture/rescue transitions.

**Movement read:** Strict movement score 3.7/10 against challenge-5-pink-green-cascade-group-1: y-range fit 1, path-length fit 0.85, turn fit 1. Current probes are still sampled summaries, so full temporal choreography is not yet proven. Legacy broad vector best-match was 10/10 against challenge-5-pink-green-cascade-group-1; xRange 1.5429, yRange 0.5295, pathLength 0.8627.
...
**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 7 sampled windows; 71% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.15.
...
**Current score:** interesting factor 3.8/10; challenge conformance 3.8/10. Movement 3.2/10, graphics 4.4/10, alien novelty 3.9/10, progression 2.7/10, player shot opportunity 5.4/10.
...
**Aurora current:** green-ladder-split / green-ladder-split; lanes bee, but, rogue, boss, boss, rogue, but, bee; first-wave types bee, but, rogue, boss, boss, rogue, but, bee; visual families dragonfly; strict movement 3.2/10, graphics 4.4/10, alien novelty 3.9/10, shot opportunity 5.4/10.

**Graphics read:** Strict graphics score 4.4/10. Current visible family/type labels are present, Direct runtime-vs-Galaga target-crop comparator reads 2.79/10 overall and 2.55/10 for challenge specialty sprites; weakest challenge crop is challenge-mosquito at 2.54/10. Runtime sprite-motion hook observed 2 visual family/families, 1 path pose family/families, 6/6 animation phase buckets, both flap state(s), and 40 object-tracked silhouette track(s). Graphics remain capped at 4.8/10 until object tracks are compared as full temporal Galaga target-crop sequences, rotations, dive poses, and capture/rescue transitions.

**Movement read:** Strict movement score 3.2/10 against challenge-6-green-ladder-split-group-1: y-range fit 0.91, path-length fit 0.79, turn fit 1. Current probes are still sampled summaries, so full temporal choreography is not yet proven. Legacy broad vector best-match was 8.9/10 against challenge-6-green-ladder-split-group-1; xRange 1.5714, yRange 0.5665, pathLength 0.7749.
...
**Current score:** interesting factor 3.8/10; challenge conformance 3.8/10. Movement 3.4/10, graphics 4.4/10, alien novelty 3.9/10, progression 2.7/10, player shot opportunity 4.6/10.
...
**Aurora current:** yellow-diagonal-fan / yellow-diagonal-fan; lanes boss, bee, but, rogue, rogue, but, bee, boss; first-wave types boss, bee, but, rogue, rogue, but, bee, boss; visual families crown; strict movement 3.4/10, graphics 4.4/10, alien novelty 3.9/10, shot opportunity 4.6/10.

**Graphics read:** Strict graphics score 4.4/10. Current visible family/type labels are present, Direct runtime-vs-Galaga target-crop comparator reads 2.79/10 overall and 2.55/10 for challenge specialty sprites; weakest challenge crop is challenge-mosquito at 2.54/10. Runtime sprite-motion hook observed 1 visual family/families, 1 path pose family/families, 6/6 animation phase buckets, both flap state(s), and 33 object-tracked silhouette track(s). Graphics remain capped at 4.8/10 until object tracks are compared as full temporal Galaga target-crop sequences, rotations, dive poses, and capture/rescue transitions.

**Movement read:** Strict movement score 3.4/10 against challenge-7-yellow-diagonal-fan-group-1: y-range fit 1, path-length fit 0.72, turn fit 1. Current probes are still sampled summaries, so full temporal choreography is not yet proven. Legacy broad vector best-match was 9.5/10 against challenge-7-yellow-diagonal-fan-group-1; xRange 1.6, yRange 0.5655, pathLength 0.7953.
...
**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 6 sampled windows; 50% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.13.
...
**Current score:** interesting factor 4/10; challenge conformance 3.9/10. Movement 3.4/10, graphics 4.5/10, alien novelty 3.9/10, progression 3.1/10, player shot opportunity 5.3/10.
...
**Aurora current:** blue-purple-finale / blue-purple-finale; lanes rogue, boss, bee, but, but, bee, boss, rogue; first-wave types rogue, boss, bee, but, but, bee, boss, rogue; visual families stingray; strict movement 3.4/10, graphics 4.5/10, alien novelty 3.9/10, shot opportunity 5.3/10.

**Graphics read:** Strict graphics score 4.5/10. Current visible family/type labels are present, Direct runtime-vs-Galaga target-crop comparator reads 2.79/10 overall and 2.55/10 for challenge specialty sprites; weakest challenge crop is challenge-mosquito at 2.54/10. Runtime sprite-motion hook observed 3 visual family/families, 3 path pose family/families, 6/6 animation phase buckets, both flap state(s), and 36 object-tracked silhouette track(s). Graphics remain capped at 4.8/10 until object tracks are compared as full temporal Galaga target-crop sequences, rotations, dive poses, and capture/rescue transitions.

**Movement read:** Strict movement score 3.4/10 against challenge-8-blue-purple-finale-group-1: y-range fit 1, path-length fit 0.61, turn fit 0.93. Current probes are still sampled summaries, so full temporal choreography is not yet proven. Legacy broad vector best-match was 9.4/10 against challenge-8-blue-purple-finale-group-1; xRange 1.6143, yRange 0.5118, pathLength 0.6434.
...
**Shot-opportunity read:** Shot-opportunity probe found scoreable targets in 7 sampled windows; 71% had a lane with 2+ targets, lane diversity was 1, and center-lane bias was 0.22.
...
- Raise challenge-stage interesting factor from 3.9/10 to 3.5/10 as the first honest gate by implementing one visibly reference-like challenge, then toward 6.0/10 after Stage 3, 7, and 11 each have distinct authored contracts.
- Raise movement conformance from 3.4/10 by increasing y-range, path length, turn count, and exit-side match against the Galaga challenge references.
- Raise graphical conformance from 4.3/10 by extending the object-tracked silhouette hook into Galaga target-crop sequence comparisons; do not inflate it from type labels alone.
- Raise player shot opportunity from 5.1/10 by creating lane-readable scoring windows for each challenge rather than incidental central-lane hits.
