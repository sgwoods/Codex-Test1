...
- local current line:
  - branch `codex/movement-conformance-pass`
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Overall quality score | `8.8` | `~8.3` | stable baseline line | stable baseline line | `10` |
| Player movement conformance | `8.4` | `~5.9` | `4.6` | `4.6` | `10` |
...
| Audio identity and cue alignment | `6.1` | `~5.6` | shared gap, not lane-rescored | shared gap, not lane-rescored | `10` |
...
- the line now reads more like a beta-candidate prep line than a dev-recovery line
