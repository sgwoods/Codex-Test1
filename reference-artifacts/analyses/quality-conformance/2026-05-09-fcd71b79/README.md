...
- Read: Close-shot responsiveness passed, and movement-fire post-shot travel was 44.39, with shot delay -5ms.
...
- Read: Audio score blends cue identity, active reference similarity, reference-window precision, overlap timing, cue alignment, semantic event mapping, and acoustic event-gap severity. 0/21 reference windows still need tighter segmentation; 17 candidate subwindows were found; semantic event score is 9.76/10, acoustic event score is 5.14/10, and highest segment risk is playerHit body.
