...
- Tap correction abs delta: 13.99
- Hold travel delta: 87.52
- Hold settle after release (ms): 217
- Reversal cross ms: 284
- Shot delay while moving (ms): 7
- Post-shot travel: 100.72
- Max frame step: 32.41

## Current metric gaps

- reversalCrossMs: value 284, target {"max":280}, gap 4
- maxFrameStep: value 32.41, target {"max":17}, gap 15.41
