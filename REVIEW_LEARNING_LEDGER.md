...
- generated: `2026-05-15T00:11:23.210Z`
- branch: `main`
- commit: `c9d9bb47`
...
| 2026-05-15 | Current branch code review packet | reference-artifacts/analyses/code-review/latest.json | 0 | P0 0 / P1 0 / P2 0 / P3 0 | Use automatic findings as review notes and blocking P0/P1 gates; P2/P3 remain explicit human-review items. |
...
| --- | --- | --- | --- |
| release-tooling-churn | Changes to scripts or release tooling often look small but affect lane authority and publish behavior. | Require `npm run publish:check:dev` plus the review packet before hosted-dev movement. | Standing release gate rule. |
