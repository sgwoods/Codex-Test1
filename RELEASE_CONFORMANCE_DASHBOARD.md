...
Generated: `2026-05-10T14:47:34.400Z`
...
| Metric points scanned | 1018 | History depth behind score trends |
| Score deltas found | 117 | Past-goal movement available for review |
| Measured runs | 380 | Tracked harness/model/local compute work |
| Tracked wall time | 239.1 min | Human clock-time planning input |
| Tracked CPU time | 368.2 min | Local compute-cost planning input |
| Tracked artifact growth | 609.4 MB | Evidence volume and storage/review-cost proxy |
...
| --- | --- | --- | --- | --- |
| Audio conformance and cue feedback | 253 | 187.5 min | 87.6% | Moves the moment-to-moment arcade feel: impact clarity, ambience identity, reward/loss feedback, and player understanding. |
...
| --- | --- | --- | --- |
| cpu | 378 | 214.1 min | 368.2 min |
| browser | 134 | 111.2 min | 191.5 min |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Audio identity, event feedback, and cue alignment | 6.9/10 | 7.5-8.0 | +0.6 | High; 3-6 hrs local/model-assisted analysis | cpu, model-api, openai-api | 199 runs; 144.8 min wall; 259 min CPU | Expected lift 0.7/10 on metric, 0.058/10 overall; investment score 3.04. | StagePulse candidate cadence-phase-muted-square-body is a phase/envelope near miss, but repeat stability and masking reject promotion. Preserve it as generator evidence and run a broader stagePulse onset strategy that compares reference subclips, pressure cadence, and combat masking before another runtime trial. |
...
| 2 | Aurora audio cue comparison and event-gap reports | audio cue scoring | waveform/spectral/alignment/semantic reports | 21 compared cues; semantic 9.78/10; 0 attention rows | semantic-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-event-gap/2026-05-10-8c3e3571-dirty-144723/report.json | Tune the highest segment-level gap next: stagePulse onset. Rerun audio comparison and event-gap analysis after the change. |
...
| 4 | Aurora audio cue contracts | audio semantic contract / theme latitude / promotion safety | cue contract readiness, theme lanes, runtime-trial blockers | 8 contracts; readiness 9.1/10; blocked 3 | contract-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-cue-contracts/2026-05-10-d5dfeffe-dirty-133244/report.json | StagePulse candidate cadence-phase-muted-square-body is a phase/envelope near miss, but repeat stability and masking reject promotion. Preserve it as generator evidence and run a broader stagePulse onset strategy that compares reference subclips, pressure cadence, and combat masking before another runtime trial. |
| 5 | Aurora stagePulse cadence pressure analysis | formation pressure / cadence audio | tracked cadence pressure axes from full audio comparison | pressure 1.5/10; weakest brightness-control | scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-stage-pulse-cadence/2026-05-10-41f7caa8-dirty/report.json | Add a cadence-specific candidate generator that jointly optimizes low-band body, brightness control, zero-crossing calm, and gain. Promote only after both repeated focus gates and full audio-theme comparison improve. |
| 6 | Boss entry and formation grammar scorer | formation grammar / boss entry / challenge identity | event grammar, timing, stage-signature, and measurement-debt report | 11 boss/formation windows | scored | medium | Boss entry and formation grammar | reference-artifacts/analyses/formation-boss-grammar-conformance/2026-05-10-8c3e3571/report.json | Promote frame-level boss/escort path traces and formation rack slot coordinates so visual choreography can be scored directly. |
| 7 | Level arc and encounter-shape evidence | level arc / challenge / reward | stage signatures, pressure windows, persona reports | 6/6 stage families; 11/6 evidence windows | scored | medium-high | Level arc and encounter shape | reference-artifacts/analyses/level-arc-conformance/2026-05-10-8c3e3571/report.json | Add more long-play reference windows and expert-route scoring for challenge/reward opportunities. |
...
![score-trends](reference-artifacts/analyses/conformance-economics/2026-05-10-8c3e3571/score-trends.svg)

![largest-score-deltas](reference-artifacts/analyses/conformance-economics/2026-05-10-8c3e3571/largest-score-deltas.svg)

![compute-minutes-by-resource](reference-artifacts/analyses/conformance-economics/2026-05-10-8c3e3571/compute-minutes-by-resource.svg)

![cost-per-positive-score-point](reference-artifacts/analyses/conformance-economics/2026-05-10-8c3e3571/cost-per-positive-score-point.svg)

![gpu-equivalent-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-10-8c3e3571/gpu-equivalent-use-by-purpose.svg)

![cpu-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-10-8c3e3571/cpu-use-by-purpose.svg)

![gameplay-improvement-by-project-part](reference-artifacts/analyses/conformance-economics/2026-05-10-8c3e3571/gameplay-improvement-by-project-part.svg)
...
- Quality report: `reference-artifacts/analyses/quality-conformance/2026-05-10-8c3e3571/report.json`
...
- Level-arc report: `reference-artifacts/analyses/level-arc-conformance/2026-05-10-8c3e3571/report.json`
- Economics report: `reference-artifacts/analyses/conformance-economics/2026-05-10-8c3e3571/report.json`
