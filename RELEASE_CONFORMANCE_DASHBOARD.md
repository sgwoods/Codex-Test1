...
Generated: `2026-05-15T17:35:02.684Z`
...
| Alien entry and challenge-stage novelty | 8.1/10 | >=7.5 first gate; >=9.0 mature | New high-priority long-cycle gameplay-authenticity gate |
...
| Metric points scanned | 1407 | History depth behind score trends |
| Score deltas found | 140 | Past-goal movement available for review |
| Measured runs | 563 | Tracked harness/model/local compute work |
| Tracked wall time | 394.6 min | Human clock-time planning input |
| Tracked CPU time | 654 min | Local compute-cost planning input |
| Tracked artifact growth | 939.1 MB | Evidence volume and storage/review-cost proxy |
...
| Gameplay behavior and level complexity | 151 | 25.1 min | 6.8% | Moves player-facing pressure, stage shape, alien entry novelty, challenge-stage learning value, and long-play texture. |
...
| conformance-economics | 97 | 46.4 min | 30.7 min |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Audio identity, event feedback, and cue alignment | 7.1/10 | 7.5-8.0 | +0.4 | High; 3-6 hrs local/model-assisted analysis | cpu, model-api, openai-api | 292 runs; 227.2 min wall; 411.1 min CPU | Expected lift 0.7/10 on metric, 0.058/10 overall; investment score 2.96. | Keep the calibrated layered playerHit runtime cue; next either refine the residual playerHit tail/body gap with the same calibrated scorer or move effort to stagePulse pressure-bed strategy if user impact per compute looks higher. |
| 2 | Alien entry and challenge-stage novelty | 8.1/10 | 7.5 first gate; 9.0+ mature | at target | High; long-cycle CPU/browser extraction plus reference contact-sheet and path-labeling pass | cpu, browser | 190 runs; 24.8 min wall; 41.5 min CPU | Estimated cost/value; dedicated investment candidate not yet generated. | Attack Regular-entry geometry separation: Minimum regular geometry distance 0.093; mean regular geometry distance 0.14; closest pair mid-run-entry-variant / late-run-cleanup-or-failure. |
...
| 2 | Aurora audio cue comparison and event-gap reports | audio cue scoring | waveform/spectral/alignment/semantic reports | 21 compared cues; semantic 9.78/10; 0 attention rows | semantic-scored | medium-high | Audio identity, event feedback, and cue alignment | reference-artifacts/analyses/aurora-audio-event-gap/2026-05-15-db84f65c-dirty-173444/report.json | Tune the highest segment-level gap next: challengePerfect onset. Rerun audio comparison and event-gap analysis after the change. |
...
![score-trends](reference-artifacts/analyses/conformance-economics/2026-05-15-db84f65c/score-trends.svg)

![largest-score-deltas](reference-artifacts/analyses/conformance-economics/2026-05-15-db84f65c/largest-score-deltas.svg)

![compute-minutes-by-resource](reference-artifacts/analyses/conformance-economics/2026-05-15-db84f65c/compute-minutes-by-resource.svg)

![cost-per-positive-score-point](reference-artifacts/analyses/conformance-economics/2026-05-15-db84f65c/cost-per-positive-score-point.svg)

![gpu-equivalent-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-15-db84f65c/gpu-equivalent-use-by-purpose.svg)

![cpu-use-by-purpose](reference-artifacts/analyses/conformance-economics/2026-05-15-db84f65c/cpu-use-by-purpose.svg)

![gameplay-improvement-by-project-part](reference-artifacts/analyses/conformance-economics/2026-05-15-db84f65c/gameplay-improvement-by-project-part.svg)
...
- Quality report: `reference-artifacts/analyses/quality-conformance/2026-05-15-db84f65c/report.json`
...
- Level-arc report: `reference-artifacts/analyses/level-arc-conformance/2026-05-15-db84f65c/report.json`
- Economics report: `reference-artifacts/analyses/conformance-economics/2026-05-15-db84f65c/report.json`
